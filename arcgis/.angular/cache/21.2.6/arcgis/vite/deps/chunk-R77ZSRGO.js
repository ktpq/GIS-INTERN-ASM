...
function a3(t, r3) {
  ...
  return s4.length ? s4.map((r4) => {
    const i3 = n2(t, r4), s5 = o2(i3, r4.definitionExpression);
...
__decorate([a2({ type: Number, json: { write: true } })], d2.prototype, "dpi", void 0), __decorate([a2()], d2.prototype, "floors", void 0), __decorate([a2({ type: String, json: { write: true } })], d2.prototype, "gdbVersion", void 0), __decorate([a2({ types: s3, json: { read: u2, write: true } })], d2.prototype, "geometry", void 0), __decorate([a2({ type: Number, json: { write: true } })], d2.prototype, "geometryPrecision", void 0), __decorate([a2({ type: Number, json: { write: true } })], d2.prototype, "height", void 0), __decorate([a2({ type: Date })], d2.prototype, "historicMoment", void 0), __decorate([r2("historicMoment")], d2.prototype, "writeHistoricMoment", null), __decorate([a2({ type: [Number], json: { write: true } })], d2.prototype, "layerIds", void 0), __decorate([a2({ type: ["top", "visible", "all", "popup"], json: { write: true } })], d2.prototype, "layerOption", void 0), __decorate([a2({ type: z, json: { write: true } })], d2.prototype, "mapExtent", void 0), __decorate([a2({ type: Number, json: { write: true } })], d2.prototype, "maxAllowableOffset", void 0), __decorate([a2({ type: Boolean, json: { write: true } })], d2.prototype, "returnFieldName", void 0), __decorate([a2({ type: Boolean, json: { write: true } })], d2.prototype, "returnGeometry", void 0), __decorate([a2({ type: Boolean, json: { write: true } })], d2.prototype, "returnM", void 0), __decorate([a2({ type: Boolean, json: { write: true } })], d2.prototype, "returnUnformattedValues", void 0), __decorate([a2({ type: Boolean, json: { write: true } })], d2.prototype, "returnZ", void 0), __decorate([a2({ type: S, json: { write: true } })], d2.prototype, "spatialReference", void 0), __decorate([a2()], d2.prototype, "sublayers", null), __decorate([a2({ type: m3, json: { write: true } })], d2.prototype, "timeExtent", void 0), __decorate([a2({ type: Number, json: { write: true } })], d2.prototype, "tolerance", void 0), __decorate([a2({ type: Number, json: { write: true } })], d2.prototype, "width", void 0), d2 = a4 = __decorate([c("esri.rest.support.IdentifyParameters")], d2);
var c2 = d2;
...
var u6 = class extends n {
  ...
  writeFeature(t, e4) {
    ...
    r3 && (e4.attributes = __spreadValues({}, r3)), null != o5 && (e4.geometry = o5.toJSON(), e4.geometryType = m2.toJSON(o5.type));
  }
};
__decorate([a2({ type: String, json: { write: true } })], u6.prototype, "displayFieldName", void 0), __decorate([a2({ type: j })], u6.prototype, "feature", void 0), __decorate([o("feature", ["attributes", "geometry"])], u6.prototype, "readFeature", null), __decorate([r2("feature")], u6.prototype, "writeFeature", null), __decorate([a2({ type: Number, json: { write: true } })], u6.prototype, "layerId", void 0), __decorate([a2({ type: String, json: { write: true } })], u6.prototype, "layerName", void 0), u6 = __decorate([c("esri.rest.support.IdentifyResult")], u6);
var l2 = u6;
...
var P2 = class extends b {
  ...
  _updatePointSymbology(e4) {
    ...
    r3 && "getSymbolAsync" in r3 ? r3.getSymbolAsync(e4).then(async (i3) => {
      ...
      n4 && (S2 || (S2 = (await import("./visualVariableUtils-IECIRYDC.js")).getSize), l3 = S2(n4, e4, { view: o5.type, scale: o5.scale, shape: "simple-marker" === i3.type ? i3.style : null })), l3 ||= "width" in i3 && "height" in i3 && null != i3.width && null != i3.height ? Math.max(i3.width, i3.height) : "size" in i3 ? i3.size : 16, s4?.includes(e4) && (this._setGraphicSymbol(e4, new u4({ style: "square", size: l3, color: new g([255, 255, 255, 1 / 255]), xoffset: "xoffset" in i3 ? i3.xoffset : 0, yoffset: "yoffset" in i3 ? i3.yoffset : 0 })), a6(e4));
    }) : a6(e4);
  }
  get _updateContext() {
  ...
  const s4 = (e5) => {
    ...
    if (e5.visible && o5 && a6) {
      if (e5.sublayers) e5.sublayers.forEach(s4);
        ...
        const t2 = n3(e5, __spreadProps(__spreadValues({}, r3), { defaultPopupTemplateEnabled: false }));
...
__decorate([a2({ constructOnly: true })], P2.prototype, "createFetchPopupFeaturesQueryGeometry", void 0), __decorate([a2({ constructOnly: true })], P2.prototype, "layerView", void 0), __decorate([a2({ constructOnly: true })], P2.prototype, "highlightGraphics", void 0), __decorate([a2({ constructOnly: true })], P2.prototype, "highlightGraphicUpdated", void 0), __decorate([a2({ constructOnly: true })], P2.prototype, "updatingHandles", void 0), __decorate([a2()], P2.prototype, "_updateContext", null), P2 = __decorate([c("esri.views.layers.support.MapServiceLayerViewHelper")], P2);

export {
  j2 as j,
  P2 as P
};
//# sourceMappingURL=chunk-R77ZSRGO.js.map
