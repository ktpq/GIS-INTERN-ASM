import {
  n2 as n4
} from "./chunk-XRKPNYQ7.js";
import {
  t as t3
} from "./chunk-6FJUC4QU.js";
import {
  E,
  F,
  I as I2,
...
var g4 = class extends b {
  ...
  addToEstimator(t5) {
    const i5 = t5.center.x, o4 = t5.center.y, e2 = f2(-i5, o4), m3 = r2(-i5, o4, 0);
...
var g5 = class extends b {
  ...
  update(t5, e2) {
    ...
    o(d3, e2.center.x, e2.center.y), $(f8, i5, o4), t5.viewpoint = bt(this.viewpoint, t5.state.paddedViewState.viewpoint, pt(f8, this._previousCenter, d3)), r3(this._previousCenter, d3);
  }
  end() {
    this.navigation.end();
  }
...
//# sourceMappingURL=chunk-HPMWPX3E.js.map
