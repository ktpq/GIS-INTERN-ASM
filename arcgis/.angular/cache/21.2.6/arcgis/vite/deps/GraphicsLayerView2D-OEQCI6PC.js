...
var d = class extends S(s) {
  ...
  highlight(i2, h) {
    let a2;
    "number" == typeof i2 ? a2 = [i2] : i2 instanceof j ? a2 = [i2.uid] : Array.isArray(i2) && i2.length > 0 ? a2 = "number" == typeof i2[0] ? i2 : i2.map((i3) => i3 && i3.uid) : q.isCollection(i2) && i2.length > 0 && (a2 = i2.map((i3) => i3 && i3.uid).toArray());
    const p = a2?.filter(N);
...
//# sourceMappingURL=GraphicsLayerView2D-OEQCI6PC.js.map
