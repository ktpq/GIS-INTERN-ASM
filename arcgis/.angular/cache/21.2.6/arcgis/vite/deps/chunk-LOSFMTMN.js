...
function e(t2, e2) {
  ...
  let i = true, a2 = true;
  return t2.some((r, n) => (i = i && 0 === r, a2 = a2 && r === n, !i && !a2)), i ? c(t2.length) : a2 ? l(t2.length) : m(t2) && t2.BYTES_PER_ELEMENT === Uint16Array.BYTES_PER_ELEMENT ? t2 : f(t2, !e2);
}
function f(r, t2) {
  for (const e2 of r) {
...
function l(n) {
  return 1 === n ? o : n < y ? Array.from(new Uint16Array(A.buffer, 0, n)) : n < A.length ? new Uint16Array(A.buffer, 0, n) : (n > y2.length && (y2 = h(Math.max(2 * y2.length, n))), new Uint32Array(y2.buffer, 0, n));
}
function h(r) {
...
//# sourceMappingURL=chunk-LOSFMTMN.js.map
