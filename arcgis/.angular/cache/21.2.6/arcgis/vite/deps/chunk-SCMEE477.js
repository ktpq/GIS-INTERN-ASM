...
var f3 = class _f {
  constructor(e2) {
    ...
    if (null != t3) throw t3;
    const i = e2;
    this.spatialReference = i.spatialReference, this._isWebMercator = this.spatialReference.isWebMercator, this._isGCS = A2(this.spatialReference), this.origin = [i.origin.x, i.origin.y], this.pixelSize = i.size[0], this.dpi = i.dpi;
  ...
  convertExtentToRadians(e2, i) {
    this._isWebMercator ? (i[0] = c2(e2[0]), i[1] = h(e2[1]), i[2] = c2(e2[2]), i[3] = h(e2[3])) : this._isGCS && (i[0] = s2(e2[0]), i[1] = s2(e2[1]), i[2] = s2(e2[2]), i[3] = s2(e2[3]));
  }
  ...
  static isPowerOfTwo(e2) {
    ...
    return !t3.some((e3) => !A3(e3.resolution, i / 2 ** e3.level));
  }
  ...
  static {
    this.WebMercatorAuxiliarySphereTileInfo = new z2({ size: [256, 256], origin: new _({ x: -20037508342787e-6, y: 20037508342787e-6, spatialReference: S.WebMercator }), spatialReference: S.WebMercator, lods: [new l({ level: 0, resolution: 156543.03392800014, scale: 591657527591555e-6 })] });
  }
  static {
...
var j = class extends s3(l2(g(_2(e(b))))) {
  ...
  getTileUrl(e2, r3, t3) {
    const i = !this.capabilities.operations.supportsTileMap && this.supportsBlankTile, o3 = A(__spreadProps(__spreadValues({}, this.parsedUrl.query), { blankTile: !i && null }));
    return `${this.parsedUrl.path}/tile/${e2}/${r3}/${t3}${o3 ? "?" + o3 : ""}`;
  }
  async queryElevation(e2, r3) {
    const { query: t3 } = await import("./ElevationQuery-NN4235EZ.js");
    return s(r3), t3(this, e2, r3);
  }
  async createElevationSampler(e2, r3) {
    const { createSampler: t3 } = await import("./ElevationQuery-NN4235EZ.js");
    return s(r3), t3(this, e2, r3);
  }
...
//# sourceMappingURL=chunk-SCMEE477.js.map
