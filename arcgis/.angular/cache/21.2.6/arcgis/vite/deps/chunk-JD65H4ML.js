...
var n6;
function r() {
  assetPathChanged || setAssetPath2(_(n3(n6)));
}
function c3(t6) {
  const o5 = [];
...
var x = class extends m2(l2) {
  ...
  constructor(e6, r2) {
    ...
    const s3 = "esri-widget-uid-" + n4(), o5 = this.render.bind(this);
  ...
  _postInitialize() {
    if (this.destroyed) return;
    this.scheduleRender(), this._delegatedEventNames?.length && this.addHandles(l(() => this.viewModel, (e7, t6) => {
    ...
    this.addHandles([R(e6), l(() => this.uiStrings, e6)]), this.addHandles(f2(() => this.container, (e7) => {
...
//# sourceMappingURL=chunk-JD65H4ML.js.map
