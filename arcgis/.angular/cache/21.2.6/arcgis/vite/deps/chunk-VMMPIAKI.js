...
var o5 = P(() => import("./bufferOperator-SQZKUA4M.js"));
var s6 = P(() => import("./convexHullOperator-Y6FUAYJC.js"));
var m = P(() => import("./lengthOperator-INNGVCBL.js"));
var n7 = P(() => import("./generalizeOperator-F42Q54N7.js"));
var i7 = P(() => import("./graphicBufferOperator-2IKNTXHE.js"));
var p3 = P(() => import("./offsetOperator-YDJUYJ5Y.js"));
var f3 = P(() => import("./simplifyOperator-X6ZGHXC5.js"));
var a2 = P(() => import("./jsonConverter-DOVZN2UO.js"));
var c2 = 512;
var l4;
function g2(e24) {
  switch (e24.type) {
...
function s15(r15) {
  return e2(Math.round(u2(r15)));
}
function a9(e24) {
  const r15 = e2(Ot), i16 = e2(Pt);
...
var ct = class extends lt {
  ...
  hitTest(t23, e24, r15, i16, s16, a10) {
    ...
    if (this._mapRotation = h12 ? s16 : 0, !has("esri-mobile")) {
      const t24 = e2(tt * window.devicePixelRatio), r16 = e2(et);
...
var mt = class extends lt {
  ...
  drawText(t23, e24) {
    if (!e24 || 0 === e24.length) return;
    this._textRasterizer || (this._textRasterizer = new s13());
    const r15 = yt(t23, this.transformSize(e2(1))), i16 = this._textRasterizer.rasterizeText(e24, r15);
    if (!i16) return;
...
var _4 = class __ {
  ...
  static fromCIMInsidePolygon(e24) {
    ...
    if ("Random" === t23.gridType) {
      const e25 = e2(xt), r16 = Math.max(Math.floor(e25 / s16), 1), y5 = Math.max(Math.floor(e25 / i16), 1);
...
//# sourceMappingURL=chunk-VMMPIAKI.js.map
