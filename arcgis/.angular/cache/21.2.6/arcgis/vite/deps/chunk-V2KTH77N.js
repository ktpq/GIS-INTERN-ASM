...
var c3 = (t) => {
  ...
  let l6 = class extends c4 {
    ...
    initialize() {
      ...
      }, () => this.notifyChange("screenLocation")), l(() => this.screenLocation, (e3, t2) => {
...
var D = class extends i3(c3(l2)) {
  ...
  initialize() {
    this.addHandles([this.on("view-change", () => this._autoClose()), l(() => [this.highlightEnabled, this.selectedFeature, this.visible, this.view], () => this._highlightSelectedFeature()), l(() => [this.highlightEnabled, this.activeFeature, this.visible, this.view], () => this._highlightActiveFeature()), l(() => this.view?.animation?.state, (e3) => this._animationStateChange(e3)), l(() => this.location, (e3) => this._locationChange(e3)), l(() => this.selectedFeature, (e3) => this._selectedFeatureChange(e3)), l(() => [this.selectedFeatureIndex, this.featureCount, this.featuresPerPage], () => this._selectedFeatureIndexChange()), l(() => [this.featurePage, this.selectedFeatureIndex, this.featureCount, this.featuresPerPage, this.featureViewModels], () => this._setGraphicOnFeatureViewModels()), l(() => this.featureViewModels, () => this._featureViewModelsChange()), this.on("trigger-action", (e3) => l4({ event: e3, viewModel: this, view: this.view })), f(() => !this.waitingForResult, () => this._waitingForResultChange(), U), l(() => [this.features, this.map, this.spatialReference, this.timeZone], () => this._updateFeatureVMs()), l(() => this.view?.scale, () => this._viewScaleChange()), f(() => !this.visible, () => this.browseClusterEnabled = false), l(() => this.browseClusterEnabled, (e3) => e3 ? this.enableClusterBrowsing() : this.disableClusterBrowsing())]);
  }
  destroy() {
  ...
  async _fetchFeaturesAndOpen(e3) {
    ...
    this.removeHandles(B), this.addHandles([l(() => this.view?.scale, () => this._debouncedLocationUpdate(t).catch((e4) => {
      d(e4) || n.getLogger(this).error(e4);
    })), f(() => !this.visible, () => {
  ...
  async _locationUpdate(e3, t) {
    ...
    if (s && "mesh" !== s && i4 && r4 && this.selectedFeature) if ("point" !== s) try {
      ...
      s2 = H(s2, i4), Z || (Z = await Promise.all([import("./intersectsOperator-L6OLQCCK.js"), import("./proximityOperator-5FA33RGF.js")]));
      const [n5, l6] = Z;
      if (!n5.execute(s2, r4)) {
...
//# sourceMappingURL=chunk-V2KTH77N.js.map
