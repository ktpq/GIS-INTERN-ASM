...
var c = class {
  constructor() {
    this._tasks = new Array(), this._numPendingTasks = r(0), this._readyToRun = r(false);
  }
  get length() {
...
function l3(s2) {
  d(s2) || s2 instanceof Error || s2 instanceof r2 || null != s2 && "object" == typeof s2 && "done" in s2 && s2.done || n.getLogger("esri.layers.support.PromiseQueue").warn("Generator iterator was aborted, but it is not done.");
}
var u2 = class {
...
var C2 = class {
  ...
  constructor() {
    this._updating = r(true), this._microTaskQueued = false, this._frameNumber = 0, this.performanceInfo = { total: new s("total"), tasks: /* @__PURE__ */ new Map() }, this._frameTaskTimes = /* @__PURE__ */ new Map(), this._budget = new y2(), this.state = 1, this._tasks = new Array(), this._runQueue = new Array(), this._load = 0, this._forceTask = false, this._debug = false, this._debugHandle = l2(() => _.SCHEDULER_LOG_SLOW_TASKS, (e) => this._debug = e, h);
...
var F = class {
  ...
  constructor(e, t, r4) {
    this._scheduler = e, this.name = t, this.blockFrame = 0, this.runtime = 0, this._queue = new c(), this._handles = new r3(), this._basePriority = O(t), this.schedulePriority = this._basePriority, this._task = r(null != r4 ? r4 : this._queue), this._handles.add(f(() => this.task.readyToRun, (t2) => e.taskRunningChanged(t2)));
  }
  remove() {
...
//# sourceMappingURL=chunk-VUOXFCBC.js.map
