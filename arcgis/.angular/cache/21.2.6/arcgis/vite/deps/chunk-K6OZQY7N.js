...
var J = class {
  ...
  async _getAggregateGeometry(e5, n5) {
    const { convexHull: r6, union: o5 } = await import("./geometryEngineJSON-EQMLMCN3.js"), { statisticType: l8, outStatisticFieldName: u7 } = e5, { featureAdapter: c4, spatialReference: m8, geometryType: d5 } = this, p4 = n5.map((e6) => i3(d5, c4.getGeometry(e6))), h4 = r6(m8, p4, true)[0], y4 = { aggregateGeometries: null, outStatisticFieldName: null };
...
//# sourceMappingURL=chunk-K6OZQY7N.js.map
