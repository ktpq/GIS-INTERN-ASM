...
var g = class extends h {
  ...
  async _queryBuddy(e) {
    const t = new (await import("./FeatureLayer-HEW23VGY.js")).default({ url: e }), { capabilities: r4 } = await t.load(), i = r4.query.supportsMaxRecordCountFactor, o2 = r4.query.supportsPagination, s = r4.query.supportsCentroid, n3 = this._config.maxRecordCountFactor, c2 = t.capabilities.query.maxRecordCount, u2 = i ? c2 * n3 : c2, h3 = new R();
...
//# sourceMappingURL=chunk-T2DHPBQZ.js.map
