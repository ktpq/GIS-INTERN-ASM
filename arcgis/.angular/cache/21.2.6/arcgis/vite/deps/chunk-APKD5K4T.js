...
var h = (h3) => {
  ...
  let v = class extends b {
    ...
    async _fetchAllLayersAndTablesFromService(e5, a4) {
      ...
      const l5 = m3(e5), p4 = e(this._allLayersAndTablesMap, l5?.url.path, () => f(V(l5?.url.path, "/layers"), { query: __spreadProps(__spreadValues({ f: "json" }, this.customParameters), { token: this.apiKey }) }).then(async (e6) => {
        ...
        if (l2(s9.values(), (e7) => null == e7.capabilities || null == e7.extent)) {
  ...
  return __decorate([a2({ readOnly: true })], v.prototype, "capabilities", void 0), __decorate([o("service", "capabilities", ["capabilities", "cimVersion", "currentVersion", "exportTilesAllowed", "maxExportTilesCount", "supportsDynamicLayers", "tileInfo"])], v.prototype, "readCapabilities", null), __decorate([a2({ json: { read: { source: "copyrightText" } } })], v.prototype, "copyright", void 0), __decorate([a2({ type: z })], v.prototype, "fullExtent", void 0), __decorate([a2(u3)], v.prototype, "id", void 0), __decorate([a2({ type: Boolean, json: { origins: { service: { read: { enabled: false } } }, read: { source: "showLegend" }, write: { target: "showLegend" } } })], v.prototype, "legendEnabled", void 0), __decorate([a2(l4)], v.prototype, "popupEnabled", void 0), __decorate([a2({ type: S })], v.prototype, "spatialReference", void 0), __decorate([a2({ readOnly: true })], v.prototype, "version", void 0), __decorate([o("service", "version", ["currentVersion", "capabilities", "tables", "supportedImageFormatTypes"])], v.prototype, "readVersion", null), v = __decorate([c("esri.layers.mixins.ArcGISMapService")], v), v;
};
...
function ee(e5, r5, t2) {
  ...
  return !!i5 && e5.originIdOf(r5) >= r3(i5);
}
...
var ne = class extends e2(o2(u)) {
  ...
  async createFeatureLayer() {
    ...
    const e5 = (await import("./FeatureLayer-HEW23VGY.js")).default, { layer: r5, url: t2 } = this;
    let i5;
    if (t2 && this.originIdOf("url") > 2) i5 = new e5({ url: t2 });
    else {
      if (!r5?.parsedUrl) throw new r("createFeatureLayer:missing-information", "Cannot create a FeatureLayer without a url or a parent layer");
      {
  ...
  async queryAttachments(e5, r5) {
    ...
    if (!i5?.data?.supportsAttachment) throw new r("queryAttachments:not-supported", "this layer doesn't support attachments");
    ...
    if (!i5?.operations?.supportsQueryAttachments) {
      if (s9?.length > 0 || l5?.length > 0 || p4?.length > 0 || n6 || y3 || u4) throw new r("queryAttachments:option-not-supported", "when 'capabilities.operations.supportsQueryAttachments' is false, only objectIds is supported", t2);
    }
    if (!(a4?.length || l5?.length || u4)) throw new r("queryAttachments:invalid-query", "'objectIds', 'globalIds', or 'where' are required to perform attachment query", t2);
  ...
  async reload(e5) {
    ...
    if (!r5 && !i5) throw new r("sublayer:missing-layer", "Sublayer can't be loaded without being part of a layer", { sublayer: this });
  ...
  toExportImageJSON(e5) {
    const r5 = { id: this.id, source: this.source?.toJSON() || { mapLayerId: this.id, type: "mapLayer" } }, t2 = o3(e5, this.definitionExpression);
  ...
  _handleSublayersChange(e5, r5) {
    r5 && (r5.forEach((e6) => {
      ...
      (this.layer?.capabilities?.exportMap?.supportsSublayersChanges ?? 1) || (n.getLogger(this).error(new r("sublayer:sublayers-non-modifiable", "Sublayer can't be added, moved, or removed from the layer's sublayers", { sublayer: this, layer: this.layer })), e6.preventDefault());
    })]));
  }
  _logLockedError(e5, r5) {
    const { layer: t2, declaredClass: i5 } = this;
    n.getLogger(i5).error(new r("sublayer:locked", `Property '${String(e5)}' can't be changed on Sublayer from the layer '${t2?.id}'`, { reason: r5, sublayer: this, layer: t2 }));
  }
  _getLayerDomain(e5) {
...
var S4 = (S5) => {
  ...
  let v = class extends m6 {
    constructor(...e5) {
      super(...e5), this.allSublayers = new l3({ getCollections: () => [this.sublayers], getChildrenFunction: (e6) => e6.sublayers }), this.sublayersSourceJSON = { 2: {}, 3: {}, 4: {}, 5: {}, 6: {} }, this.subtables = null, this.addHandles([l(() => this.sublayers, (e6, r5) => this._handleSublayersChange(e6, r5), U), l(() => this.subtables, (e6, r5) => this._handleSublayersChange(e6, r5), U)]);
    }
    destroy() {
    ...
    readSublayers(e5, r5) {
      if (!r5 || !e5) return;
      const { sublayersSourceJSON: s9 } = this, t2 = r3(r5.origin);
      if (t2 < 2) return;
    ...
    createSublayersForOrigin(e5) {
      let r5;
      const s9 = r3("web-document" === e5 ? "web-map" : e5);
    ...
    _handleSublayersChange(e5, r5) {
      r5 && (r5.forEach((e6) => {
        ...
        n.getLogger("esri.layers.TileLayer").error(new r("tilelayer:sublayers-non-modifiable", "Sublayer can't be added, moved, or removed from the layer's sublayers", { layer: this })), e6.preventDefault();
      }), "sublayers-owner"));
    }
  };
...
//# sourceMappingURL=chunk-APKD5K4T.js.map
