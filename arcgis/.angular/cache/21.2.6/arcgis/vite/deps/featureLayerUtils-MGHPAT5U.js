...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (u2(e2)) {
      case "CatalogLayer":
        r2.push(import("./CatalogLayer-QXIEOOHW.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r2.push(import("./FeatureLayer-HEW23VGY.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r2.push(import("./OrientedImageryLayer-UT6XBRQR.js").then((e3) => e3.default));
    }
  });
...
//# sourceMappingURL=featureLayerUtils-MGHPAT5U.js.map
