...
__decorate([a()], d5.prototype, "editsResolver", void 0), __decorate([a({ type: String, json: { write: true } })], d5.prototype, "statusUrl", void 0), __decorate([r2(l3)], d5.prototype, "status", void 0), __decorate([a({ type: Date, json: { type: Number, write: { writer: (t4, e3) => {
  e3.submissionTime = t4 ? t4.getTime() : null;
} } } })], d5.prototype, "submissionTime", void 0), __decorate([a({ type: Date, json: { type: Number, write: { writer: (t4, e3) => {
...
function d6(e3) {
  ...
  let r5;
  return o2(t4) ? r5 = t4.layerId : b2(t4) && (r5 = t4.parent?.layerId), r5 ?? null;
}
function w(e3) {
...
async function S2(e3, t4) {
  if ("Utility Network Layer" === e3) {
    const { default: e4 } = await import("./UtilityNetwork-U76MK4MW.js");
...
var k2 = class extends e2(u2) {
  ...
  async queryNamedTraceConfigurations(e3, t4) {
    const [{ queryNamedTraceConfigurations: r5 }, { default: o4 }] = await Promise.all([import("./queryNamedTraceConfigurations-AUJIMGYU.js"), import("./QueryNamedTraceConfigurationsParameters-YS6BIIO5.js")]), s5 = this.networkServiceUrl, i6 = o4.from(e3);
  ...
  async validateTopology(e3, t4) {
    ...
    const [{ validateNetworkTopology: r5 }, { default: s5 }] = await Promise.all([import("./validateNetworkTopology-Z5GQ2NHU.js"), import("./ValidateNetworkTopologyParameters-XLXO53HT.js")]), i6 = s5.from(e3);
  ...
  async submitTopologyValidationJob(e3, t4) {
    ...
    const [{ submitValidateNetworkTopologyJob: i6 }, { default: a4 }] = await Promise.all([import("./validateNetworkTopology-Z5GQ2NHU.js"), import("./ValidateNetworkTopologyParameters-XLXO53HT.js")]), n5 = a4.from(e3);
...
function N(e3, r5) {
  return new j({ attributes: e3.attributes, geometry: u3(__spreadProps(__spreadValues({}, e3.geometry), { spatialReference: r5 })) });
}
__decorate([a({ type: String, nonNullable: true, json: { origins: { "web-map": { read: true, write: { isRequired: true } } }, read: false } })], k2.prototype, "id", void 0), __decorate([a({ type: String, nonNullable: true, json: { origins: { "web-map": { read: true, write: { isRequired: true } }, service: { read: { source: "name" } } }, read: false } })], k2.prototype, "title", void 0), __decorate([a({ type: String, nonNullable: true, json: { origins: { "web-map": { read: { source: "url" }, write: { target: "url", isRequired: true } } }, read: false } })], k2.prototype, "layerUrl", void 0), __decorate([a({ type: Object, json: { origins: { service: { read: true } }, read: false } })], k2.prototype, "dataElement", void 0), __decorate([a({ type: z, json: { origins: { service: { read: { source: "extent" } } }, read: false } })], k2.prototype, "fullExtent", void 0), __decorate([a({ type: S, json: { origins: { service: { read: { source: "extent.spatialReference" } } }, read: false } })], k2.prototype, "spatialReference", void 0), __decorate([a({ type: ["utility", "trace"], readOnly: true, json: { read: false, write: false } })], k2.prototype, "type", void 0), __decorate([a({ readOnly: true })], k2.prototype, "datasetName", null), __decorate([a({ readOnly: true })], k2.prototype, "owner", null), __decorate([a({ readOnly: true })], k2.prototype, "schemaGeneration", null), __decorate([a({ readOnly: true })], k2.prototype, "parsedUrl", null), __decorate([a({ readOnly: true })], k2.prototype, "featureServiceUrl", null), __decorate([a({ readOnly: true })], k2.prototype, "networkServiceUrl", null), __decorate([a({ readOnly: true })], k2.prototype, "layerId", null), __decorate([a()], k2.prototype, "sourceJSON", void 0), __decorate([a({ readOnly: true })], k2.prototype, "networkSystemLayers", null), __decorate([a({ type: String })], k2.prototype, "gdbVersion", null), __decorate([a({ type: Date })], k2.prototype, "historicMoment", null), __decorate([a()], k2.prototype, "_historicMoment", void 0), __decorate([a()], k2.prototype, "_gdbVersion", void 0), k2 = __decorate([c2("esri.networks.Network")], k2);
var V = k2;

// node_modules/@arcgis/core/networks/RulesTable.js
var f3 = class extends a2(u2) {
  constructor(e3) {
  ...
  _initializeRulesTable() {
    ...
    for (const s5 of this.rules) {
      ...
      for (const o4 of r5) {
        ...
        if (v[f4] = v[f4] ?? {}, c8) {
          v[l5] = v[l5] ?? {};
          const e4 = o3(`assetgroup = ${p3}`, `assettype = ${d7}`);
        ...
        const A = o3(`assetgroup = ${m4}`, `assettype = ${T2}`);
...
__decorate([a({ constructOnly: true })], f3.prototype, "rulesLayer", void 0), __decorate([a({ constructOnly: true })], f3.prototype, "rules", void 0), __decorate([a({ readOnly: true })], f3.prototype, "rulesHash", void 0), __decorate([a()], f3.prototype, "rulesCategorized", void 0), __decorate([a({ constructOnly: true })], f3.prototype, "request", void 0), f3 = __decorate([c2("esri.networks.RulesTable")], f3);
...
__decorate([a({ constructOnly: true })], l4.prototype, "rulesTableId", void 0), __decorate([a({ constructOnly: true })], l4.prototype, "rulesTableUrl", void 0), __decorate([a()], l4.prototype, "subnetworksTable", void 0), __decorate([a({ constructOnly: true })], l4.prototype, "subnetworksTableId", void 0), __decorate([a({ constructOnly: true })], l4.prototype, "subnetworksTableUrl", void 0), __decorate([a({ constructOnly: true })], l4.prototype, "dirtyAreasLayerId", void 0), __decorate([a({ constructOnly: true })], l4.prototype, "dirtyAreasLayerUrl", void 0), __decorate([a()], l4.prototype, "associationsTable", void 0), __decorate([a({ constructOnly: true })], l4.prototype, "associationsTableId", void 0), __decorate([a({ constructOnly: true })], l4.prototype, "associationsTableUrl", void 0), l4 = __decorate([c2("esri.networks.support.NetworkSystemLayers")], l4);
...
__decorate([a({ type: Number, json: { read: { source: "terminalId" }, write: { target: "terminalId" } } })], s3.prototype, "id", void 0), __decorate([a({ type: String, json: { read: { source: "terminalName" }, write: { target: "terminalName" } } })], s3.prototype, "name", void 0), __decorate([a({ type: Boolean, json: { write: true } })], s3.prototype, "isUpstreamTerminal", void 0), s3 = __decorate([c2("esri.networks.support.Terminal")], s3);
var i5 = s3;
...
__decorate([a({ type: String, json: { write: true } })], s4.prototype, "defaultConfiguration", void 0), __decorate([a({ type: Number, json: { read: { source: "terminalConfigurationId" }, write: { target: "terminalConfigurationId" } } })], s4.prototype, "id", void 0), __decorate([a({ type: String, json: { read: { source: "terminalConfigurationName" }, write: { target: "terminalConfigurationName" } } })], s4.prototype, "name", void 0), __decorate([a({ type: [i5], json: { write: true } })], s4.prototype, "terminals", void 0), __decorate([a({ type: a3.apiValues, json: { type: a3.jsonValues, read: a3.read, write: a3.write } })], s4.prototype, "traversabilityModel", void 0), s4 = __decorate([c2("esri.networks.support.TerminalConfiguration")], s4);
...
__decorate([a({ type: String, json: { write: true } })], m3.prototype, "statusUrl", void 0), __decorate([r2(n4)], m3.prototype, "status", void 0), __decorate([a({ type: Date, json: { type: Number, write: { writer: (t4, e3) => {
  e3.submissionTime = t4 ? t4.getTime() : null;
} } } })], m3.prototype, "submissionTime", void 0), __decorate([a({ type: Date, json: { type: Number, write: { writer: (t4, e3) => {
  e3.lastUpdatedTime = t4 ? t4.getTime() : null;
...
var S3 = class extends V {
  ...
  async getCircuitManager(e3) {
    ...
    if (!t4) return null;
    const { default: r5 } = await import("./CircuitManager-S45JCRX4.js");
  ...
  async getUnitIdentifierManager() {
    ...
    const { default: e3 } = await import("./UnitIdentifierManager-WN2WFUTN.js");
  ...
  async queryAssociations(e3, t4) {
    const [{ queryAssociations: r5 }, { default: s5 }] = await Promise.all([import("./queryAssociations-OCVZ64UW.js"), import("./QueryAssociationsParameters-GB3VZKRN.js")]), o4 = s5.from(e3);
  ...
  async synthesizeAssociationGeometries(e3) {
    const [{ synthesizeAssociationGeometries: t4 }, { default: r5 }] = await Promise.all([import("./synthesizeAssociationGeometries-INMFRNDS.js"), import("./SynthesizeAssociationGeometriesParameters-TLOMMUXU.js")]), s5 = r5.from(e3);
    return s5.gdbVersion = this.gdbVersion, s5.moment = this.historicMoment, t4(this.networkServiceUrl, s5);
  }
  async trace(e3) {
    const [{ trace: t4 }, { default: r5 }] = await Promise.all([import("./trace-DLDDLPY3.js"), import("./TraceParameters-5KGWPNZG.js")]), s5 = r5.from(e3);
    return s5.gdbVersion = this.gdbVersion, s5.moment = this.historicMoment, t4(this.networkServiceUrl, s5);
  }
  async submitTraceJob(e3) {
    const [{ submitTraceJob: t4 }, { default: r5 }] = await Promise.all([import("./trace-DLDDLPY3.js"), import("./TraceParameters-5KGWPNZG.js")]), s5 = r5.from(e3);
...
__decorate([a({ readOnly: true })], S3.prototype, "_rulesLayer", null), __decorate([a({ type: [c5], json: { origins: { "web-map": { read: { source: "traceConfigurations" }, write: { target: "traceConfigurations" } }, service: { read: { source: "traceConfigurations" } } }, read: false } })], S3.prototype, "sharedNamedTraceConfigurations", void 0), __decorate([a({ type: ["utility"], readOnly: true, json: { read: false, write: false } })], S3.prototype, "type", void 0), __decorate([a({ readOnly: true })], S3.prototype, "serviceTerritoryFeatureLayerId", null), __decorate([a({ readOnly: true })], S3.prototype, "networkSystemLayers", null), __decorate([a({ readOnly: true })], S3.prototype, "terminalConfigurations", null), __decorate([a({ readOnly: true })], S3.prototype, "domainNetworkNames", null), __decorate([a({ readOnly: true })], S3.prototype, "hasTelecomNetwork", null), __decorate([a({ readOnly: true, json: { read: false } })], S3.prototype, "associationsTable", null), S3 = __decorate([c2("esri.networks.UtilityNetwork")], S3);
var N2 = S3;

export {
  N2 as N
};
//# sourceMappingURL=chunk-EYSKOBKC.js.map
