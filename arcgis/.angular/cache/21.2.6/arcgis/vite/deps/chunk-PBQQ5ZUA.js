...
function a2(t2, s2) {
  ...
  try {
    let r = `this${l2(s2)} = null;`;
    for (const s3 in t2) {
      r += `this${l2(s3)} = ${JSON.stringify(t2[s3])};`;
    }
...
//# sourceMappingURL=chunk-PBQQ5ZUA.js.map
