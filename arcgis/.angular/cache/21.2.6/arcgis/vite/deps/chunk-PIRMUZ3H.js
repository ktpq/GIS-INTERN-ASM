...
var _ = (_2) => {
  ...
  let E = class extends A {
    ...
    async _save(e) {
      ...
      return await Promise.all(i3.resources.pendingOperations ?? []), await this._validateAgainstJSONSchema(o3, i3, t), this.url && (this.portalItem.url = this.url), this.portalItem.title || (this.portalItem.title = this.title), T(this.portalItem, t, 0), await n3(this.portalItem, o3, this.resourceReferences, i3), i2(i3), this.portalItem;
    }
...
//# sourceMappingURL=chunk-PIRMUZ3H.js.map
