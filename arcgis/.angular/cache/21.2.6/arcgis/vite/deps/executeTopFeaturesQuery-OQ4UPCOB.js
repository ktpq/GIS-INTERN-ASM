import {
  m
} from "./chunk-24HZF4ND.js";
import {
  j
} from "./chunk-QKZBJRAH.js";
...
async function s(s2, p, u, a) {
  const m2 = f(s2), i = __spreadValues({}, a), { data: f2 } = await m(m2, j.from(p), u, i);
  return g.fromJSON(f2);
}
export {
  s as executeTopFeaturesQuery
};
//# sourceMappingURL=executeTopFeaturesQuery-OQ4UPCOB.js.map
