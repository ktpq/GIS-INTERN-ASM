...
function v(e, n) {
  const { fieldType: t2, value: l3, orderBy: i2, isDiscrete: a3 } = n, o2 = g(t2, "desc" === i2, "case-insensitive");
...
function g(e, n, t2 = "case-sensitive") {
  if (e) {
    if (r.has(e)) return N(n);
    if (s.has(e)) return D(n, true);
    if ("esriFieldTypeTimestampOffset" === e) return F(n);
    const l4 = D(n, "case-sensitive" === t2);
    if ("esriFieldTypeString" === e) return l4;
    if ("esriFieldTypeGUID" === e || "esriFieldTypeGlobalID" === e) return (e2, n2) => l4(M(e2), M(n2));
  }
  const l3 = n ? 1 : -1, i2 = N(n), a3 = D(n, "case-sensitive" === t2), o2 = x(n);
  return (e2, n2) => "number" == typeof e2 && "number" == typeof n2 ? i2(e2, n2) : "string" == typeof e2 && "string" == typeof n2 ? a3(e2, n2) : o2(e2, n2) ?? l3;
}
...
//# sourceMappingURL=chunk-IW2P55MP.js.map
