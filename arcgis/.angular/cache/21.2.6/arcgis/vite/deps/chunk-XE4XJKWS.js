...
async function k() {
  const [e6, r4, { Feature: t }] = await Promise.all([import("./arcade-SPBHDG3X.js"), import("./arcade-NI2HMEPC.js"), import("./Feature-A6IGHNFB.js")]);
  ...
  async _queryFeatureCount() {
    ...
    if ("subtype-group" === t?.type && !l4) {
      if (this._set("featureCount", 0), this._destroyRelatedFeatureViewModels(), this.featurePage = 1, this.relatedFeatures.destroyAll(), s7 && null != u4) {
        const { default: e7 } = await import("./uniqueValues-W7HGNTGL.js"), { uniqueValueInfos: l5 } = await e7({ layer: t, sqlWhere: `${s7} = '${u4}'`, field: t.subtypeField, signal: r4?.signal }), a5 = l5.map(({ count: e8, value: r5 }) => {
...
//# sourceMappingURL=chunk-XE4XJKWS.js.map
