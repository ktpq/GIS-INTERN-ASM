...
import {
  c as c5
} from "./chunk-FBNCLW2I.js";
import {
  F as F2
} from "./chunk-V54VR3EM.js";
import {
  C,
  c as c4,
  f as f2,
...
var R2 = class {
  ...
  arrayToXYZ(e7, r11 = n2()) {
    return u4(r11, e7[0], e7[1], 0);
  }
  pointToXYZ(e7, r11 = n2()) {
  ...
  apply() {
    ...
    switch (null == this.createdVertex && (n10 = "apply", this.createdVertex = new f3(p5)), l4.type) {
      ...
      case "circular-arc": {
        ...
        f4.push(...u2(s9, e7, this._t));
        break;
      }
      case "elliptic-arc-4": {
        const e7 = l4.toCurveOrCoordinate(), t7 = h2(u5.pos, e7);
        f4.push(...n3(t7, e7, this._t));
        break;
      }
      case "elliptic-arc-7": {
...
var M6 = class _M {
  ...
  _initializeNeighbors() {
    ...
    this._edgeDirection = G2(n2(), t7, e7), i4 ? (this._left = this._computeNeighbor(t7, i4, this._edgeDirection), this._right = this._computeNeighbor(e7, s9, this._edgeDirection, this._left)) : (this._right = this._computeNeighbor(e7, s9, this._edgeDirection), this._left = this._computeNeighbor(t7, i4, this._edgeDirection, this._right));
  }
  _toXYZ(t7) {
  ...
  _bisectVectorsPerpendicular(t7, i4) {
    const e7 = A(t7, i4) < 0 ? t7 : y2(n2(), t7), s9 = Math.abs(A(e7, i4));
    if (!(s9 < A3 || s9 > 1 - A3)) return this._bisectDirection(e7, i4);
    const n10 = P(n2(), e7, [0, 0, 1]);
    return _3(n10, n10);
  }
  _bisectDirection(t7, i4) {
    const e7 = c3(n2(), t7, i4);
    return _3(e7, e7);
  }
  _initializePlane() {
  ...
  _computeNormalDirection(t7) {
    const i4 = P(n2(), t7.direction, this._edgeDirection);
    _3(i4, i4);
    const e7 = P(n2(), this._edgeDirection, i4);
  ...
  _updateIntersectDistanceConstraint(t7) {
    const i4 = y3(t7), h3 = this._edgeDirection, o6 = c3(n2(), this._left.start, this._left.direction), a4 = c3(n2(), this._right.start, this._right.direction), _5 = this._pointInBasis2D(n5(), i4, h3, this._left.start), l4 = this._pointInBasis2D(n5(), i4, h3, o6), p5 = this._pointInBasis2D(n5(), i4, h3, this._right.start), d2 = this._pointInBasis2D(n5(), i4, h3, a4), [m8] = M2({ start: l4, end: _5, type: 1 }, { start: d2, end: p5, type: 1 });
    if (!m8) return;
    const u5 = e2(n5(), _5, l4);
    v(u5, u5);
    const D2 = e2(n5(), m8, l4), x5 = j(u5, D2), V2 = c3(n2(), o6, x2(n2(), this._left.direction, -x5)), N = X(t7, V2);
  ...
  _offset(t7, i4) {
    ...
    const e7 = (t8, i5, e8) => null != i5 && J(this._offsetPlane, t8, c3(n2(), t8, i5), e8), s9 = n2();
  ...
  clampedStartAndEnd(i4) {
    const e7 = this._helper.toXYZ(this._helper.pointToVector(i4)), s9 = R(this._plane, e7, n2()), n10 = X(this._plane, e7), r11 = r2(n10, this._minDistance, this._maxDistance);
  ...
  clone() {
    ...
    return q(t7._plane, this._plane), q(t7._offsetPlane, this._offsetPlane), t7._maxDistance = this._maxDistance, t7._minDistance = this._minDistance, t7._left = this._cloneNeighbor(this._left), t7._right = this._cloneNeighbor(this._right), t7._edgeDirection = o2(n2(), this._edgeDirection), t7;
  }
  ...
  _cloneNeighbor({ start: t7, end: i4, direction: e7, isOriginalDirection: s9 }) {
    return { start: o2(n2(), t7), end: null != i4 ? o2(n2(), i4) : null, direction: o2(n2(), e7), isOriginalDirection: s9 };
  }
};
var z4 = s(15);
var A3 = 1e-3;
...
var a3 = class extends s8 {
  ...
  normalizeCtorArgs(t7) {
    ...
    return __spreadValues({ name: "size", actual: null, parse: B({ createQuantity: (t8, o6) => f2(t8, i4(o6)) }), format: (t8, o6) => o6.formatters.length(t8), formatForInputMode: (t8, r11) => r11.formatters.scalar(g(t8, i4(r11))), suffix: (t8) => t8.inputUnitInfos.length.abbreviation, title: (t8) => t8.messages.sketch.size }, t7);
  }
};
...
function y5(t7) {
  ...
  return new s8(__spreadValues({ name: t7?.name ?? "distance", actual: k2, parse: B({ createQuantity: (t8, a4) => f2(Math.max(t8, 0), e7(a4)) }), format: (t8, e8) => e8.formatters.length(t8), formatForInputMode: (t8, a4) => a4.formatters.scalar(g(t8, e7(a4))), suffix: (t8) => t8.inputUnitInfos.length.abbreviation, title: (t8) => t8.messages.sketch.distance }, t7));
}
function U2(t7) {
  const e7 = (t8) => t8.inputUnitInfos.length.unit;
  return new s8(__spreadValues({ name: t7?.name ?? "radius", actual: k2, parse: B({ createQuantity: (t8, a4) => f2(Math.max(t8, 0), e7(a4)) }), format: (t8, e8) => e8.formatters.length(t8), formatForInputMode: (t8, a4) => a4.formatters.scalar(g(t8, e7(a4))), suffix: (t8) => t8.inputUnitInfos.length.abbreviation, title: (t8) => t8.messages.sketch.radius }, t7));
}
function w4(t7) {
...
function F3(t7) {
  const e7 = (t8) => t8.inputUnitInfos.length.unit;
  return y5(__spreadProps(__spreadValues({}, t7), { parse: B({ createQuantity: (t8, a4) => f2(t8, e7(a4)) }), format: (t8, e8) => e8.formatters.lengthRelative(t8) }));
}
function M7(t7) {
  return new l3(t7);
}
...
//# sourceMappingURL=chunk-R3MAIYCU.js.map
