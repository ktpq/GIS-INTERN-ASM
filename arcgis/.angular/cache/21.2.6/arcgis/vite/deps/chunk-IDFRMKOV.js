...
function R3(t6, n5) {
  ...
  return (c8) => {
    ...
    const s6 = r(c8.screenEnd.x - o5, 0, t6.width), u6 = r(c8.screenEnd.y - l9, 0, t6.height), i7 = i3(s6, u6);
...
function U4(t6, n5, e9 = []) {
  ...
  let r5 = null;
  return (a7) => {
    "start" === a7.action && (r5 = t6.toMap(a7.screenStart, { exclude: e9 }), null != r5 && (r5.z = x2(r5, t6, n5)));
    const o5 = t6.toMap(a7.screenEnd, { exclude: e9 });
    null != o5 && (o5.z = x2(o5, t6, n5));
...
function G2(t6, n5, e9) {
  ...
  return a7.z = r5, a7.hasZ = true, a7.z = x2(a7, n5, e9), a7;
}
function q4(t6, n5) {
  if ("2d" === t6.type) return (t7) => t7;
  let e9 = null;
  ...
  return { snappingStep: [(n5) => {
    ...
    if (null != j7) {
      ...
      if (U6 = C2, h4(s6, C2, g5, p8), w7 = m5, I4 = T5, "end" !== e9) {
        ...
        }, z6({ forceUpdate: false }), null == f6 && (f6 = l2(() => i7.options.effectiveEnabled, () => z6?.({ forceUpdate: true })));
      }
    }
    return "end" === e9 && T4(), n5;
...
var s5 = class extends b {
  constructor(o5) {
    super(o5), this.events = new i2(), this.interactive = true, this.selectable = false, this.cursor = null, this.grabbable = true;
  }
...
var A3 = class extends l3 {
  constructor(t6) {
    super(t6), this._createOperationCompleted = false, this._hideDefaultCursor = false, this._pointerDownStates = new e4(), this._stagedScreenPoint = null, this._stagedPointerType = null, this._updatingHandles = new h(), this._stagedPointerId = null, this.constraintsEnabled = false, this.constraints = void 0, this._getPointConstraint = t(q2), this._getPolylineOrPolygonConstraint = t(z2), this.constraintZ = null, this.defaultZ = null, this.isDraped = true, this.labelOptions = new c5(), this.cursor = null, this.loading = false, this.snapToSceneEnabled = null, this.firstVertex = null, this.lastVertex = null, this.secondToLastVertex = null, null == t6.elevationInfo && (this.elevationInfo = i4(!!t6.hasZ));
  }
  initializePointer() {
  ...
  initialize() {
    ...
    this.coordinateHelper = Y2(this.hasZ, this.hasM, i7), this._editGeometryOperations = new S(new w5(s6, this.coordinateHelper), r5), this._snappingOperation = new p3({ view: e9 }), this.addHandles([l2(() => ({ stagedPoint: this._snappingOperation.stagedPoint, constraint: this._constraint }), ({ stagedPoint: t7, constraint: e10 }, i8) => {
    ...
    }, { equals: (t7, e10) => t7.stagedPoint === e10.stagedPoint && o(t7.constraint, e10.constraint) }), l2(() => this.view.viewpoint, (t7, e10) => {
    ...
    null != a7 && (a7.context = { view: e9, editGeometryOperations: this._editGeometryOperations, elevationInfo: this.elevationInfo, labelOptions: this.labelOptions, automaticLengthMeasurementUtils: this.automaticLengthMeasurementUtils }, this.addHandles(l2(() => this.labelOptions.enabled, (t7) => {
      a7.visible = t7;
    }, w))), this.addHandles(this._editGeometryOperations.on(["vertex-add", "vertex-update", "vertex-remove"], (t7) => {
    ...
    this.manipulators.add(c8), c8.grabbable = "point" !== t6 && "multipoint" !== t6, this.addHandles([c8.events.on("immediate-click", (t7) => this._onImmediateClick(t7)), c8.events.on("immediate-double-click", (t7) => this._onImmediateDoubleClick(t7)), l2(() => this.drawingMode, () => {
      this.removeHandles(L3), this.addHandles(this._createManipulatorDragPipeline(c8), L3);
    }, w), l2(() => ({ effectiveCursor: this.effectiveCursor }), ({ effectiveCursor: t7 }) => {
      c8.cursor = t7;
    }, w)]), x7(this, () => {
...
var u5 = class extends b {
  ...
  get elevationInfo() {
    ...
    return new x3({ mode: i7, offset: o5 });
  }
  ...
  constructor(t6) {
    super(t6), this.layer = null, this.interactive = true, this.selectable = false, this.grabbable = true, this.dragging = false, this.cursor = null, this.consumesClicks = true, this.events = new i2(), this._circleCollisionCache = null, this._graphicSymbolChangedHandle = null, this._originalSymbol = null;
  }
  destroy() {
  ...
  attachSymbolChanged() {
    this.detachSymbolChanged(), this._graphicSymbolChangedHandle = l2(() => this.graphic?.symbol, (t6) => {
...
function F3(o5, i7, r5 = false) {
  ...
  x(i7.basis1, i7.basis1, t6), x(i7.basis2, i7.basis2, s6), k(i7.origin, i7.origin, o5.origin, o5.axis1, t6), k(i7.origin, i7.origin, o5.origin, o5.axis2, s6), K(i7);
}
function S5(a7, m5, g5, p8, u6 = false) {
  p8 || (p8 = D4());
  const N3 = o2(t2.get(), a7[1], -a7[0]), d5 = o2(t2.get(), Number.POSITIVE_INFINITY, Number.POSITIVE_INFINITY), x10 = o2(t2.get(), Number.NEGATIVE_INFINITY, Number.NEGATIVE_INFINITY), j7 = t2.get(), V5 = m5.allVerticesUnordered;
  V5.forEach(({ pos: s6 }) => {
    o2(j7, j2(a7, s6), j2(N3, s6)), f(d5, d5, j7), M(x10, x10, j7);
  });
  const T4 = 1e-6, E6 = o2(t2.get(), x10[0] - d5[0] < T4 ? g5 / 2 : 0, x10[1] - d5[1] < T4 ? g5 / 2 : 0);
...
//# sourceMappingURL=chunk-IDFRMKOV.js.map
