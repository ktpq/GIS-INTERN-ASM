...
async function v(e2) {
  ...
  const a = s.spatialReference, l2 = n2 ? g3.fromJSON(n2) : oe(a), m = a && (A(a) || O(a)) ? s : await f(a, g).then(() => g2(s, g)), f2 = await import("./geodesicBufferOperator-ETBOBYUG.js");
  await f2.load();
...
//# sourceMappingURL=chunk-O2QKXNMI.js.map
