...
var N = class extends e {
  ...
  async featureSetByName(e2, t3 = true, a2 = null) {
    if (m(this._map) && !this._map.loaded) return await this._map.load(), this.featureSetByName(e2, t3, a2);
  ...
  async featureSetById(e2, t3 = true, a2 = ["*"]) {
    if (m(this._map) && !this._map.loaded) return await this._map.load(), this.featureSetById(e2, t3, a2);
    null === a2 && (a2 = ["*"]), a2 = (a2 = a2.slice()).sort();
    const r3 = JSON.stringify(a2);
    for (let l2 = 0; l2 < this._instantLayers.length; l2++) {
      const a3 = this._instantLayers[l2];
...
//# sourceMappingURL=chunk-MTFYEIMB.js.map
