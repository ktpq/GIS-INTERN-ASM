import {
  p
} from "./chunk-F67THCK3.js";
import "./chunk-VXOLKQAF.js";
...
async function e(e2, n, p2) {
  const m = f2(e2), u2 = __spreadProps(__spreadValues({}, n.toJSON()), { f: "json" }), a = u(__spreadValues(__spreadValues({}, m.query), u2)), f3 = s(a, __spreadProps(__spreadValues({}, p2), { method: "post", authMode: "no-prompt" })), d = `${m.path}/unitIdentifiers/insertGap`, { data: j } = await f(d, f3);
  return p.fromJSON(j);
}
export {
  e as insertGap
};
//# sourceMappingURL=insertGap-27UHQC6C.js.map
