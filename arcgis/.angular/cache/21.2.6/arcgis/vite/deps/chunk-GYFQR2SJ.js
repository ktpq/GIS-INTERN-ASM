...
import {
  h as h3
} from "./chunk-QLRHO7K5.js";
import {
  d as d2,
  p as p2,
  y as y2
} from "./chunk-PKOAIVK2.js";
import {
  _ as _3
...
function i4(i6) {
  ...
  -1 === r9 && (r9 = t[1]), r9 = u(r9), n6 = u(n6), o9 = u(o9);
...
var w = class extends o4 {
  ...
  _writePlacedMarkers(s9, n6) {
    ...
    if (!o9) return;
    const a5 = -1, c4 = e.getPlacement(o9, a5, this.evaluatedMeshParams.placement, u(1), s9.id);
    if (!c4) return;
...
var R = class extends j {
  ...
  _writePoly(s9, i6, n6) {
    ...
    if (null == h6) return;
    const { _currentWrite: l9, _tessellationOptions: m3 } = this, { baseSize: u7, capType: c4, joinType: d5, miterLimit: f7 } = this.evaluatedMeshParams, p3 = u(0.5 * u7);
...
var k2 = 128;
var R2 = o3 * o3 / 16;
var $ = P(() => import("./operatorIntersection-6SDLXUY5.js"));
var C2 = P(() => import("./FlatGeometry-TRRRDYLP.js"));
function E2(e3, t, r9) {
  return l(`${e3}${t}${r9}`);
}
...
var Y = class extends v2 {
  ...
  _placeStraightAlong(e3, i6, n6, a5) {
    ...
    if (l9.metricStart(this._createLineLabelMetric(c4, n6, a5, e3.x, e3.y)), x4) {
      const n7 = Math.max(i6, m3[0], 0), a6 = Math.min(S3, m3[1]), f8 = M(n3(), -e3.angle), g3 = { minZoom: n7, maxZoom: a6, clipAngle: _6, mapAligned: true, isLineLabel: true }, p4 = u(this.evaluatedMeshParams.offsetX), x5 = u(this.evaluatedMeshParams.offsetY);
      if (!this._verticalPlacement || this._verticalPlacement === this._current.offsetDirection) {
  ...
  _placeFirst(e3, i6, s9, a5, l9 = false) {
    const { out: c4, id: h6, shaping: m3, zoomRange: u7, referenceBounds: f7 } = this._current, g2 = m3.glyphs, p3 = u(this.evaluatedMeshParams.offsetX), _6 = u(this.evaluatedMeshParams.offsetY), y4 = r3(p3, _6), x4 = M(n3(), -e3.angle);
    S(y4, y4, x4);
    for (const t of g2) {
  ...
  _placeOnSegment(e3, i6, s9, a5, l9, c4, h6) {
    const { out: m3, id: u7, shaping: f7, referenceBounds: g2 } = this._current, p3 = f7.glyphs, _6 = e3.dx / e3.length, y4 = e3.dy / e3.length, x4 = { x: e3.x + s9 * -l9 * _6, y: e3.y + s9 * -l9 * y4 }, b2 = u(this.evaluatedMeshParams.offsetX), P4 = u(this.evaluatedMeshParams.offsetY), v5 = r3(b2, P4), M3 = M(n3(), -e3.angle);
    S(v5, v5, M3);
    for (const t of p3) {
...
function U(e3, t) {
  ...
  for (let u7 = 0; u7 < s9.length; u7++) {
    ...
    for (let s10 = 0; s10 < e4; s10++) {
      ...
      s10 > 0 ? o2(o9, r9[u8], r9[u8 + 1]) : o2(o9, 0, 0), o2(n6, r9[x4], r9[x4 + 1]), s10 < e4 - 1 ? o2(d5, r9[b2], r9[b2 + 1]) : o2(d5, 0, 0), 0 === s10 ? o2(f7, 0, 0) : (B(f7, n6, o9), v(f7, f7), o2(f7, f7[1], -f7[0])), s10 === e4 - 1 ? o2(g2, 0, 0) : (B(g2, d5, n6), v(g2, g2), o2(g2, g2[1], -g2[0])), u2(p3, f7, g2), v(p3, p3);
...
//# sourceMappingURL=chunk-GYFQR2SJ.js.map
