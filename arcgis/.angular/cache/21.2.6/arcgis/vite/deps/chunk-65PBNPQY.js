...
async function F(n3) {
  null == C3 && (C3 = Promise.all([import("./projectOperator-HOS3RJ3I.js").then((n4) => (D = n4, D.load())), import("./projectOperator-PKLTVZQY.js").then((n4) => (W = n4, W.load())), import("./geographicTransformationUtils-PXXULM6T.js").then((n4) => (I = n4, I.load()))])), await C3, s2(n3), B.notify();
}
function H(n3, e3, r3) {
...
async function rn(n3, r3, t3) {
  if (s2(t3), !n3) return n3;
  const o4 = $(Array.isArray(n3) ? n3 : [n3], r3, t3);
  if (o4.pending) return await o4.pending, s2(t3), rn(n3, r3, t3);
...
function an(n3, e3, r3) {
  return n3 ? t(n3) ? un(n3, e3, new _(), r3, 0) : n2(n3) ? jn(n3, e3, new z(), r3, 0) : o2(n3) ? gn(n3, e3, new j(), r3, 0) : e(n3) ? mn(n3, e3, new y(), r3, 0) : i2(n3) ? fn(n3, e3, new m(), r3, 0) : null : null;
}
...
//# sourceMappingURL=chunk-65PBNPQY.js.map
