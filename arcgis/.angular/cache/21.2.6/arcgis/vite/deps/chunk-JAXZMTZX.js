...
var n3 = class extends b {
  ...
  async update(t, r2) {
    const { addOrUpdateResources: e } = await import("./resourceUtils-2FS4DD7A.js");
...
var k = v = class extends a3(u) {
  ...
  async fetchResources(e = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-2FS4DD7A.js");
    return i(this, e, t);
  }
  async addResource(e, t, i) {
    const { addOrUpdateResources: r2 } = await import("./resourceUtils-2FS4DD7A.js");
  ...
  async removeResource(e, t) {
    const { removeResource: r2 } = await import("./resourceUtils-2FS4DD7A.js");
  ...
  async removeAllResources(e) {
    const { removeAllResources: t } = await import("./resourceUtils-2FS4DD7A.js");
    return t(this, e);
  }
  resourceFromPath(e) {
...
//# sourceMappingURL=chunk-JAXZMTZX.js.map
