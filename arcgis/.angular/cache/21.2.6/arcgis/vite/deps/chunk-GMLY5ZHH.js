...
async function F(e3, t) {
  switch (e3.type) {
    case "web-style": {
      const { previewWebStyleSymbol: l3 } = await import("./previewWebStyleSymbol-2N2ZMOKT.js");
      return l3(e3, F, t);
    }
    case "label-3d":
    case "line-3d":
    ...
    case "point-3d":
    case "polygon-3d": {
      const { previewSymbol3D: l3 } = await import("./previewSymbol3D-QUHN7CPR.js");
      return l3(e3, t);
    }
    case "simple-marker":
    case "simple-line":
    ...
    case "picture-fill":
    case "text": {
      const { previewSymbol2D: l3 } = await import("./previewSymbol2D-SOYFOLGS.js");
      return l3(e3, t);
    }
    case "cim": {
      const { previewCIMSymbol: l3 } = await import("./previewCIMSymbol-DRZDXJCW.js");
      return l3(e3, t);
    }
    default:
      return;
...
async function R2(e3, t) {
  ...
  const { getColor: n2, getOpacity: f2, getAllSizes: y3, getRotationAngle: h2 } = await import("./visualVariableUtils-IECIRYDC.js"), m2 = [], d2 = [], b4 = [], g3 = [];
...
//# sourceMappingURL=chunk-GMLY5ZHH.js.map
