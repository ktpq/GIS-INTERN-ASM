...
var x = class extends a3(u2) {
  ...
  async _loadLayersFromJSON(e, r2, t) {
    const s4 = this.resourceInfo?.context, a6 = this.portalItem?.portal || s4?.portal || null, o = O[s4?.origin || ""] ?? "web-map", { populateOperationalLayers: i3 } = await import("./layersCreator-QJI4TYXQ.js"), n4 = [];
...
//# sourceMappingURL=chunk-SMCKWGEF.js.map
