...
var m2 = class extends Z {
  ...
  async _updateClipGeometry() {
    ...
    if (e && "inside" === t2.clippingType) {
      const { extent: t3 } = this.rasterInfo, r4 = await import("./densifyOperator-H7NZB3NS.js"), i2 = await import("./differenceOperator-U7TX3BCS.js");
    ...
    async _getSampleLocations(e) {
      ...
      if ("polyline" === i2) {
        ...
        if (e.sampleCount || e.sampleDistance) {
          const r5 = await import("./densifyOperator-H7NZB3NS.js"), n4 = (await import("./lengthOperator-RLD4UFOI.js")).execute(t2, { unit: "meters" }), s3 = Math.min(e.sampleCount || 100, X);
...
//# sourceMappingURL=chunk-TIAUDHKS.js.map
