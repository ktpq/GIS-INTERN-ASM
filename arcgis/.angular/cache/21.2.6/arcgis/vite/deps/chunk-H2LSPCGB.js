...
var M = class extends l2 {
  ...
  initialize() {
    t(this.view, this.layer), this._highlightHelper = new l4({ view: this.view }), this.refresh(), this.addHandles([l(() => this.graphics.length, () => this.refresh()), f(() => this.view?.ready, () => {
  ...
  _setUpIndicators() {
    if (this._removeIndicators(), this.indicatorsEnabled) {
      for (const i2 of this.graphics) {
        const t3 = i2.clone();
        t3.symbol = E(i2), this._indicators.push(t3), this.addHandles(l(() => i2.symbol, () => this._setUpIndicators()), H);
      }
...
//# sourceMappingURL=chunk-H2LSPCGB.js.map
