...
async function c() {
  if (!u2()) {
    const [n2, t2] = await Promise.all([import("./OperatorProject-EZIFCCHW.js"), import("./SpatialReference-XWO6JU7C.js").then((n3) => n3.aP).then(({ injectPe: n3 }) => n3), P()]);
...
//# sourceMappingURL=chunk-Z5CO7LF4.js.map
