...
async function S2(e2, t, r4) {
  const { applyEdits: n4 } = await import("./editingSupport-OKYY72TO.js"), o2 = await e2.load();
  let i2 = r4;
...
async function v(e2, t, r4) {
  const { uploadAssets: n4 } = await import("./editingSupport-OKYY72TO.js"), o2 = await e2.load();
...
async function Z(t, r4) {
  if (!s2) return;
  const n4 = s2.findCredential(t);
  if (n4) return n4.userId;
  let o2;
  try {
    const n5 = await F(t, r4);
    n5 && (o2 = await s2.checkSignInStatus(`${n5}/sharing`));
  } catch (i2) {
  }
...
async function H(t, r4) {
  ...
  try {
    ...
    o2 && (n4 = await s2.checkSignInStatus(`${o2}/sharing`));
  } catch (o2) {
  }
  if (n4) try {
    const n5 = null != r4 ? r4.signal : null;
    await s2.getCredential(t, { signal: n5 });
  } catch (o2) {
  }
}
...
//# sourceMappingURL=chunk-ATQTOAUP.js.map
