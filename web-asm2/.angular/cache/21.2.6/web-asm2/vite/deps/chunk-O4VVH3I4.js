...
function x3(e7, o3, s4) {
  ...
  c10.origin = c3(n3(), c10.origin, u10);
}
function v(e7, t3, r6) {
...
function l4(r6) {
  const { spatialReference: f8, vertexSpace: l5, untransformedBounds: d4 } = r6, g6 = f2(d4, u7);
...
async function u8(r6, o3, n7) {
  const { source: i4 } = o3, { loadGLTFMesh: a8 } = await p(import("./loadGLTFMesh-MY6EVVMH.js"), n7), c10 = await f6(i4, n7);
  s(n7);
...
async function w2(t3, i4) {
  ...
  if (a2(i4)) throw a8.forEach((e7) => e7.source.dispose()), u();
  return T(a8);
}
...
var a7 = class extends f {
  constructor(e7) {
    super(e7), this.externalSources = new q(), this._explicitDisplaySource = null, this.addHandles(a3(() => this.externalSources, "after-remove", ({ item: e8 }) => {
...
__decorate([a()], a7.prototype, "externalSources", void 0), __decorate([a()], a7.prototype, "displaySource", null), __decorate([a()], a7.prototype, "_implicitDisplaySource", null), __decorate([a()], a7.prototype, "_explicitDisplaySource", void 0), a7 = __decorate([c("esri.geometry.support.meshUtils.Metadata")], a7);
...
function G2(t3, e7, r6) {
  ...
  m6.scale = O(n3(), q4), f3(q4, q4, z2(K, m6.scale));
  const L2 = m6.rotationAxis;
  m6.rotation = y2(q4), 0 === m6.rotationAngle && (m6.rotationAxis = L2), m6.translation = I(n3(), q4);
}
function H(t3, r6, o3) {
...
function L(e7, s4, f8) {
  ...
  x7.scale = O(n3(), L2), f3(L2, L2, z2(V2, x7.scale));
  const M5 = x7.rotationAxis;
  x7.rotation = y2(L2), 0 === x7.rotationAngle && (x7.rotationAxis = M5), x7.translation = I(n3(), L2);
}
...
var Y2 = Q2 = class extends l(p2(m(s2))) {
  constructor(e7) {
  ...
  initialize() {
    (0 === this.metadata.externalSources.length || this.vertexAttributes.position.length) && (this.loadStatus = "loaded"), this.when(() => {
      this.addHandles(l2(() => ({ vertexAttributes: this.vertexAttributes, components: this.components?.map((e7) => e7.clone()) }), () => this._clearSources(), { once: true, sync: true }));
    });
  }
  get hasExtent() {
  ...
  async toBinaryGLTF(e7) {
    const [{ toBinaryGLTF: t3 }] = await Promise.all([import("./gltfexport-BY3ZJVXD.js"), this.load(e7)]);
  ...
  static async createFromGLTF(e7, t3, r6) {
    ...
    const { loadGLTFMesh: o3 } = await p(import("./loadGLTFMesh-MY6EVVMH.js"), r6);
...
__decorate([a({ type: [g2], json: { write: true } })], Y2.prototype, "components", void 0), __decorate([a({ nonNullable: true, types: X2, constructOnly: true, json: { write: true }, clonable: (e7, t3) => n5(t3)?.vertexSpace ?? e7.clone(t3) })], Y2.prototype, "vertexSpace", void 0), __decorate([a({ type: A2, clonable: (e7, t3) => {
  const r6 = n5(t3);
  return r6 && "transform" in r6 ? r6.transform : e7?.clone() ?? e7;
}, json: { write: true } })], Y2.prototype, "transform", void 0), __decorate([a({ constructOnly: true, type: a7, clonable: (e7, t3) => n5(t3)?.metadata ?? e7.clone() })], Y2.prototype, "metadata", void 0), __decorate([a()], Y2.prototype, "hasExtent", null), __decorate([a()], Y2.prototype, "_transformedExtent", null), __decorate([a()], Y2.prototype, "_untransformedBounds", null), __decorate([a()], Y2.prototype, "origin", null), __decorate([a({ readOnly: true, json: { read: false } })], Y2.prototype, "extent", null), __decorate([a({ readOnly: true, json: { read: false, write: true, default: true } })], Y2.prototype, "hasZ", void 0), __decorate([a({ readOnly: true, json: { read: false, write: true, default: false } })], Y2.prototype, "hasM", void 0), __decorate([a({ type: u5, nonNullable: true, json: { write: true }, clonable: (e7, t3) => n5(t3)?.vertexAttributes ?? e7.clone(t3) })], Y2.prototype, "vertexAttributes", void 0), Y2 = Q2 = __decorate([c("esri.geometry.Mesh")], Y2);
var $ = g();

export {
  Y2 as Y
};
//# sourceMappingURL=chunk-O4VVH3I4.js.map
