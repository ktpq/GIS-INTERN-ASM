...
async function i4(n4, r3) {
  ...
  if (s2(r3), !c4) throw new r("imageToArrayBuffer", "Failed to encode image");
  const s5 = await c4.arrayBuffer();
  return s2(r3), { data: s5, type: i5 };
}
function o(e7) {
...
var _3 = class {
  ...
  _createTextureInfo(e7, t6) {
    ...
    return t6 ? (s5.extensions || (s5.extensions = {}), s5.extensions.KHR_texture_transform = { scale: t6.scale, offset: t6.offset, rotation: s(t6.rotation) }, s5) : s5;
  }
  _addTexture(e7) {
...
async function c3(e7, s5) {
  ...
  await Promise.allSettled(c4), s2(s5.signal);
...
//# sourceMappingURL=gltfexport-BY3ZJVXD.js.map
