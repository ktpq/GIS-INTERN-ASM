...
import {
  _,
  l as l3
} from "./chunk-RIO274HV.js";
import {
  e as e5,
  n as n4
} from "./chunk-LBUHOK3S.js";
import {
  M,
  e as e4,
  i as i3,
...
var o5 = P(() => import("./bufferOperator-4BL6Y4SB.js"));
var s6 = P(() => import("./convexHullOperator-TU7TI5SD.js"));
var m = P(() => import("./lengthOperator-ZID3HK7F.js"));
var n7 = P(() => import("./generalizeOperator-UV43TAS6.js"));
var i7 = P(() => import("./graphicBufferOperator-RASJYGMI.js"));
var p3 = P(() => import("./offsetOperator-YL2U6UAJ.js"));
var f3 = P(() => import("./simplifyOperator-GAUELTSM.js"));
var a2 = P(() => import("./jsonConverter-FWXRQAJ2.js"));
var c2 = 512;
var l4;
function g2(e24) {
  switch (e24.type) {
...
var f4 = class extends s4 {
  ...
  processPath(t23) {
    ...
    const n25 = t23.getCurrentPath().asJSON(), h12 = n7.module.execute(n25, 0.25 * this._geomUnitsPerPoint, { removeDegenerateParts: true }), y5 = null == h12 ? null : o3(h12) ? h12.rings : e3(h12) ? h12.paths : null;
...
var s13 = class {
  ...
  _computeTextWidth(t23, i16) {
    ...
    const s16 = i16.font;
    return ("italic" === s16.style || "oblique" === s16.style || "string" == typeof s16.weight && ("bold" === s16.weight || "bolder" === s16.weight) || "number" == typeof s16.weight && s16.weight > 600) && (n25 += 0.3 * t23.measureText("w").width), n25 += 2 * u(this._parameters.halo.size), Math.round(n25);
  }
  ...
  _computeLineHeight() {
    ...
    return i16 && "underline" === i16 && (t23 *= 1.3), Math.round(t23 + 2 * u(this._parameters.halo.size));
  }
...
function r12(t23, i16) {
  const n25 = Math.max(i16.size, 0.5), s16 = i16.font, r15 = `${s16.style} ${s16.weight} ${u(n25).toFixed(1)}px ${s16.family}, sans-serif`;
  let o11;
...
function s15(r15) {
  return e(Math.round(u(r15)));
}
function a9(e24) {
  const r15 = e(Ot), i16 = e(Pt);
...
var lt = class {
  constructor(t23, e24) {
    this._resourceManager = t23, this._transfos = [], this._sizeTransfos = [], this._geomUnitsPerPoint = 1, this._placementPool = new e2(() => new t7(), void 0, void 0, 100), this._earlyReturn = false, this._mapRotation = 0, this._transfos.push(e24 || at.createIdentity()), this._sizeTransfos.push(e24 ? e24.scaleRatio() : 1);
  }
...
var ht = class extends lt {
  ...
  drawSolidFill(t23) {
    ...
    else if (e3(t23)) this._processPath(t23.paths, 0);
    else if (n3(t23)) {
      const e24 = gt(t23);
  ...
  drawSolidStroke(t23, e24, r15) {
    ...
    else if (e3(t23)) this._processPath(t23.paths, i16);
    else if (n3(t23)) {
      const e25 = gt(t23);
...
var ct = class extends lt {
  ...
  hitTest(t23, e24, r15, i16, s16, a10) {
    ...
    if (this._mapRotation = h12 ? s16 : 0, !has("esri-mobile")) {
      const t24 = e(tt * window.devicePixelRatio), r16 = e(et);
  ...
  _hittestSvgPath(t23, e24, r15, i16 = 0) {
    const s16 = this.reverseTransformScalar(this._searchDistPoint) * this.prevGeomUnitsPerPoint(), o11 = this.reverseTransformPt(this._searchPoint), n25 = u2();
    f2(n25, t23);
...
var mt = class extends lt {
  ...
  drawSolidFill(t23, e24) {
    ...
    else if (e3(t23)) this._buildPath(t23.paths, true);
  ...
  drawSolidStroke(t23, e24, r15, i16, s16, o11) {
    ...
    if (o3(t23)) this._buildPath(t23.rings, true);
    else if (e3(t23)) this._buildPath(t23.paths, false);
    else {
  ...
  drawText(t23, e24) {
    if (!e24 || 0 === e24.length) return;
    this._textRasterizer || (this._textRasterizer = new s13());
    const r15 = yt(t23, this.transformSize(e(1))), i16 = this._textRasterizer.rasterizeText(e24, r15);
    if (!i16) return;
  ...
  drawPictureStroke(t23, r15) {
    ...
    const p6 = Math.max(this.transformSize(u(c4)), 0.5), g4 = p6 / d.width, _5 = this._ctx, w4 = _5.createPattern(d, "repeat-y");
    let M3, b3;
  ...
  drawGradientFill(t23, e24) {
    ...
    switch (C2.save(), n25) {
      case "Buffered":
        ...
        break;
      case "Linear": {
        const t24 = (M3 + k) / 2, r16 = "Absolute" === l9 ? this.transformSize(u(a10)) : ee(a10, h12.gradientSize) * (b3 - x4), [i16, s17] = "Discrete" === g4 ? [b3, b3 - r16] : [x4 + r16, x4], n26 = t18([i16, t24], _5), c4 = t18([s17, t24], _5), m4 = C2.createLinearGradient(n26[0], n26[1], c4[0], c4[1]);
        p2(m4, e24), C2.fillStyle = m4, C2.fill("evenodd");
        break;
      }
      case "Circular": {
        const t24 = j(w4), r16 = q(w4) / 2, i16 = "Absolute" === l9 ? this.transformSize(u(a10)) : ee(a10, h12.gradientSize) * r16, [s17, n26] = "Discrete" === g4 ? [r16, r16 - i16] : [i16, 0], c4 = C2.createRadialGradient(t24[0], t24[1], s17, t24[0], t24[1], n26);
      ...
      case "Rectangular": {
        ...
        let m4 = "Absolute" === l9 ? this.transformSize(u(a10)) : ee(a10, h12.gradientSize) * (p(w4) / 2), [p6, y5] = "Discrete" === g4 ? [b3, b3 - m4] : [i16 + m4, i16];
        c4(p6, s17, y5, s17, b3, M3, b3, k), [p6, y5] = "Discrete" === g4 ? [x4, x4 + m4] : [i16 - m4, i16], c4(p6, s17, y5, s17, x4, k, x4, M3), m4 = "Absolute" === l9 ? this.transformSize(u(a10)) : ee(a10, h12.gradientSize) * (b(w4) / 2);
  ...
  drawGradientStroke(t23, r15) {
    ...
    else if (e3(t23)) m4 = t23.paths;
    else {
      if (!n3(t23)) return void nt().error("Unable to draw gradient stroke");
      m4 = gt(t23).rings;
    }
    const f5 = r15.gradientType ?? o4.CIMGradientStroke.gradientType, u10 = Math.max(this.transformSize(u(c4)), 0.5), d = this._ctx;
    let p6, g4;
    ...
    for (let _5 of m4) {
      ...
      const i17 = "Absolute" === a10 ? this.transformSize(u(n25)) : ee(n25, o4.CIMGradientStroke.gradientSize) * ("AcrossLine" === s16 ? u10 : t24);
      let l10 = 0;
      p6 = this.transformPt(_5[0]);
      for (let e24 = 1; e24 < _5.length; e24++) {
        g4 = this.transformPt(_5[e24]);
      ...
      switch (l9.type) {
        ...
        case "CIMPictureMarker": {
          ...
          if (e25.rotateClockwise && (n26 = -n26), o11 && (n26 -= o11), n26) {
            const e26 = G2 * n26, r16 = Math.cos(e26), o12 = Math.sin(e26), a11 = u2([r2, r2, -r2, -r2]);
...
var _4 = class __ {
  ...
  static fromCIMInsidePolygon(e24) {
    ...
    if ("Random" === t23.gridType) {
      const e25 = e(xt), r16 = Math.max(Math.floor(e25 / s16), 1), y5 = Math.max(Math.floor(e25 / i16), 1);
...
//# sourceMappingURL=chunk-RK3JBATE.js.map
