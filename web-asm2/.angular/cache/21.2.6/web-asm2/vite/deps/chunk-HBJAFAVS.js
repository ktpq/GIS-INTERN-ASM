...
function H2(t, e3, n3 = 0) {
  ...
  if (0 !== n3) {
    const e4 = s(n3), i3 = Math.abs(Math.cos(e4)), c5 = Math.abs(Math.sin(e4));
...
async function Y(e3, r3) {
  ...
  let l3 = null;
  u5?.targetGeometry ? l3 = u5.targetGeometry : e3 instanceof z ? l3 = e3 : e3 instanceof s2 ? l3 = await J(e3, r3, n3) : e3 && (l3 = await J(e3.center, r3, n3) || await J(e3.target, r3, n3) || await J(e3, r3, n3)), !l3 && i2?.targetGeometry ? l3 = i2.targetGeometry : !l3 && r3.extent && (l3 = r3.extent), n3 || (n3 = B2(r3.spatialReference || r3.extent || l3)), V() || T(l3.spatialReference, n3) || tn(l3.spatialReference, n3) || await F();
...
//# sourceMappingURL=chunk-HBJAFAVS.js.map
