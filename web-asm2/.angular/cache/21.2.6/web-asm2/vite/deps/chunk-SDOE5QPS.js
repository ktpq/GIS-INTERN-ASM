...
function x3(t6) {
  return c3(t6, __spreadValues({ signDisplay: "exceptZero" }, b2(v2)));
}
function j(t6) {
...
function R(t6) {
  const n13 = U3(t6);
  return c3(n13, __spreadValues({ style: "unit", unitDisplay: "narrow", unit: "degree", signDisplay: n13 > 0 ? "never" : "exceptZero" }, b2(v2)));
}
function $2(t6) {
  return F2(t6, t6.rotationType, v2);
}
...
var N3 = class extends O {
  ...
  loadDependencies() {
    return c4({ button: () => import("./calcite-button-H4HNZWPJ.js"), icon: () => import("./calcite-icon-OGZL6YYI.js"), input: () => import("./calcite-input-DUOG62X3.js") });
  }
  ...
  async _transitionTo(t6, o5) {
    ...
    const i4 = async () => {
      this.destroyed || (this._mode = t6, await P2(), this.destroyed || (this.renderNow(), await P2(), this.destroyed || o5?.()));
    };
...
var m5 = class extends O {
  ...
  loadDependencies() {
    return c4({ button: () => import("./calcite-button-H4HNZWPJ.js"), icon: () => import("./calcite-icon-OGZL6YYI.js"), input: () => import("./calcite-input-DUOG62X3.js"), "input-message": () => import("./calcite-input-message-K2ZLSSJC.js") });
  }
  render() {
...
var l4 = class extends O {
  ...
  loadDependencies() {
    return c4({ button: () => import("./calcite-button-H4HNZWPJ.js"), dropdown: () => import("./calcite-dropdown-CZPQ6CV7.js"), "dropdown-item": () => import("./calcite-dropdown-item-OJFUMIDU.js"), "dropdown-group": () => import("./calcite-dropdown-group-GDNCDDCN.js") });
  }
...
var b3 = class extends l {
  ...
  get _outerContainerStyle() {
    ...
    if (this._lastPosition = c2(t6), null != t6 && null != this.content && (!this.hidden || this.inputModePosition)) {
  ...
  async enterInputMode(t6) {
    const e5 = this.position ?? this._lastPosition ?? this._screenPoint, o5 = this.inputModePosition = c2(e5), { effectivePlacement: n13 } = this;
...
function D3(t6, o5, e5) {
  ...
  P(a6, s12) || (e5?.onRotateStart(0), o5.rotationAngle = s12, e5?.onRotate(u2), e5?.onRotateStop(u2));
}
...
function F4(t6, o5) {
  ...
  return { dx: null == l5 || P(l5, e5) ? 0 : l5 - e5, dy: null == a6 || P(a6, r4) ? 0 : a6 - r4, dz: null == s12 || null == i4 || P(s12, i4) ? 0 : s12 - i4 };
}
function E4(t6, o5) {
  let e5, n13;
...
//# sourceMappingURL=chunk-SDOE5QPS.js.map
