...
var a3 = class _a extends O2 {
  ...
  get geometryType() {
    const e5 = u4(this._current.geometry);
  ...
  _readServerCentroid() {
    switch (this.geometryType) {
      ...
      case "esriGeometryPolyline": {
        const t5 = this._current.projectedGeometry, r2 = u3(t5.paths, this.hasZ), s5 = new s3([], r2, this.hasZ, false);
...
var y4 = class {
  ...
  hitTest(e5, t5, i4, n7, m3) {
    ...
    const p4 = n7 * window.devicePixelRatio * f4, y5 = u2();
    y5[0] = e5 - p4, y5[1] = t5 - p4, y5[2] = e5 + p4, y5[3] = t5 + p4;
    const b7 = n7 * window.devicePixelRatio * h, I = u2();
  ...
  _searchForItems(e5) {
    ...
    if (i4 && t5.isWrappable) {
      ...
      if ((!n7 || !m3) && (n7 || m3)) {
        ...
        let m4;
        m4 = u2(n7 ? [t6, o5[1], t6 + i5 * i, o5[3]] : [r2 - i5 * i, o5[1], r2, o5[3]]);
  ...
  _getSymbolBounds(t5, o5, r2, n7, m3) {
    ...
    if (t5 || (t5 = u2()), e(t5, r2), !n7 || 0 === n7[0] && 0 === n7[1] && 0 === n7[2] && 0 === n7[3]) {
...
var O3 = class extends o2(b) {
  ...
  _createFeatureTile(e5) {
    const t5 = this.view.featuresTilingScheme.getTileBounds(u2(), e5), s5 = this.view.featuresTilingScheme.getTileResolution(e5.level), r2 = new b4(e5, s5, t5[0], t5[3]);
...
//# sourceMappingURL=chunk-KAKPWM4S.js.map
