...
var n = { exports: {} };
function a() {
  return t || (t = 1, r = n, e2 = "undefined" != typeof document ? document.currentScript?.src : void 0, a2 = function(r2 = {}) {
    var t2, n2, a3 = Object.assign({}, r2), o3 = new Promise((r3, e3) => {
      t2 = r3, n2 = e3;
    }), i2 = true, u = Object.assign({}, a3), s = "./this.program", l = "";
    function c(r3) {
      return a3.locateFile ? a3.locateFile(r3, l) : l + r3;
    }
    "undefined" != typeof document && document.currentScript && (l = document.currentScript.src), e2 && (l = e2), l = l.startsWith("blob:") ? "" : l.substr(0, l.replace(/[?#].*/, "").lastIndexOf("/") + 1), a3.print || console.log.bind(console);
    ...
    function S() {
      if (a3.postRun) for ("function" == typeof a3.postRun && (a3.postRun = [a3.postRun]); a3.postRun.length; ) $(a3.postRun.shift());
      G(F);
    }
    function O(r3) {
      C.unshift(r3);
    ...
    var D = 0, M = null;
    function R(r3) {
      D++, a3.monitorRunDependencies?.(D);
    }
    function x(r3) {
      if (D--, a3.monitorRunDependencies?.(D), 0 == D && M) {
        var e3 = M;
        M = null, e3();
      }
    }
    ...
    function Y(r3) {
      return !f && i2 && "function" == typeof fetch ? fetch(r3, { credentials: "same-origin" }).then((e3) => {
    ...
    function q() {
      var r3 = N();
      function e3(r4, e4) {
        return lt = r4.exports, d = lt.N, T(), kr = lt.Q, j(lt.O), x(), lt;
      }
      function t3(r4) {
        e3(r4.instance);
      }
    ...
    var Z, rr, er, tr = {}, nr = {}, ar = {}, or = (r3) => {
      ...
      e3.forEach((r4, e4) => {
        nr.hasOwnProperty(r4) ? a4[e4] = nr[r4] : (o4.push(r4), tr.hasOwnProperty(r4) || (tr[r4] = []), tr[r4].push(() => {
          a4[e4] = nr[r4], ++i3 === o4.length && n3(a4);
        }));
      }), 0 === o4.length && n3(a4);
    }, ur = (r3) => {
      var e3 = X[r3];
      ...
      ir([r3], o4, (r4) => {
        ...
        return a4.forEach((e4, t4) => {
          var n4 = e4.fieldName, i3 = r4[t4], u2 = e4.getter, s2 = e4.getterContext, l2 = r4[t4 + a4.length], c2 = e4.setter, f2 = e4.setterContext;
          o5[n4] = { read: (r5) => i3.fromWireType(u2(s2, r5)), write: (r5, e5) => {
            var t5 = [];
    ...
    var mr = 8, vr = (r3, e3, t3, n3) => {
      ...
      return wr(r3), e3;
    }, toWireType: (r3, e3) => Ar.toHandle(e3), argPackAdvance: mr, readValueFromPointer: Q, destructorFunction: null }, Cr = (r3) => hr(r3, Tr), Pr = (r3, e3, t3) => {
      ...
      }, toWireType: (r4, e4) => e4.value, argPackAdvance: mr, readValueFromPointer: Wr(e3, t3, n3), destructorFunction: null }), Fr(e3, a4);
      ...
      hr(r3, { name: e3 = cr(e3), fromWireType: (r4) => r4, toWireType: (r4, e4) => e4, argPackAdvance: mr, readValueFromPointer: Dr(e3, t3), destructorFunction: null });
    };
    function Rr(r3) {
    ...
    function xr(r3, e3, t3, n3, a4, o4) {
      var i3 = e3.length;
      i3 < 2 && fr("argTypes array size mismatch! Must at least get return value and 'this' types!"), e3[1];
      var u2 = Rr(e3), s2 = "void" !== e3[0].name, l2 = i3 - 2, c2 = new Array(l2), f2 = [], d2 = [];
      return Sr(r3, function(...t4) {
        ...
        for (var i4 = 0; i4 < l2; ++i4) c2[i4] = e3[i4 + 2].toWireType(d2, t4[i4]), f2.push(c2[i4]);
        function h2(r4) {
          if (u2) K(d2);
    ...
    var kr, Hr, Ir, Vr = (r3, e3) => {
    ...
    }, Kr = (r3, e3, t3, n3, a4, o4, i3) => {
      var u2 = Vr(e3, t3);
      r3 = cr(r3), r3 = Xr(r3), a4 = Gr(n3, a4), Fr(r3, function() {
      ...
      for (var a4 = t3, o4 = t3 + n3 - 1, i3 = 0; i3 < r3.length; ++i3) {
        var u2 = r3.charCodeAt(i3);
        if (u2 >= 55296 && u2 <= 57343 && (u2 = 65536 + ((1023 & u2) << 10) | 1023 & r3.charCodeAt(++i3)), u2 <= 127) {
          if (t3 >= o4) break;
          e3[t3++] = u2;
        } else if (u2 <= 2047) {
          if (t3 + 1 >= o4) break;
      ...
      hr(r3, { name: e3, fromWireType(r4) {
        ...
        if (t3) for (var o4 = a4, i3 = 0; i3 <= n3; ++i3) {
          var u2 = a4 + i3;
          if (i3 == n3 || 0 == v[u2]) {
            var s2 = ue(o4, u2 - o4);
          ...
          var l2 = new Array(n3);
          for (i3 = 0; i3 < n3; ++i3) l2[i3] = String.fromCharCode(v[a4 + i3]);
          e4 = l2.join("");
        }
        return dt(r4), e4;
      }, toWireType(r4, e4) {
        ...
        var o4 = ft(4 + n3 + 1), i3 = o4 + 4;
        if (w[o4 >> 2] = n3, t3 && a4) ne(e4, i3, n3 + 1);
        else if (a4) for (var u2 = 0; u2 < n3; ++u2) {
          var s2 = e4.charCodeAt(u2);
          s2 > 255 && (dt(i3), fr("String has UTF-16 code units that do not fit in 8 bits")), v[i3 + u2] = s2;
        }
      ...
      for (var n3 = e3, a4 = n3 + t3 - 4, o4 = 0; o4 < r3.length; ++o4) {
        var i3 = r3.charCodeAt(o4);
        if (i3 >= 55296 && i3 <= 57343 && (i3 = 65536 + ((1023 & i3) << 10) | 1023 & r3.charCodeAt(++o4)), g[e3 >> 2] = i3, (e3 += 4) + 4 > a4) break;
      }
      ...
      var n3, a4, o4, i3;
      t3 = cr(t3), 2 === e3 ? (n3 = ce, a4 = fe, i3 = de, o4 = (r4) => y[r4 >> 1]) : 4 === e3 && (n3 = he, a4 = me, i3 = ve, o4 = (r4) => w[r4 >> 2]), hr(r3, { name: t3, fromWireType: (r4) => {
        for (var t4, a5 = w[r4 >> 2], i4 = r4 + 4, u2 = 0; u2 <= a5; ++u2) {
          var s2 = r4 + 4 + u2 * e3;
          if (u2 == a5 || 0 == o4(s2)) {
            var l2 = n3(i4, s2 - i4);
            void 0 === t4 ? t4 = l2 : (t4 += String.fromCharCode(0), t4 += l2), i4 = s2 + e3;
          }
        }
        return dt(r4), t4;
      }, toWireType: (r4, n4) => {
        "string" != typeof n4 && fr(`Cannot pass non-string to C++ string type ${t3}`);
        var o5 = i3(n4), u2 = ft(4 + o5 + e3);
    ...
    }, ge = (r3, e3, t3, n3, a4, o4, i3, u2, s2, l2) => {
      X[r3].fields.push({ fieldName: cr(e3), getterReturnType: t3, getter: Gr(n3, a4), getterContext: o4, setterArgumentType: i3, setter: Gr(u2, s2), setterContext: l2 });
    }, we = (r3, e3) => {
    ...
    }, Ce = (r3, e3, t3) => (r3 = Ar.toValue(r3), e3 = jr(e3, "emval::as"), Te(e3, t3, r3)), Pe = [], Fe = (r3, e3, t3, n3) => (r3 = Pe[r3])(null, e3 = Ar.toValue(e3), t3, n3), We = {}, Ee = (r3) => {
      var e3 = We[r3];
      return void 0 === e3 ? cr(r3) : e3;
    }, Se = (r3, e3, t3, n3, a4) => (r3 = Pe[r3])(e3 = Ar.toValue(e3), e3[t3 = Ee(t3)], n3, a4), Oe = (r3) => {
      var e3 = Pe.length;
      return Pe.push(r3), e3;
    }, je = (r3, e3) => {
      for (var t3 = new Array(r3), n3 = 0; n3 < r3; ++n3) t3[n3] = jr(w[e3 + 4 * n3 >> 2], "parameter " + n3);
      return t3;
    }, $e = Reflect.construct, De = (r3, e3, t3) => {
      var n3 = je(r3, e3), a4 = n3.shift();
      r3--;
      var o4 = new Array(r3), i3 = (e4, i4, u3, s2) => {
        for (var l2 = 0, c2 = 0; c2 < r3; ++c2) o4[c2] = n3[c2].readValueFromPointer(s2 + l2), l2 += n3[c2].argPackAdvance;
        var f2 = 1 === t3 ? $e(i4, o4) : i4.apply(e4, o4);
        return Te(a4, u3, f2);
      }, u2 = `methodCaller<(${n3.map((r4) => r4.name).join(", ")}) => ${a4.name}>`;
      return Oe(Sr(u2, i3));
    }, Me = (r3, e3) => (r3 = Ar.toValue(r3), e3 = Ar.toValue(e3), Ar.toHandle(r3[e3])), Re = () => Ar.toHandle([]), xe = (r3) => {
      r3 = Ar.toValue(r3);
      ...
      var t3 = (r3 = jr(r3, "_emval_take_value")).readValueFromPointer(e3);
    ...
    var ze = (r3) => {
      ...
      for (var n3 = (r4, e4) => r4 + (e4 - r4 % e4) % e4, a4 = 1; a4 <= 4; a4 *= 2) {
        ...
        var i3 = Math.min(t3, n3(Math.max(r3, o4), 65536));
        if (ze(i3)) return true;
      }
      return false;
    ...
    var at = (r3, e3) => {
      ...
      var a4 = w[n3 + 40 >> 2], o4 = { tm_sec: g[n3 >> 2], tm_min: g[n3 + 4 >> 2], tm_hour: g[n3 + 8 >> 2], tm_mday: g[n3 + 12 >> 2], tm_mon: g[n3 + 16 >> 2], tm_year: g[n3 + 20 >> 2], tm_wday: g[n3 + 24 >> 2], tm_yday: g[n3 + 28 >> 2], tm_isdst: g[n3 + 32 >> 2], tm_gmtoff: g[n3 + 36 >> 2], tm_zone: a4 ? ue(a4) : "" }, i3 = ue(t3), u2 = { "%c": "%a %b %d %H:%M:%S %Y", "%D": "%m/%d/%y", "%F": "%Y-%m-%d", "%h": "%b", "%r": "%I:%M:%S %p", "%R": "%H:%M", "%T": "%H:%M:%S", "%x": "%m/%d/%y", "%X": "%H:%M:%S", "%Ec": "%c", "%EC": "%C", "%Ex": "%m/%d/%y", "%EX": "%H:%M:%S", "%Ey": "%y", "%EY": "%Y", "%Od": "%d", "%Oe": "%e", "%OH": "%H", "%OI": "%I", "%Om": "%m", "%OM": "%M", "%OS": "%S", "%Ou": "%u", "%OU": "%U", "%OV": "%V", "%Ow": "%w", "%OW": "%W", "%Oy": "%y" };
    ...
    var ut, st = { a: L, k: ur, z: sr, w: vr, t: pr, M: Cr, r: Er, j: $r, v: Mr, e: Kr, m: Zr, f: re, L: ee, u: se, s: pe, l: ye, c: ge, x: we, F: be, J: Ae, g: Ce, y: Fe, p: Se, b: wr, n: De, h: Me, q: Re, K: xe, o: ke, d: He, i: Ie, E: Ve, G: Ue, A: Be, I: Ir, H: Ne, C: Xe, D: Ke, B: it }, lt = q(), ct = (r3) => (ct = lt.P)(r3), ft = a3._malloc = (r3) => (ft = a3._malloc = lt.R)(r3), dt = a3._free = (r3) => (dt = a3._free = lt.S)(r3), ht = (r3) => (ht = lt.T)(r3);
    function mt() {
      function r3() {
        ut || (ut = true, a3.calledRun = true, A || (E(), t2(a3), a3.onRuntimeInitialized && a3.onRuntimeInitialized(), S()));
      }
      D > 0 || (W(), D > 0 || (a3.setStatus ? (a3.setStatus("Running..."), setTimeout(function() {
        setTimeout(function() {
          a3.setStatus("");
        }, 1), r3();
      }, 1)) : r3()));
    }
    if (a3.dynCall_viijii = (r3, e3, t3, n3, o4, i3, u2) => (a3.dynCall_viijii = lt.U)(r3, e3, t3, n3, o4, i3, u2), a3.dynCall_iiiiij = (r3, e3, t3, n3, o4, i3, u2) => (a3.dynCall_iiiiij = lt.V)(r3, e3, t3, n3, o4, i3, u2), a3.dynCall_iiiiijj = (r3, e3, t3, n3, o4, i3, u2, s2, l2) => (a3.dynCall_iiiiijj = lt.W)(r3, e3, t3, n3, o4, i3, u2, s2, l2), a3.dynCall_iiiiiijj = (r3, e3, t3, n3, o4, i3, u2, s2, l2, c2) => (a3.dynCall_iiiiiijj = lt.X)(r3, e3, t3, n3, o4, i3, u2, s2, l2, c2), M = function r3() {
      ut || mt(), ut || (M = r3);
    }, a3.preInit) for ("function" == typeof a3.preInit && (a3.preInit = [a3.preInit]); a3.preInit.length > 0; ) a3.preInit.pop()();
    return mt(), o3;
  }, r.exports = a2), n.exports;
  var r, e2, a2;
}
var o2 = a();
...
//# sourceMappingURL=lclayout-CBC636OP.js.map
