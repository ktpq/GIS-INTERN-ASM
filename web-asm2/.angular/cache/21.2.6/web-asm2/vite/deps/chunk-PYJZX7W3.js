...
var r12 = class {
  constructor(i6 = o2(), r15 = r5(0.57735, 0.57735, 0.57735)) {
    this.intensity = i6, this.direction = r15;
  }
};
var c5 = class {
  constructor(i6 = o2(), r15 = r5(0.57735, 0.57735, 0.57735), c8 = true, n11 = 1, o9 = 1) {
...
function u3(n11) {
  return r(Math.floor(Math.sqrt(n11) - 1), 0, 2);
}
...
var _3 = class {
  constructor() {
    this._shOrder = 2, this._legacy = new m6(), this.globalFactor = 0.5, this.noonFactor = 0.5, this._sphericalHarmonics = new n7(), this._mainLight = new c5(n2(), r5(1, 0, 0), false);
  }
  get legacy() {
    return this._legacy;
  }
...
var g5 = class extends b2 {
  ...
  destroy() {
    this._program = r3(this._program), this._pipeline = null;
  }
  get program() {
...
var tt = $ = class extends b2 {
  ...
  copyFrom(t8) {
    o4(this._ray.origin, t8.eye), this.center = t8.center, this.up = t8.up, r7(this._viewport, t8.viewport), this.notifyChange("_viewport"), r7(this._padding, t8.padding), this.notifyChange("_padding"), r4(this._nearFar, t8.nearFar), this.notifyChange("_nearFar"), this._fov = t8.fov, this.row = t8.row, this.column = t8.column, this.rows = t8.rows, this.columns = t8.columns, this.relativeElevation = t8.relativeElevation;
    const i6 = t8;
...
function h5(l9, a9, p7, g8, h6) {
  ...
  if (j8) {
    ...
    P(u5, j8, h6);
    x6 = (A3(u5, g8) > 0 ? 1 : -1) * M(b(r15));
  }
  const v9 = M(b(-A3(g8, l9) / a3(l9)));
...
var t7 = 1e5;
var i4 = 1e6 - t7;
var m8 = r5(5802e-9, 13558e-9, 331e-7);
var s7 = 3;
var f6 = r5(65e-8 * s7, 1881e-9 * s7, 85e-9 * s7);
var a6 = r5(m8[0] + f6[0], m8[1] + f6[1], m8[2] + f6[2]);
...
function l8(e10, r15, u6) {
  const i6 = r15 / u6, s8 = s(e10), l9 = Math.sin(i6 / 2), a9 = Math.cos(s8), c8 = 2 * l(Math.sqrt(l9 * l9 / (a9 * a9)));
  return M(c8);
}

// node_modules/@arcgis/core/chunks/cameraUtilsSpherical.js
var Y = r5(0, 0, 1);
var Z2 = _(n2(), r5(1, 1, 1));
var $2 = e3();
var ee = n2();
var te = n2();
...
function se(e10, r15, s8, n11) {
  ...
  if (Math.abs(m10) < 1e-8) M5 = c8 + d6;
    ...
    const e11 = d6 / g8, t8 = l(c8 / e11), r16 = Math.PI - m10 - t8;
    M5 = e11 * Math.sin(r16);
  }
...
function ae(e10, t8, s8) {
  const n11 = a3(t8), i6 = Math.sqrt(s8 * s8 + n11 * n11 - 2 * s8 * n11 * Math.cos(Math.PI - e10)), a9 = l(s8 / (i6 / Math.sin(e10)));
  return M(e10 - a9);
}
function ce(e10, r15, s8) {
  const n11 = s(e10), i6 = a3(r15);
  return l(s8 / (i6 / Math.sin(n11))) + n11;
}
...
var a8 = class extends b2 {
  ...
  initialize() {
    this.addHandles([l3(() => this.view.ready, (e10) => {
  ...
  render() {
    throw new r2("RenderNode:render-function-not-implemented", "render() is not implemented.");
  }
  get camera() {
...
//# sourceMappingURL=chunk-PYJZX7W3.js.map
