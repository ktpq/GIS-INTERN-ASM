...
var i2 = class {
  ...
  async initialize() {
    const e2 = await r5("RasterWorker");
  ...
  async split(e2, r6) {
    ...
    return s3 && s3.forEach((e3, r7) => {
      s3.set(r7, e3 ? c2.fromJSON(e3) : null);
    }), s3;
  }
  ...
  async mosaicAndTransform(e2, r6) {
    ...
    return { pixelBlock: o5.pixelBlock ? new c2(o5.pixelBlock) : null, localNorthDirections: o5.localNorthDirections };
  }
...
var b2 = u4 = class extends m5(n) {
  ...
  readInputUnit(e2, M2) {
    return S.has(e2) ? s.fromJSON(e2) : null;
  }
  ...
  get rotationVariables() {
    ...
    if (0 === e2.length) {
      const M2 = new s2({ field: "Direction", rotationType: this.rotationType });
      this.visualVariables ? this.visualVariables.push(M2) : this._set("visualVariables", [M2]), e2.push(M2);
    }
    return e2;
  }
  ...
  async getGraphicsFromPixelData(e2, M2 = false, a8 = []) {
    const t3 = new Array(), I = a4(this.inputUnit, this.outputUnit), g2 = this.rotationVariables[0]?.rotationType || this.rotationType, r6 = M2 ? f(e2.pixelBlock, "vector-uv", g2, I) : p2(e2.pixelBlock, "vector-magdir", I);
...
function B2(e2, t3 = false) {
  ...
  return u3(e2, t3) && n3.push("raster-colormap"), t(e2) && n3.push("unique-value"), r4(e2, t3) && n3.push("class-breaks"), e(e2) && n3.push("raster-shaded-relief"), o4(e2) && n3.push("vector-field"), i(e2) && n3.push("flow"), n3;
}
function z2(e2) {
...
function _2(t3, n3, a8, r6) {
  ...
  if (null != l4) l4.features.forEach((t4) => {
    ...
    if (!h2.has(t4.attributes[i4.name]) && null != n4) {
      ...
      b3.push(new p3({ value: t4.attributes[i4.name], label: t4.attributes[i4.name] + "", symbol: new m({ style: "solid", outline: null, color: new g(v ? [t4.attributes[o5.name] * r7, t4.attributes[m8.name] * r7, t4.attributes[f2.name] * r7, 1] : [0, 0, 0, 0]) }) }));
    }
  });
  else if (s3?.[0]) for (let u5 = s3[0].min; u5 <= s3[0].max; u5++) b3.push(new p3({ value: u5, label: u5.toString(), symbol: new m({ style: "solid", outline: null, color: new g([0, 0, 0, 0]) }) }));
...
function H(e2, t3, n3) {
  let r6;
  return null != e2 ? (r6 = t3 ? e2.fields.find((e3) => t3.toLowerCase() === e3.name.toLowerCase()) : K(e2.fields), r6 || (n3 || (r6 = e2.fields.find((e3) => "string" === e3.type)), r6 || (r6 = Q(e2, "value")))) : r6 = new m2({ name: "value" }), r6;
}
function K(e2) {
  let t3;
  for (let n3 = 0; n3 < e2.length; n3++) {
...
var d6 = (d7) => {
  ...
  let h2 = class extends c8 {
    ...
    async createFlowMesh(e2, n3) {
      ...
      return r6 ? r6.createFlowMesh(e2, n3) : c3(e2.meshType, e2.simulationSettings, e2.flowData, e2.startInfo, null != n3.signal ? n3.signal : new AbortController().signal);
    }
...
//# sourceMappingURL=chunk-3XTOFUIZ.js.map
