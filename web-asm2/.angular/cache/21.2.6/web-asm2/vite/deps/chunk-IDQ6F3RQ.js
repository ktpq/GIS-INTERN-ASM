...
var k = v = class extends a3(u) {
  ...
  async fetchResources(e = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-ZCU5NBSZ.js");
    return i(this, e, t);
  }
  async addResource(e, t, i) {
    const { addOrUpdateResources: r2 } = await import("./resourceUtils-ZCU5NBSZ.js");
  ...
  async removeResource(e, t) {
    const { removeResource: r2 } = await import("./resourceUtils-ZCU5NBSZ.js");
  ...
  async removeAllResources(e) {
    const { removeAllResources: t } = await import("./resourceUtils-ZCU5NBSZ.js");
    return t(this, e);
  }
  resourceFromPath(e) {
...
//# sourceMappingURL=chunk-IDQ6F3RQ.js.map
