import {
  l as l4
} from "./chunk-TLF7XQAF.js";
import {
  v
} from "./chunk-VMHZD5KD.js";
import {
  t
} from "./chunk-DDYCAEBC.js";
import {
  Ye
...
async function k() {
  const [e7, r5, { Feature: t2 }] = await Promise.all([import("./arcade-RIBZC52I.js"), import("./arcade-COOFO7DZ.js"), import("./Feature-NZLS7QAX.js")]);
...
var E2 = class extends b {
  ...
  _startCompile() {
    this._evaluateTask = e2(this._evaluateTask), this._compileTask = e2(this._compileTask), this._compileTask = w(async (e7) => {
  ...
  _startEvaluate(e7) {
    this._evaluateTask = e2(this._evaluateTask), this._evaluateTask = w(async (t2) => {
  ...
  async _queryFeatureCount() {
    ...
    if ("subtype-group" === t2?.type && !l5) {
      if (this._set("featureCount", 0), this._destroyRelatedFeatureViewModels(), this.featurePage = 1, this.relatedFeatures.destroyAll(), s8 && null != u5) {
        const { default: e8 } = await import("./uniqueValues-QRRXZXJN.js"), { uniqueValueInfos: l6 } = await e8({ layer: t2, sqlWhere: `${s8} = '${u5}'`, field: t2.subtypeField, signal: r5?.signal }), a6 = l6.map(({ count: e9, value: r6 }) => {
...
var ne = class extends o2(b) {
  ...
  _graphicChanged() {
    this._evaluateExpressionAttributesTask = e2(this._evaluateExpressionAttributesTask), this._graphicChangedTask = e2(this._graphicChangedTask), this._graphicChangedTask = w(async (e7) => {
  ...
  _evaluateExpressionAttributes({ title: e7, content: t2, expressionInfos: i3 }) {
    this._evaluateExpressionAttributesTask = e2(this._evaluateExpressionAttributesTask), this._evaluateExpressionAttributesTask = w(async (s8) => {
...
//# sourceMappingURL=chunk-HMVPCBOE.js.map
