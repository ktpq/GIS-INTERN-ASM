...
var d2 = class extends i4 {
  ...
  static fromSimpleFillSymbol(t6) {
    ...
    return e8 && t6.outline?.cap && (o7.patternCap = t6.outline.cap), new y2({ material: new l5({ color: (t6.color ?? n8).clone() }), pattern: t6.style && "solid" !== t6.style ? new i8({ style: t6.style }) : null, outline: o7 });
  }
};
__decorate([r({ Fill: "fill" }, { readOnly: true })], d2.prototype, "type", void 0), __decorate([a2({ type: l5, json: { write: true } })], d2.prototype, "material", void 0), __decorate([a2(s4)], d2.prototype, "pattern", void 0), __decorate([a2({ type: Boolean, nonNullable: true, json: { write: true, default: true } })], d2.prototype, "castShadows", void 0), __decorate([a2({ type: m6, json: { write: true } })], d2.prototype, "outline", void 0), __decorate([a2(t4)], d2.prototype, "edges", void 0), d2 = y2 = __decorate([c("esri.symbols.FillSymbol3DLayer")], d2);
...
__decorate([a2({ json: { write: false } })], m7.prototype, "color", void 0), __decorate([a2({ json: { write: true } })], m7.prototype, "data", void 0), __decorate([o("data", ["symbol"])], m7.prototype, "readData", null), __decorate([r2("data", {})], m7.prototype, "writeData", null), __decorate([r({ CIMSymbolReference: "cim" }, { readOnly: true })], m7.prototype, "type", void 0), m7 = n9 = __decorate([c("esri.symbols.CIMSymbol")], m7);
...
var d3 = l8 = class extends n2 {
  ...
  writeHref(r6, e8, t6, p20) {
    r6 && (tt(r6) ? e8.dataURI = r6 : (e8.href = m3(r6, p20), Y(e8.href) && (e8.href = K(e8.href))));
  }
  clone() {
...
__decorate([a2({ type: ["style"], readOnly: true, json: { read: true, write: { ignoreOrigin: true, isRequired: true } } })], c8.prototype, "type", void 0), __decorate([a2({ type: e2, json: { default: "begin-end", write: true } })], c8.prototype, "placement", void 0), __decorate([a2({ type: n4, json: { default: "arrow", write: true } })], c8.prototype, "style", void 0), __decorate([a2({ type: g, json: { type: [D], default: null, write: true } })], c8.prototype, "color", void 0), c8 = __decorate([c("esri.symbols.LineStyleMarker3D")], c8);
...
var j3 = class extends i4 {
  ...
  static fromSimpleLineSymbol(t6) {
    const r6 = { enabled: true, size: t6.width ?? e(1), cap: t6.cap || "butt", join: t6.join || "miter", pattern: t6.style ? new i7({ style: t6.style }) : null, imagePattern: null, material: new p8({ color: (t6.color || r4).clone() }), marker: t6.marker ? new c8({ placement: t6.marker.placement, style: t6.marker.style, color: t6.marker.color?.clone() ?? null }) : null };
    return new h4(r6);
  }
};
...
__decorate([a2({ type: y, json: { write: true } })], b3.prototype, "font", null), __decorate([r2("font")], b3.prototype, "writeFont", null), __decorate([a2({ type: m9, json: { write: true } })], b3.prototype, "halo", void 0), __decorate([a2(__spreadProps(__spreadValues({}, m4), { json: { default: "center", write: true } }))], b3.prototype, "horizontalAlignment", void 0), __decorate([a2(__spreadProps(__spreadValues({}, n7), { json: { default: 1, write: true } }))], b3.prototype, "lineHeight", void 0), __decorate([a2({ type: p8, json: { write: true } })], b3.prototype, "material", void 0), __decorate([a2({ type: l9, json: { write: true } })], b3.prototype, "background", void 0), __decorate([a2(i5)], b3.prototype, "size", null), __decorate([a2({ type: String, json: { write: true } })], b3.prototype, "text", void 0), __decorate([r({ Text: "text" }, { readOnly: true })], b3.prototype, "type", void 0), __decorate([a2(__spreadProps(__spreadValues({}, p2), { json: { default: "baseline", write: true } }))], b3.prototype, "verticalAlignment", void 0), __decorate([a2(i10)], b3.prototype, "occludedVisibility", void 0), b3 = g4 = __decorate([c("esri.symbols.TextSymbol3DLayer")], b3);
...
var c11 = m11 = class extends n3 {
  ...
  async _fetchSymbol(t6) {
    ...
    const { resolveWebStyleSymbol: s7 } = await import("./webStyleSymbolUtils-ZKVRXGYW.js");
    s2(t6);
...
var x2 = { base: n3, key: "type", typeMap: { "simple-fill": m2, "picture-fill": f3, "picture-marker": c3, "simple-line": d, "simple-marker": u, text: u2, "label-3d": f2, "line-3d": b5, "mesh-3d": n15, "point-3d": w2, "polygon-3d": f4, "web-style": c11, cim: m7 }, errorContext: "symbol" };
var M2 = { base: n3, key: "type", typeMap: { "picture-marker": c3, "simple-marker": u, "point-3d": w2, cim: m7 }, errorContext: "symbol" };
var C2 = { base: n3, key: "type", typeMap: { "simple-line": d, "line-3d": b5, cim: m7 }, errorContext: "symbol" };
var h7 = { base: n3, key: "type", typeMap: { "simple-fill": m2, "picture-fill": f3, "polygon-3d": f4, cim: m7 }, errorContext: "symbol" };
var g5 = { base: n3, key: "type", typeMap: { "picture-marker": c3, "simple-marker": u, text: u2, "web-style": c11, cim: m7 }, errorContext: "symbol" };
var w3 = s({ types: x2 });
var D3 = { base: n3, key: "type", typeMap: { "simple-fill": m2, "picture-fill": f3, "picture-marker": c3, "simple-line": d, "simple-marker": u, text: u2, "line-3d": b5, "mesh-3d": n15, "point-3d": w2, "polygon-3d": f4, "web-style": c11, cim: m7 }, errorContext: "symbol" };
var P = { base: n3, key: "type", typeMap: { text: u2, "label-3d": f2 }, errorContext: "symbol" };
var F = { base: n3, key: "type", typeMap: { "line-3d": b5, "mesh-3d": n15, "point-3d": w2, "polygon-3d": f4, "web-style": c11, cim: m7 }, errorContext: "symbol" };
var T2 = { base: n3, key: "type", typeMap: { "label-3d": f2 }, errorContext: "symbol" };
var z3 = x(x2);
...
//# sourceMappingURL=chunk-R5ZARNWA.js.map
