...
var m2 = class extends Z {
  ...
  async _updateClipGeometry() {
    ...
    if (e && "inside" === t2.clippingType) {
      const { extent: t3 } = this.rasterInfo, r4 = await import("./densifyOperator-2FWQCD7K.js"), i2 = await import("./differenceOperator-2SQQNOII.js");
    ...
    async _getSampleLocations(e) {
      ...
      if ("polyline" === i2) {
        ...
        if (e.sampleCount || e.sampleDistance) {
          const r5 = await import("./densifyOperator-2FWQCD7K.js"), n4 = (await import("./lengthOperator-JQVCVXM7.js")).execute(t2, { unit: "meters" }), s3 = Math.min(e.sampleCount || 100, X);
...
//# sourceMappingURL=chunk-A4CO2IQY.js.map
