...
var l5 = class extends l(n2) {
  constructor(o7) {
    super(o7), this.color = g.fromArray([0, 0, 0, 0]), this.value = 0, this.enabled = true, this.label = "", this.colorLocked = false;
  }
};
__decorate([a3({ type: g, json: { type: [D], write: { enabled: true, isRequired: true } } })], l5.prototype, "color", void 0), __decorate([a3({ type: Number, json: { write: { enabled: true, isRequired: true } } })], l5.prototype, "value", void 0), __decorate([a3({ type: Boolean, json: { default: true, write: true } })], l5.prototype, "enabled", void 0), __decorate([a3({ type: String, json: { write: true } })], l5.prototype, "label", void 0), __decorate([a3({ type: Boolean, json: { default: false, write: true } })], l5.prototype, "colorLocked", void 0), l5 = __decorate([c("esri.layers.voxel.VoxelIsosurface")], l5);
...
__decorate([a3({ type: g, json: { type: [D], write: { enabled: true, isRequired: true } } })], l6.prototype, "color", void 0), __decorate([a3({ type: Number, json: { write: { enabled: true, isRequired: true } } })], l6.prototype, "position", void 0), l6 = __decorate([c("esri.layers.voxel.VoxelColorStop")], l6);
var c4 = l6;
  ...
  get rasterizedTransferFunction() {
    ...
    if (0 === this.opacityStops.length) for (const t2 of e4) r5.push({ color: t2.color, position: t2.position });
      ...
      for (const t2 of this.opacityStops) {
        const o9 = r(t2.position, 0, 1), r6 = Math.round(255 * r(1 - t2.opacity, 0, 1));
        let i7 = false;
      ...
      for (let t2 = 0; t2 < o8; ++t2) {
        ...
        if (3 !== r6.type) if (1 === r6.type) {
          ...
          if (-1 !== s12 && i7 !== o8) {
            ...
            r6.color.a = Math.round(o(e4[s12].color.a, e4[i7].color.a, o9));
          ...
          if (-1 !== s12 && i7 !== o8) {
            ...
            g4.forEach((e5) => {
              r6.color[e5] = Math.round(o(t3[e5], n6[e5], o9));
            });
    ...
    for (let c6 = 0; c6 < this._colorMapSize; ++c6) {
      ...
      const s12 = (e5 - r5[i6].position) / (r5[l9].position - r5[i6].position), a6 = r5[i6].color, h2 = r5[l9].color, f5 = new g();
      g4.forEach((o8) => {
        f5[o8] = Math.round(o(a6[o8], h2[o8], s12));
      }), f5.a = r(1 - o(a6.a, h2.a, s12) / 255, 0, 1), o7.push(f5);
    }
    return o7;
  }
...
} } } })], y3.prototype, "opacityStops", null), __decorate([a3({ type: p6, json: { write: true } })], y3.prototype, "rangeFilter", void 0), __decorate([a3({ type: [g], clonable: false, json: { read: false } })], y3.prototype, "rasterizedTransferFunction", null), y3 = __decorate([c("esri.layers.voxel.VoxelTransferFunctionStyle")], y3);
var u6 = y3;
var g4 = ["r", "g", "b"];
...
var _6 = class extends _5(l3(g2(_4(l2(e(s3(s4(b)))))))) {
  constructor(e4) {
  ...
  validateLayer(e4) {
    if (e4.layerType && e4.layerType !== this.operationalLayerType) throw new r2("voxel-layer:layer-type-not-supported", "VoxelLayer does not support this layer type", { layerType: e4.layerType });
    if (isNaN(this.version.major) || isNaN(this.version.minor) || this.version.major < 3) throw new r2("layer:service-version-not-supported", "Service version is not supported.", { serviceVersion: this.version.versionString, supportedVersions: "3.x" });
    if (this.version.major > 3) throw new r2("layer:service-version-too-new", "Service version is too new.", { serviceVersion: this.version.versionString, supportedVersions: "3.x" });
  }
...
//# sourceMappingURL=VoxelLayer-TOCYMBP5.js.map
