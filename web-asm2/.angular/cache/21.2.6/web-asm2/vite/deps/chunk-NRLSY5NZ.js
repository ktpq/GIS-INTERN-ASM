...
__decorate([a2({ type: String, json: { type: String, write: true } })], m5.prototype, "max", void 0), __decorate([o("max")], m5.prototype, "readMax", null), __decorate([r("max")], m5.prototype, "writeMax", null), __decorate([a2({ type: String, json: { type: String, write: true } })], m5.prototype, "min", void 0), __decorate([o("min")], m5.prototype, "readMin", null), __decorate([r("min")], m5.prototype, "writeMin", null), __decorate([a2({ type: ["date-picker"], json: { read: false, write: true } })], m5.prototype, "type", void 0), m5 = p6 = __decorate([c("esri.form.elements.inputs.DatePickerInput")], m5);
var l5 = m5;
...
__decorate([a2({ type: Boolean, json: { write: true } })], l6.prototype, "includeTimeOffset", void 0), __decorate([a2({ type: String, json: { type: String, write: true } })], l6.prototype, "max", void 0), __decorate([o("max")], l6.prototype, "readMax", null), __decorate([r("max")], l6.prototype, "writeMax", null), __decorate([a2({ type: String, json: { type: String, write: true } })], l6.prototype, "min", void 0), __decorate([o("min")], l6.prototype, "readMin", null), __decorate([r("min")], l6.prototype, "writeMin", null), __decorate([a2({ type: String, json: { type: String, write: true } })], l6.prototype, "timeResolution", void 0), __decorate([o("timeResolution")], l6.prototype, "readTimeResolution", null), __decorate([r("timeResolution")], l6.prototype, "writeTimeResolution", null), __decorate([a2({ type: ["datetimeoffset-picker"], json: { read: false, write: true } })], l6.prototype, "type", void 0), l6 = s14 = __decorate([c("esri.form.elements.inputs.DateTimeOffsetPickerInput")], l6);
var u3 = l6;
...
__decorate([a2({ type: Boolean, json: { write: true } })], s15.prototype, "includeTime", void 0), __decorate([a2({ type: Date, json: { type: Number, write: true } })], s15.prototype, "max", void 0), __decorate([o("max")], s15.prototype, "readMax", null), __decorate([r("max")], s15.prototype, "writeMax", null), __decorate([a2({ type: Date, json: { type: Number, write: true } })], s15.prototype, "min", void 0), __decorate([o("min")], s15.prototype, "readMin", null), __decorate([r("min")], s15.prototype, "writeMin", null), __decorate([a2({ type: ["datetime-picker"], json: { read: false, write: true } })], s15.prototype, "type", void 0), s15 = p8 = __decorate([c("esri.form.elements.inputs.DateTimePickerInput")], s15);
var u4 = s15;
...
__decorate([a2({ type: String, json: { type: String, write: true } })], l7.prototype, "max", void 0), __decorate([o("max")], l7.prototype, "readMax", null), __decorate([r("max")], l7.prototype, "writeMax", null), __decorate([a2({ type: String, json: { type: String, write: true } })], l7.prototype, "min", void 0), __decorate([o("min")], l7.prototype, "readMin", null), __decorate([r("min")], l7.prototype, "writeMin", null), __decorate([a2({ type: String, json: { type: String, write: true } })], l7.prototype, "timeResolution", void 0), __decorate([o("timeResolution")], l7.prototype, "readTimeResolution", null), __decorate([r("timeResolution")], l7.prototype, "writeTimeResolution", null), __decorate([a2({ type: ["time-picker"], json: { read: false, write: true } })], l7.prototype, "type", void 0), l7 = s20 = __decorate([c("esri.form.elements.inputs.TimePickerInput")], l7);
var u5 = l7;
...
__decorate([a2({ json: { write: true } })], u7.prototype, "elements", null), __decorate([s("elements")], u7.prototype, "castElements", null), __decorate([o("elements", ["formElements"])], u7.prototype, "readElements", null), __decorate([r("elements")], u7.prototype, "writeElements", null), __decorate([a2({ type: ["collapsed", "expanded"], json: { write: true } })], u7.prototype, "initialState", void 0), __decorate([a2({ type: String, json: { read: false, write: true } })], u7.prototype, "type", void 0), u7 = d2 = __decorate([c("esri.form.elements.GroupElement")], u7);
var f2 = h(u7);
var E = u7;
...
function k2(e) {
  ...
  for (const s23 of e) if (u(t2, s23.visibilityExpression), !m9(s23)) {
    if (u6(s23)) r2(t2, k2(s23.elements));
...
__decorate([a2({ type: String, json: { write: true } })], g.prototype, "description", void 0), __decorate([a2({ json: { write: true } })], g.prototype, "elements", null), __decorate([m2("elements")], g.prototype, "castElements", null), __decorate([o("elements", ["formElements"])], g.prototype, "readElements", null), __decorate([r("elements")], g.prototype, "writeElements", null), __decorate([a2({ type: [n2], json: { write: true } })], g.prototype, "expressionInfos", void 0), __decorate([a2({ type: Boolean, json: { default: false, write: true } })], g.prototype, "preserveFieldValuesWhenHidden", void 0), __decorate([a2({ type: Boolean, json: { default: false, write: true } })], g.prototype, "supportsAttachmentElements", void 0), __decorate([a2({ type: String, json: { write: true } })], g.prototype, "title", void 0), g = __decorate([c("esri.form.FormTemplate")], g);

export {
  l8 as l,
  g
};
//# sourceMappingURL=chunk-NRLSY5NZ.js.map
