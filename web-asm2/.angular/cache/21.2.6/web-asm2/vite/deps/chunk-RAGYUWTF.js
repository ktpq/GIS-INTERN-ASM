...
function a4(t2) {
  ...
  if ("string" == typeof t2) {
    const c9 = g.fromString(t2);
    if (!c9) return n6().errorOnce(new r2("mapview:mesh-processing", "Unable to parse string into color", { color: t2 })), [0, 0, 0, 0];
    o13 = c9.toArray();
  } else o13 = t2;
...
var a5 = class {
  ...
  async loadDependencies() {
    for (const { effect: e6 } of this.effectInfos || []) await g2(e6);
  }
...
var v = class extends a5 {
  ...
  _getShaping(o13) {
    ...
    const r12 = u(i9.fontSize), n11 = u(i9.offsetX), h7 = u(i9.offsetY), f7 = s15.glyphs.sdfSize, p6 = r(u(s15.lineWidth), Ot, Pt), m6 = f7 / 24 * l2 * r(s15.lineHeightRatio, 0.25, 4);
...
//# sourceMappingURL=chunk-RAGYUWTF.js.map
