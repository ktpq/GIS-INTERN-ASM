...
var r7 = class {
  constructor(r9, i5) {
    if (this._events = new i2(), this._entries = /* @__PURE__ */ new Map(), this._timings = new t2(10), this._currentContainer = null, this._currentPass = null, this._currentBrush = null, this._currentSummary = null, !n5) return;
...
var d2 = class extends b {
  ...
  _end(t5, e2, r9, o4, a6) {
    const n8 = this.view, h6 = n8.toMap(i(t5 + 0.5 * r9, e2 + 0.5 * o4));
...
var g4 = class extends b {
  constructor(t5) {
    super(t5), this.animationTime = t(0), this.momentumEstimator = new c5(500, 6, 0.92), this.momentum = null, this.tmpMomentum = n(), this.momentumFinished = false, this.viewpoint = new c2({ targetGeometry: new _(), scale: 0, rotation: 0 }), this._previousDrag = null, this.addHandles(f2(() => this.momentumFinished, () => this.navigation.stop()));
  }
  begin(t5, i5) {
  ...
  addToEstimator(t5) {
    const i5 = t5.center.x, o4 = t5.center.y, e2 = f(-i5, o4), m3 = r3(-i5, o4, 0);
...
//# sourceMappingURL=chunk-CVBWMW6A.js.map
