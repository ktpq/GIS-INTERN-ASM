...
function r2(e11) {
  ...
  return isNaN(n12.getTime()) ? (t().error("Accessor#set", `Invalid date value: '${e11}', falling back to current date`), /* @__PURE__ */ new Date()) : n12;
}
function o4(e11) {
...
function g(e11, n12) {
  return !!i(n12) && (t().error("Accessor#set", "Assigning an instance of '" + (n12.declaredClass || "unknown") + "' which is not a subclass of '" + h(e11) + "'"), true);
}
function m(e11, n12) {
...
function b(e11) {
  switch (e11) {
    ...
    case _:
      return c;
    default:
      return e2(d, e11, () => m.bind(null, e11));
  }
}
function w(e11, n12) {
  const t7 = b(e11);
...
function S(e11, n12) {
  ...
  return (e12, n13) => {
    ...
    return l6 && (r9.has(e12) || u7.some((e13) => "string" === c7 && e13 === String || "number" === c7 && e13 === Number)) || "object" === c7 && u7.some((n14) => !f(n14, e12)) ? e12 : (l6 && o15.length ? (a11 || (a11 = o15.map((e13) => "string" == typeof e13 ? `'${e13}'` : `${e13}`).join(", ")), t().error("Accessor#set", `'${e12}' is not a valid value for this property, only the following values are valid: ${a11}`)) : "object" == typeof e12 && u7.length ? (s9 || (s9 = u7.map((e13) => h(e13)).join(", ")), t().error("Accessor#set", `'${e12}' is not a valid value for this property, value must be one of ${s9}`)) : t().error("Accessor#set", `'${e12}' is not a valid value for this property`), n13 && (n13.valid = false), null);
  };
}
function x(e11, n12) {
  ...
  return (n13) => {
    ...
    if (!u8) return t().error("Accessor#set", `Invalid property value, value needs to be one of ${a11()}, or a plain object that can autocast (having .type = ${s9()})`), null;
    if (!f(e11.typeMap[o16], n13)) return n13;
    if ("string" == typeof e11.key && !i(n13)) {
      const t7 = {};
...
function F(e11) {
  let n12 = null;
  return (r9, o15) => O(r9, e11) ? r9 : (null == n12 && (n12 = L(e11)), t().error("Accessor#set", `Invalid property value, value needs to be of type ${n12}`), o15 && (o15.valid = false), null);
}
function L(e11) {
  switch (e11.type) {
    case "native":
...
function i2(t7, i8) {
  ...
  const u7 = n2(i8);
  return e3(u7, e11) ? u7.get(e11) : i8[e11];
}
function e4(t7, n12, r9) {
  if (null == t7) return t7;
  const u7 = i2(n12[r9], t7);
  return !u7 && r9 < n12.length - 1 ? void 0 : r9 === n12.length - 1 ? u7 : e4(u7, n12, r9 + 1);
}
function u3(n12, r9, u7 = 0) {
  return "string" != typeof r9 || r9.includes(".") ? e4(n12, o3(r9), u7) : i2(r9, n12);
}
function o5(t7, n12) {
  return u3(t7, n12);
}
function s2(t7, n12) {
  return void 0 !== u3(n12, t7);
}
...
function t2(o15, e11, s9) {
  if (o15 && e11) if ("object" == typeof e11) for (const r9 of Object.getOwnPropertyNames(e11)) t2(o15, r9, e11[r9]);
  else {
    if (e11.includes(".")) {
      const n12 = e11.split("."), i9 = n12.splice(-1, 1)[0];
      return void t2(o5(o15, n12), i9, s9);
    }
...
function n4(r9, t7) {
  if (has("esri-unknown-property-errors") && !e5(r9, t7)) throw new r("set:unknown-property", s3(r9, t7));
}
function e5(o15, r9) {
...
function a5(o15, n12, t7, i8, s9) {
  o15 && o15?.messages?.push(l2("warning" === n12 ? t3 : r, t7, i8, s9));
}
...
function b2(t7, e11, o15) {
  const i8 = Object.values(e11)[0], p7 = r3(i8.prototype)[t7], u7 = i4(p7, o15), s9 = u7?.read?.source;
...
function o11(r9, t7) {
  ...
  r9 && (1 === n12 || "type" in r9 && e6(r9.type)) ? t7.write.writer = a7 : n12 > 1 ? t7.write.writer = l4(n12) : t7.types ? Array.isArray(t7.types) ? t7.write.writer = f3(t7.types[0]) : t7.write.writer = i5(t7.types) : t7.write.writer = s6;
}
function i5(r9) {
...
function r6(r9, a11 = {}) {
  const t7 = r9 instanceof o2 ? r9 : new o2(r9, a11), { alwaysWriteDefaults: l6, default: o15, ignoreUnknown: s9 = true, name: i8, nonNullable: u7, readOnly: p7 = false } = a11;
...
function o13(n12) {
  ...
  return function(...t7) {
    ...
    return e8.apply(this, t7);
  };
}
function e8(t7, r9, o15, e11) {
  o6(t7, r9).cast = e11;
}
function i6(t7) {
  return (r9, o15) => {
...
function s8(...t7) {
  if (3 !== t7.length || "string" != typeof t7[1]) return 1 === t7.length && "[object Function]" === r8.call(t7[0]) ? o13(t7[0]) : 1 === t7.length && "string" == typeof t7[0] ? i6(t7[0]) : void 0;
}
...
var e9 = class _e {
  ...
  acquire(...t7) {
    ...
    return this._acquireFunction ? this._acquireFunction(s9, ...t7) : i7(s9) && s9.acquire(...t7), s9;
  }
  release(i8) {
    i8 && !_e.test.disabled && (this._releaseFunction ? this._releaseFunction(i8) : t5(i8) && i8.release(), this._pool.push(i8));
  }
...
//# sourceMappingURL=chunk-GUGGSMY4.js.map
