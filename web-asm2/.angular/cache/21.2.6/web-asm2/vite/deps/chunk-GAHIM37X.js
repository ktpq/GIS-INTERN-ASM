...
async function S2(e3, t4) {
  if ("Utility Network Layer" === e3) {
    const { default: e4 } = await import("./UtilityNetwork-64JELV7R.js");
...
var k2 = class extends e2(u3) {
  ...
  async queryNamedTraceConfigurations(e3, t4) {
    const [{ queryNamedTraceConfigurations: r5 }, { default: o4 }] = await Promise.all([import("./queryNamedTraceConfigurations-WN3UBK4I.js"), import("./QueryNamedTraceConfigurationsParameters-KWF33IQ3.js")]), s5 = this.networkServiceUrl, i6 = o4.from(e3);
  ...
  async validateTopology(e3, t4) {
    ...
    const [{ validateNetworkTopology: r5 }, { default: s5 }] = await Promise.all([import("./validateNetworkTopology-XBSROBIU.js"), import("./ValidateNetworkTopologyParameters-4TNMOGYS.js")]), i6 = s5.from(e3);
  ...
  async submitTopologyValidationJob(e3, t4) {
    ...
    const [{ submitValidateNetworkTopologyJob: i6 }, { default: a4 }] = await Promise.all([import("./validateNetworkTopology-XBSROBIU.js"), import("./ValidateNetworkTopologyParameters-4TNMOGYS.js")]), n5 = a4.from(e3);
...
var S3 = class extends V {
  ...
  async getCircuitManager(e3) {
    ...
    if (!t4) return null;
    const { default: r5 } = await import("./CircuitManager-JO3TDGKK.js");
  ...
  async getUnitIdentifierManager() {
    ...
    const { default: e3 } = await import("./UnitIdentifierManager-XZUGPQL7.js");
  ...
  async queryAssociations(e3, t4) {
    const [{ queryAssociations: r5 }, { default: s5 }] = await Promise.all([import("./queryAssociations-6XD2QGUP.js"), import("./QueryAssociationsParameters-KIGNL7T5.js")]), o4 = s5.from(e3);
  ...
  async synthesizeAssociationGeometries(e3) {
    const [{ synthesizeAssociationGeometries: t4 }, { default: r5 }] = await Promise.all([import("./synthesizeAssociationGeometries-VDUADWHE.js"), import("./SynthesizeAssociationGeometriesParameters-7UIT2QTV.js")]), s5 = r5.from(e3);
    return s5.gdbVersion = this.gdbVersion, s5.moment = this.historicMoment, t4(this.networkServiceUrl, s5);
  }
  async trace(e3) {
    const [{ trace: t4 }, { default: r5 }] = await Promise.all([import("./trace-UJVGHOZY.js"), import("./TraceParameters-LV7XE7UO.js")]), s5 = r5.from(e3);
    return s5.gdbVersion = this.gdbVersion, s5.moment = this.historicMoment, t4(this.networkServiceUrl, s5);
  }
  async submitTraceJob(e3) {
    const [{ submitTraceJob: t4 }, { default: r5 }] = await Promise.all([import("./trace-UJVGHOZY.js"), import("./TraceParameters-LV7XE7UO.js")]), s5 = r5.from(e3);
...
//# sourceMappingURL=chunk-GAHIM37X.js.map
