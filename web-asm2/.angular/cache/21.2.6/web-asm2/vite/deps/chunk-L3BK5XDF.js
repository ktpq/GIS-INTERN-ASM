...
var i3 = class _i {
  ...
  decode(n11, s3, r12) {
    ...
    return new Promise((t6, d2) => {
      ...
      m3.src = v3, m3.onload = () => {
        if (URL.revokeObjectURL(v3), a3(r12)) return void d2(u());
...
__decorate([a2({ type: Number, json: { write: true } })], p2.prototype, "blockWidth", void 0), __decorate([a2({ type: Number, json: { write: true } })], p2.prototype, "blockHeight", void 0), __decorate([a2({ type: String, json: { write: true } })], p2.prototype, "compression", void 0), __decorate([a2({ type: _, json: { write: true } })], p2.prototype, "origin", void 0), __decorate([a2({ type: Number, json: { write: true } })], p2.prototype, "firstPyramidLevel", void 0), __decorate([a2({ type: Number, json: { write: true } })], p2.prototype, "maximumPyramidLevel", void 0), __decorate([a2({ json: { write: true } })], p2.prototype, "pyramidResolutions", void 0), __decorate([a2({ type: Number, json: { write: true } })], p2.prototype, "pyramidScalingFactor", void 0), __decorate([a2({ type: Number, json: { write: true } })], p2.prototype, "pyramidBlockWidth", void 0), __decorate([a2({ type: Number, json: { write: true } })], p2.prototype, "pyramidBlockHeight", void 0), __decorate([a2({ json: { write: true } })], p2.prototype, "isBsqTile", void 0), __decorate([a2({ type: Boolean, json: { write: true } })], p2.prototype, "isVirtualTileInfo", void 0), __decorate([a2({ json: { write: true } })], p2.prototype, "tileInfo", void 0), __decorate([a2()], p2.prototype, "transposeInfo", void 0), __decorate([a2({ json: { write: true } })], p2.prototype, "blockBoundary", void 0), p2 = l4 = __decorate([c("esri.layers.support.RasterStorageInfo")], p2);
...
__decorate([a2({ json: { name: "BandName", write: true } })], o7.prototype, "name", void 0), __decorate([a2({ json: { read: { source: ["WavelengthMin", "Wavelength"], reader: (e6, a10) => t5(a10.WavelengthMin ?? a10.Wavelength) }, write: { target: "WavelengthMin" } } })], o7.prototype, "minWavelength", void 0), __decorate([a2({ json: { name: "WavelengthMax", read: { reader: t5 }, write: true } })], o7.prototype, "maxWavelength", void 0), __decorate([a2({ json: { name: "RadianceBias", read: { reader: t5 }, write: true } })], o7.prototype, "radianceBias", void 0), __decorate([a2({ json: { name: "RadianceGain", read: { reader: t5 }, write: true } })], o7.prototype, "radianceGain", void 0), __decorate([a2({ json: { name: "ReflectanceBias", read: { reader: t5 }, write: true } })], o7.prototype, "reflectanceBias", void 0), __decorate([a2({ json: { name: "ReflectanceGain", read: { reader: t5 }, write: true } })], o7.prototype, "reflectanceGain", void 0), __decorate([a2({ json: { name: "SolarIrradiance", read: { reader: t5 }, write: true } })], o7.prototype, "solarIrradiance", void 0), o7 = n9 = __decorate([c("esri.layers.support.RasterBandInfo")], o7);
...
__decorate([a2({ type: Date, json: { name: "AcquisitionDate", write: true } })], u4.prototype, "acquisitionDate", void 0), __decorate([o("acquisitionDate")], u4.prototype, "readAcquisitionDate", null), __decorate([r2("acquisitionDate")], u4.prototype, "writeAcquisitionDate", null), __decorate([a2({ json: { name: "CloudCover", read: { reader: a9 }, write: true } })], u4.prototype, "cloudCover", void 0), __decorate([a2({ json: { name: "ProductName", write: true } })], u4.prototype, "productName", void 0), __decorate([a2({ json: { name: "SensorName", write: true } })], u4.prototype, "sensorName", void 0), __decorate([a2({ json: { name: "SensorAzimuth", read: { reader: a9 }, write: true } })], u4.prototype, "sensorAzimuth", void 0), __decorate([a2({ json: { name: "SensorElevation", read: { reader: a9 }, write: true } })], u4.prototype, "sensorElevation", void 0), __decorate([a2({ json: { name: "SunAzimuth", read: { reader: a9 }, write: true } })], u4.prototype, "sunAzimuth", void 0), __decorate([a2({ json: { name: "SunElevation", read: { reader: a9 }, write: true } })], u4.prototype, "sunElevation", void 0), u4 = n10 = __decorate([c("esri.layers.support.RasterSensorInfo")], u4);
...
__decorate([a2({ json: { write: true } })], m2.prototype, "attributeTable", void 0), __decorate([a2({ json: { write: true } })], m2.prototype, "bandCount", void 0), __decorate([a2({ readOnly: true })], m2.prototype, "bandInfos", null), __decorate([a2({ json: { write: true } })], m2.prototype, "colormap", void 0), __decorate([a2({ type: String, readOnly: true })], m2.prototype, "dataType", null), __decorate([a2({ type: z, json: { write: true } })], m2.prototype, "extent", void 0), __decorate([a2({ type: z, json: { write: true } })], m2.prototype, "nativeExtent", null), __decorate([a2({ json: { write: true } })], m2.prototype, "nativePixelSize", null), __decorate([a2({ json: { write: true } })], m2.prototype, "format", void 0), __decorate([a2({ json: { write: true } })], m2.prototype, "height", void 0), __decorate([a2({ json: { write: true } })], m2.prototype, "width", void 0), __decorate([a2({ json: { write: true } })], m2.prototype, "hasMultidimensionalTranspose", null), __decorate([a2({ json: { write: true } })], m2.prototype, "histograms", void 0), __decorate([a2({ json: { write: true } })], m2.prototype, "keyProperties", void 0), __decorate([a2({ json: { write: true } })], m2.prototype, "multidimensionalInfo", void 0), __decorate([a2({ json: { write: true } })], m2.prototype, "noDataValue", void 0), __decorate([a2({ json: { write: true } })], m2.prototype, "pixelSize", void 0), __decorate([a2({ type: n8.apiValues, json: { write: true } })], m2.prototype, "pixelType", void 0), __decorate([a2()], m2.prototype, "isPseudoSpatialReference", void 0), __decorate([a2({ readOnly: true })], m2.prototype, "sensorInfo", null), __decorate([a2({ type: S, json: { write: true } })], m2.prototype, "spatialReference", void 0), __decorate([a2({ json: { write: true } })], m2.prototype, "statistics", void 0), __decorate([a2({ type: p2, json: { write: true } })], m2.prototype, "storageInfo", void 0), __decorate([a2({ json: { write: true } })], m2.prototype, "transform", void 0), m2 = u5 = __decorate([c("esri.layers.support.RasterInfo")], m2);
...
//# sourceMappingURL=chunk-L3BK5XDF.js.map
