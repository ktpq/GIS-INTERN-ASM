...
function n() {
  return t || (t = 1, a = e, r2 = globalThis.document?.currentScript?.src, n2 = async function(a2 = {}) {
    ...
    var it, st, ut, ft, lt, ht, ct, wt, dt = { 212604: () => "undefined" != typeof wasmOffsetConverter }, vt = { U: function() {
    ...
    return wt = await (async function() {
      ...
      }) : (g ??= e2.locateFile ? e2.locateFile("arcgis-knowledge-client-core-simd.wasm", o3) : o3 + "arcgis-knowledge-client-core-simd.wasm", a3((await j(r3)).instance));
    })(), (function() {
      function a3() {
...
//# sourceMappingURL=arcgis-knowledge-client-core-simd-ABV4Y3X2.js.map
