...
var e = class {
  ...
  async fetchAvailability(i, e2, o, s) {
    await O(s);
    const a = this.getAvailability(i, e2, o);
    if ("unavailable" === a) throw new r("tile-map:tile-unavailable", "Tile is not available", { level: i, row: e2, col: o });
    return a;
  }
  async fetchAvailabilityUpsample(l, e2, o, s, a) {
    await O(a), s.level = l, s.row = e2, s.col = o;
    const n = this.tileInfo;
    return n.updateTileInfo(s), this.fetchAvailability(l, e2, o, a).catch((l2) => {
      if (d(l2)) throw l2;
...
//# sourceMappingURL=chunk-VMBM7IOC.js.map
