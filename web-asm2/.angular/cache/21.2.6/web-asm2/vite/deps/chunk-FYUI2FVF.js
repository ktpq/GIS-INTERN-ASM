...
var F2 = class extends b {
  ...
  updateModelTransform(t6) {
    ...
    const a5 = c2(L, L, C2);
    u2(i5, a5[12], a5[13], a5[14]), e7.modelOrigin.setVec(t6, i5), n(s3, a5), e7.model.setMat(t6, s3);
    const r10 = g(x2, a5);
...
var R = class extends g2 {
  constructor(e7, t6) {
    let i5 = t(k(t6));
    t6.instanced && t6.instancedDoublePrecision && (i5 = i5.concat(t(u4(t6)))), super(e7, t6, i5), this.shader = new t3(K, () => import("./DefaultMaterial.glsl-ZS4GG47C.js"));
  }
  _makePipeline(e7, t6) {
...
var t5 = class extends R {
  constructor() {
    super(...arguments), this.shader = new t3(z2, () => import("./RealisticTree.glsl-CLSQ5YEW.js"));
  }
};
...
//# sourceMappingURL=chunk-FYUI2FVF.js.map
