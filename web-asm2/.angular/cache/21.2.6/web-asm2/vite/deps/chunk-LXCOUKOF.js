...
async function p(t2, e) {
  ...
  if ("image/gif" === a) {
    const { isAnimatedGIF: t3, parseGif: a2 } = await import("./gif-5MHSSEMT.js");
    if (t3(r2)) return a2(r2, e);
  }
  if (n) {
    const { isAnimatedPNG: t3, parseApng: a2 } = await import("./apng-RTQEHXTZ.js");
    if (t3(r2)) return a2(r2, e);
  }
...
//# sourceMappingURL=chunk-LXCOUKOF.js.map
