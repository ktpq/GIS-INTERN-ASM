import {
  g as g2
} from "./chunk-GVEZITNH.js";
import "./chunk-SOF4YPWE.js";
...
async function H(e2, t2, i3, o) {
  const r = (await import("./visualVariableUtils-5M4JGELT.js")).getSizeRangeAtScale(e2, i3, o), s2 = r && O(r);
  if (!r || !s2) return;
...
async function F(e2, t2, l4, i3, o) {
  const { getSize: r } = await import("./visualVariableUtils-5M4JGELT.js");
...
//# sourceMappingURL=sizeRampUtils-LLUZUQYQ.js.map
