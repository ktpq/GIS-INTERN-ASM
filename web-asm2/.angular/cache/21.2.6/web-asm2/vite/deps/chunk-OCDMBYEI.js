...
function D(t3, o5, e5, s, i4) {
  ...
  return P(t3.field) || P(t3.valueExpression) ? P(t3.stops) ? 2 === t3.stops.length && n(t3.stops[0].size) && n(t3.stops[1].size) ? (F(t3.stops[0].size, t3.stops[1].size, t3.stops[0].value, t3.stops[1].value, o5, e5), o5.type[e5] = 1, true) : (T(i4, "Could not convert size info: stops only supported with 2 elements"), false) : n(r6) && n(n5) && P(t3.minDataValue) && P(t3.maxDataValue) ? (F(r6, n5, t3.minDataValue, t3.maxDataValue, o5, e5), o5.type[e5] = 1, true) : "unknown" === t3.valueUnit ? (T(i4, "Could not convert size info: proportional size not supported"), false) : null != m2[t3.valueUnit] ? (o5.minSize[e5] = -1 / 0, o5.maxSize[e5] = 1 / 0, o5.offset[e5] = 0, o5.factor[e5] = 1 / m2[t3.valueUnit], o5.type[e5] = 1, true) : (T(i4, "Could not convert size info: scale-dependent size not supported"), false) : t3.stops?.[0] && n(t3.stops[0].size) ? (o5.minSize[e5] = t3.stops[0].size, o5.maxSize[e5] = t3.stops[0].size, o5.offset[e5] = o5.minSize[e5], o5.factor[e5] = 0, o5.type[e5] = 1, true) : n(r6) ? (o5.minSize[e5] = r6, o5.maxSize[e5] = r6, o5.offset[e5] = r6, o5.factor[e5] = 0, o5.type[e5] = 1, true) : (T(i4, "Could not convert size info: unsupported variant of sizeInfo"), false);
}
...
function Y(t3, i4) {
  const r6 = new X(t3);
  return r6.vvSize && (r6.vvSymbolAnchor = i4.anchor, o2(nt), U(i4.rotation[2], i4.rotation[0], i4.rotation[1], nt), r6.vvSymbolRotationMatrix = r6.vvSymbolRotationMatrix || e(), n2(r6.vvSymbolRotationMatrix, nt)), r6;
}
function Z(t3, o5, e5) {
...
//# sourceMappingURL=chunk-OCDMBYEI.js.map
