...
var V = class extends b {
  ...
  get _colors() {
    const e5 = this.context?.view.effectiveTheme.textColor ?? g.fromArray([255, 255, 255]);
  ...
  _refreshMessages() {
    this._messageUnitsTask?.abort(), this._messageUnitsTask = w(() => f2("esri/core/t9n/Units"));
  }
};
...
//# sourceMappingURL=chunk-HWTYAFQP.js.map
