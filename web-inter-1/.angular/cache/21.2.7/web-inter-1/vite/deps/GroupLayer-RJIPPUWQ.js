...
import {
  C
} from "./chunk-MAZYLKB4.js";
import "./chunk-TUZOUVQ7.js";
import {
  a as a3
...
import "./chunk-JYSXFVUE.js";
import "./chunk-L6ZXJMSG.js";
...
import {
  ...
  n2 as n3,
  t
} from "./chunk-AYJXYDGH.js";
import {
  w as w2
} from "./chunk-2H2SGHM4.js";
import {
  l as l2
...
var V = class extends p(l3(g(_(n3(d(e(b))))))) {
  constructor(e3) {
    super(e3), this._allLayers = new l4({ getCollections: () => [this.layers], getChildrenFunction: (e4) => "layers" in e4 ? e4.layers : null }), this.allTables = t(this), this.fullExtent = void 0, this.operationalLayerType = "GroupLayer", this.spatialReference = void 0, this.type = "group", this._debouncedSaveOperations = L(async (e4, t2, i) => {
      const { save: r2, saveAs: s2 } = await import("./groupLayerUtils-YOHZ3XI3.js");
      switch (e4) {
        case 0:
          return r2(this, t2);
        case 1:
...
//# sourceMappingURL=GroupLayer-RJIPPUWQ.js.map
