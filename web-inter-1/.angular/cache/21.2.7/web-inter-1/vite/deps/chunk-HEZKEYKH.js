...
var BigDecimal = class _BigDecimal {
  ...
  static {
    this._divRound = (dividend, divisor) => _BigDecimal.fromBigInt(
      dividend / divisor + (_BigDecimal.ROUNDED ? dividend * BigInt(2) / divisor % BigInt(2) : BigInt(0))
    );
  }
  static {
    this.fromBigInt = (bigint) => Object.assign(Object.create(_BigDecimal.prototype), { value: bigint, isNegative: bigint < BigInt(0) });
  }
...
//# sourceMappingURL=chunk-HEZKEYKH.js.map
