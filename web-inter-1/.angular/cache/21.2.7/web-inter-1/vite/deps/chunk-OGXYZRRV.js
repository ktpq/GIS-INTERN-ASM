...
function _2(t3, n3, a8, r6) {
  ...
  if (null != l4) l4.features.forEach((t4) => {
    ...
    if (!h2.has(t4.attributes[i4.name]) && null != n4) {
      ...
      b3.push(new p3({ value: t4.attributes[i4.name], label: t4.attributes[i4.name] + "", symbol: new m2({ style: "solid", outline: null, color: new g(v ? [t4.attributes[o5.name] * r7, t4.attributes[m8.name] * r7, t4.attributes[f2.name] * r7, 1] : [0, 0, 0, 0]) }) }));
    }
  });
  else if (s3?.[0]) for (let u5 = s3[0].min; u5 <= s3[0].max; u5++) b3.push(new p3({ value: u5, label: u5.toString(), symbol: new m2({ style: "solid", outline: null, color: new g([0, 0, 0, 0]) }) }));
...
//# sourceMappingURL=chunk-OGXYZRRV.js.map
