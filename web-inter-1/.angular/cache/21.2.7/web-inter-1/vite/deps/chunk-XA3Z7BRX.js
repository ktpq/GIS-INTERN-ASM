...
var F = class {
  ...
  constructor(e, t, r4) {
    this._scheduler = e, this.name = t, this.blockFrame = 0, this.runtime = 0, this._queue = new c(), this._handles = new r(), this._basePriority = O(t), this.schedulePriority = this._basePriority, this._task = r3(null != r4 ? r4 : this._queue), this._handles.add(f(() => this.task.readyToRun, (t2) => e.taskRunningChanged(t2)));
  }
  remove() {
...
//# sourceMappingURL=chunk-XA3Z7BRX.js.map
