...
function r(e = i()) {
  ...
  const [l2, s2, o2 = "#,##0.###"] = n[e];
  return { decimal: l2, group: s2, pattern: o2 };
}
function l(e, t) {
  const n2 = r((t = __spreadValues({}, t)).locale);
  t.customs = n2;
  const l2 = t.pattern || n2.pattern;
  return isNaN(e) || Math.abs(e) === 1 / 0 ? null : o(e, l2, t);
}
var s = /[#0,]*[#0](?:\.0*#*)?/;
function o(e, t, n2) {
  const r2 = (n2 = n2 || {}).customs.group, l2 = n2.customs.decimal, o2 = t.split(";"), a = o2[0];
  if ((t = o2[e < 0 ? 1 : 0] || "-" + a).includes("%")) e *= 100;
...
function i2(e, t, n2) {
  ...
  const o2 = String(Math.abs(e)).split("."), i3 = o2[1] || "";
  if (r2[1] || n2.places) {
    l2 && (n2.places = n2.places.slice(0, Math.max(0, l2)));
    const e2 = void 0 !== n2.places ? n2.places : r2[1] && r2[1].lastIndexOf("0") + 1;
    +e2 > i3.length && (o2[1] = i3.padEnd(Number(e2), "0")), +s2 < i3.length && (o2[1] = i3.slice(0, Math.max(0, Number(s2))));
  } else o2[1] && o2.pop();
  const a = r2[0].replace(",", "");
  let c2 = a.indexOf("0");
  -1 !== c2 && (c2 = a.length - c2, c2 > o2[0].length && (o2[0] = o2[0].padStart(c2, "0")), a.includes("#") || (o2[0] = o2[0].slice(-c2)));
  let p2, u3, d2 = r2[0].lastIndexOf(",");
  if (-1 !== d2) {
    p2 = r2[0].length - d2 - 1;
    const e2 = r2[0].slice(0, d2);
    d2 = e2.lastIndexOf(","), -1 !== d2 && (u3 = e2.length - d2 - 1);
  }
  const f2 = [];
  for (let g2 = o2[0]; g2; ) {
    const e2 = g2.length - p2;
    f2.push(e2 > 0 ? g2.slice(Math.max(0, e2)) : g2), g2 = e2 > 0 ? g2.slice(0, e2) : "", u3 && (p2 = u3, u3 = void 0);
  }
  return o2[0] = f2.reverse().join(n2.group || ","), o2.join(n2.decimal || ".");
}
function c(t) {
  const n2 = r((t = t || {}).locale), l2 = t.pattern || n2.pattern, o2 = n2.group, i3 = n2.decimal;
  let a = 1;
  ...
  const p2 = f(c2, (n3) => (n3 = "(?:" + u(n3, ".") + ")").replace(s, (e) => {
    const n4 = { signed: false, separator: t.strict ? o2 : [o2, ""], fractional: t.fractional, decimal: i3, exponent: false }, r2 = e.split(".");
    let l3 = t.places;
    ...
    const s2 = r2[0].split(",");
    return s2.length > 1 && (n4.groupSize = s2.pop().length, s2.length > 1 && (n4.groupSize2 = s2.pop().length)), "(" + u2(n4) + ")";
  }), true);
  return { regexp: p2.replaceAll(/[\xa0 ]/g, "[\\s\\xa0]"), group: o2, decimal: i3, factor: a };
}
function p(e, t) {
...
//# sourceMappingURL=chunk-NAH26QEI.js.map
