...
async function c() {
  if (!u2()) {
    const [n2, t2] = await Promise.all([import("./OperatorProject-OUCW6FAX.js"), import("./SpatialReference-J73TUBVZ.js").then((n3) => n3.aP).then(({ injectPe: n3 }) => n3), P()]);
...
//# sourceMappingURL=chunk-PIGO73DQ.js.map
