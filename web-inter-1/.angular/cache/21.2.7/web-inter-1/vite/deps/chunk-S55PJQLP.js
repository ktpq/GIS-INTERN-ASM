...
var m2 = class extends Z {
  ...
  async _open(t2) {
    ...
    "Table" === l2?.functionName && (r4.rasterInfo.attributeTable = g.fromJSON(l2.functionArguments.attributeTableAsRecordSet)), await this.syncJobHandler();
    const p6 = o2[0];
  ...
  async _updateClipGeometry() {
    ...
    if (e && "inside" === t2.clippingType) {
      const { extent: t3 } = this.rasterInfo, r4 = await import("./densifyOperator-KG2WA5V6.js"), i2 = await import("./differenceOperator-BDUU2RNB.js");
...
var Y = (Y2) => {
  ...
  let ee = class extends Z2 {
    ...
    normalizeRasterFetchOptions(e) {
      ...
      if (null == t2) return e;
      const r4 = g2({ rasterInfo: this.raster.rasterInfo, multidimensionalDefinition: e.multidimensionalDefinition || this.multidimensionalDefinition, timeExtent: e.timeExtent ?? this.timeExtent, multidimensionalSubset: this.multidimensionalSubset });
    ...
    async identify(e, t2 = {}) {
      ...
      if (null != s2?.multidimensionalInfo) {
        if (!(s2.hasMultidimensionalTranspose && !(!y(t2.multidimensionalDefinition) && !t2.transposedVariableName)) && null == (t2 = this.normalizeRasterFetchOptions(t2)).multidimensionalDefinition) return { location: i2, value: null };
      }
    ...
    async _getSampleLocations(e) {
      ...
      if ("polyline" === i2) {
        ...
        if (e.sampleCount || e.sampleDistance) {
          const r5 = await import("./densifyOperator-KG2WA5V6.js"), n4 = (await import("./lengthOperator-XA7PNIZL.js")).execute(t2, { unit: "meters" }), s3 = Math.min(e.sampleCount || 100, X);
    ...
    async _updateRasterFunction() {
      if (this._isConstructedFromFunctionRaster && t(this.raster)) {
        ...
        return void (!this.rasterFunction && e2 && this._set("rasterFunction", g3.fromJSON(e2)));
      }
  ...
  } } } }), r2(a2)], ee.prototype, "interpolation", void 0), __decorate([a()], ee.prototype, "ioConfig", void 0), __decorate([a({ type: [n2], json: { write: true } })], ee.prototype, "multidimensionalDefinition", null), __decorate([a({ type: u, json: { write: true } })], ee.prototype, "multidimensionalSubset", void 0), __decorate([a()], ee.prototype, "raster", void 0), __decorate([a({ type: g3 })], ee.prototype, "rasterFunction", null), __decorate([a()], ee.prototype, "serviceRasterInfo", void 0), __decorate([a()], ee.prototype, "sourceJSON", void 0), __decorate([a({ readOnly: true, type: S, json: { read: false } })], ee.prototype, "spatialReference", void 0), __decorate([a({ type: z })], ee.prototype, "tileInfo", void 0), __decorate([a(y2)], ee.prototype, "url", null), __decorate([a({ types: l })], ee.prototype, "renderer", null), __decorate([a({ types: l, json: { name: "layerDefinition.drawingInfo.renderer", write: { overridePolicy() {
...
//# sourceMappingURL=chunk-S55PJQLP.js.map
