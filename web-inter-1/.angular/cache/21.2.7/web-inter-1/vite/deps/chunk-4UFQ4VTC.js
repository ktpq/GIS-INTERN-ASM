...
function T3(n13, e5, t6) {
  const r4 = [], o5 = A3(t6);
  if (-1 === o5) return console.warn(`invalid conversionMode: ${t6}`), null;
  const i4 = k(e5);
  return M.mgrsToGeogExtended(i4, 1, [n13], o5, r4) ? new _(r4[0][0], r4[0][1], e5 || S2.WGS84) : null;
}
function P4(n13, e5) {
  const t6 = [];
  !e5 && /\(.+27/.test(n13) && (e5 = S2.GCS_NAD_1927);
  const r4 = k(e5);
  return A.usngToGeog(r4, 1, [n13], t6) ? new _(t6[0][0], t6[0][1], e5 || S2.WGS84) : null;
}
function G2(n13, e5, t6) {
  const r4 = [], o5 = D2(t6);
  if (-1 === o5) return console.warn(`invalid conversionMode: ${t6}`), null;
  const i4 = k(e5);
  return D.utmToGeog(i4, 1, [n13], o5, r4) ? new _(r4[0][0], r4[0][1], e5 || S2.WGS84) : null;
}
function p3(n13, e5, r4 = 0) {
  const o5 = [[n13.x, n13.y]], i4 = [], l5 = k(n13.spatialReference);
  let u2 = 0;
  switch (e5) {
    case "dd":
      u2 = d.geogToDd(l5, 1, o5, r4, i4);
      break;
    case "ddm":
      u2 = d.geogToDdm(l5, 1, o5, r4, i4);
      break;
    case "dms":
      u2 = d.geogToDms(l5, 1, o5, r4, i4);
      break;
    default:
      return console.warn(`invalid format: ${e5}`), null;
  }
  return u2 ? i4[0] : null;
}
function M2(n13, e5, t6 = 0, r4 = false) {
  const o5 = [[n13.x, n13.y]], i4 = [], l5 = k(n13.spatialReference);
  let u2 = A3(e5);
  if (-1 === u2) return console.warn(`invalid conversionMode: ${e5}`), null;
  r4 && (u2 |= M.PE_MGRS_ADD_SPACES);
  return M.geogToMgrsExtended(l5, 1, o5, t6, false, u2, i4) ? i4[0] : null;
}
function v2(n13, e5 = 0, t6 = false) {
  const r4 = [[n13.x, n13.y]], o5 = [], i4 = k(n13.spatialReference);
  return A.geogToUsng(i4, 1, r4, e5, false, t6, o5) ? o5[0] : null;
}
function R(n13, e5, t6 = false) {
  const r4 = [[n13.x, n13.y]], o5 = [], i4 = k(n13.spatialReference);
  let l5 = D2(e5);
  if (-1 === l5) return console.warn(`invalid conversionMode: ${e5}`), null;
  t6 && (l5 |= D.PE_UTM_OPTS_ADD_SPACES);
  return D.geogToUtm(i4, 1, r4, l5, o5) ? o5[0] : null;
}
function k(e5) {
...
var e4 = "esri-tooltip";
var t5 = `${e4}-content`;
var n3 = `${e4}-content--input`;
var _5 = `${e4}-content__header`;
var a3 = `${e4}-content__header__spacer`;
var o3 = `${e4}-content__header__actions`;
var s3 = `${e4}-draw-header-actions`;
var c7 = `${e4}-table`;
var $ = `${e4}-help-message`;
var r3 = `${e4}-help-message__text`;
var h3 = `${e4}-help-message__icon`;

// node_modules/@arcgis/core/views/interactive/tooltip/components/TooltipField.js
var d4 = `${e4}-field`;
var p4 = { base: d4, inputMode: `${d4}--input`, title: `${d4}__title`, value: `${d4}__value` };
var l3 = class extends O {
  constructor() {
    super(...arguments), this.hidden = false, this.mode = "feedback";
  }
  render() {
    return x("div", { class: this.classes({ [p4.base]: true, [p4.inputMode]: "input" === this.mode }) }, x("div", { class: p4.title, key: "title" }, this.title), x("div", { class: p4.value, key: "value" }, this.value));
  }
};
...
var p5 = { base: `${e4}-value-by-value` };
var d5 = class extends O {
  constructor() {
    super(...arguments), this.divider = "×";
  }
  render() {
    return x("div", { class: p5.base }, x("span", null, this.left), x("span", null, this.divider), x("span", null, this.right));
  }
};
...
var y2 = 6;
function D3(t6, n13) {
  return { angleRelative: x3, direction: j, directionRelative: R2, directionRelativeBilateral: $2, latitudeDecimalDegrees: L2, longitudeDecimalDegrees: F3, area: (e5, r4) => G(t6, e5, r4 ?? n13.area), length: (e5, r4, i4) => U2(t6, e5, r4 ?? n13.length, i4), lengthRelative: (e5, r4) => z(t6, e5, r4 ?? n13.length), totalLength: (e5, r4) => U2(t6, e5, r4 ?? n13.length), verticalLength: (e5, r4) => B(t6, e5, r4 ?? n13.verticalLength), verticalLengthRelative: (e5, r4) => E(t6, e5, r4 ?? n13.verticalLength), percentage: T4, scalar: Z, scale: U4 };
}
function x3(t6) {
  return c3(t6, __spreadValues({ signDisplay: "exceptZero" }, b2(v3)));
}
function j(t6) {
...
function R2(t6) {
  const n13 = U3(t6);
  return c3(n13, __spreadValues({ style: "unit", unitDisplay: "narrow", unit: "degree", signDisplay: n13 > 0 ? "never" : "exceptZero" }, b2(v3)));
}
function $2(t6) {
  return F2(t6, t6.rotationType, v3);
}
...
function T4(t6) {
  return c3(t6.value, { style: "percent" });
}
function U4(t6) {
  return c3(t6, { style: "percent", maximumFractionDigits: 0 });
}
function Z(t6, n13) {
  return c3(t6.value, b2(n13));
}
function b2(t6) {
...
var I = " ";
var M3 = [];
for (const P8 of [",", "\\|", "\\s+"]) for (const t6 of ["\\.", ",", ""]) for (const n13 of ["", ",", "\\.", I, "\\s+"]) P8 !== t6 && P8 !== n13 && t6 !== n13 && M3.push({ separator: P8, decimal: t6, thousands: n13, pattern: E3({ decimal: t6, thousands: n13, separator: P8 }) });
function Q(t6) {
  for (const { decimal: n13, thousands: e5, pattern: i4 } of M3) {
    i4.lastIndex = 0;
...
var N3 = class extends O {
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-2T75ADLD.js"), icon: () => import("./calcite-icon-6UYXZHFB.js"), input: () => import("./calcite-input-IVZ7D2IR.js") });
  }
...
var n4 = class extends N3 {
  _renderContent() {
    const { area: t6, radius: e5, xSize: i4, ySize: n13, visibleElements: a6 } = this.info, p7 = this._messagesTooltip.sketch, u2 = this._formatters;
    return x(S, null, a6.radius && null != e5 ? x(l3, { title: p7.radius, value: u2.length(e5) }) : null, a6.size && null != i4 && null != n13 ? x(l3, { title: p7.size, value: x(d5, { left: u2.length(i4), right: u2.length(n13) }) }) : null, a6.area ? x(l3, { title: p7.area, value: u2.area(t6) }) : null);
  }
};
...
var m5 = class extends O {
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-2T75ADLD.js"), icon: () => import("./calcite-icon-6UYXZHFB.js"), input: () => import("./calcite-input-IVZ7D2IR.js"), "input-message": () => import("./calcite-input-message-TEKMKJNP.js") });
  }
  render() {
...
var l4 = class extends O {
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-2T75ADLD.js"), dropdown: () => import("./calcite-dropdown-6WIFFDT2.js"), "dropdown-item": () => import("./calcite-dropdown-item-MHEPCHNG.js"), "dropdown-group": () => import("./calcite-dropdown-group-XQQ2E2A6.js") });
  }
...
function a4(e5) {
  ...
  } }, x("calcite-button", { alignment: "end", appearance: "transparent", iconStart: e3[t6], kind: "neutral", label: i4, scale: "s", slot: "trigger", title: i4 }), x("calcite-dropdown-group", { selectionMode: "single" }, x("calcite-dropdown-item", { "data-mode": n13, "data-testid": "tooltip-direction-mode-relative", iconStart: e3.relative, key: "relative", selected: t6 === n13 }, o5?.directionModeSelect?.relative), x("calcite-dropdown-item", { "data-mode": r4, "data-testid": "tooltip-direction-mode-absolute", iconStart: e3.absolute, key: "absolute", selected: t6 === r4 }, o5?.directionModeSelect?.absolute)));
}
...
var n5 = class extends N3 {
  _renderContent() {
    const { area: t6, xSize: e5, ySize: i4, visibleElements: n13 } = this.info, a6 = this._messagesTooltip.sketch, p7 = this._formatters;
    return x(S, null, n13.size && null != e5 && null != i4 ? x(l3, { title: a6.size, value: x(d5, { left: p7.length(e5), right: p7.length(i4) }) }) : null, n13.area ? x(l3, { title: a6.area, value: p7.area(t6) }) : null);
  }
};
...
var b3 = class extends l2 {
  ...
  initialize() {
    ...
    this.addHandles([l(() => this.view.overlay?.surface, (e5) => {
    ...
    }, w), l(() => ({ container: this.outerContainer, style: this._outerContainerStyle }), ({ container: t7, style: e5 }) => {
      Object.assign(t7.style, e5);
    }, h), l(() => ({ outerContainer: this.outerContainer, placement: this.effectivePlacement, effectiveOffset: this._effectiveOffset, rtl: this._rtl, debug: this.debug }), ({ outerContainer: t7, placement: e5, effectiveOffset: o5, rtl: n13, debug: i4 }) => {
      const { classList: s12 } = t7;
      s12.add(v4.base), s12.toggle(v4.rtl, n13), s12.toggle(v4.ltr, !n13), s12.toggle(v4.debug, i4), this.outerContainer.style.setProperty("--offset", `${o5}px`), a2(t7), w5(t7, e5);
  ...
  async enterInputMode(t6) {
    ...
    const i4 = () => {
      o5 && (this.inputModePosition = M4(this.contentContainer, o5, this._effectiveOffset, this.view), Object.assign(this.outerContainer.style, this._outerContainerStyle));
    };
  ...
  onDrag(t6, e5) {
    ...
    if (i4) {
      ...
      if (r4 < 0 || r4 > s12.width || l5 < 0 || l5 > s12.height - P6) return;
...
function V2(t6) {
  const o5 = new x5(t6());
  return o5.addHandles(l(() => t6(), ({ view: t7, options: e5, info: n13 }) => {
    o5.view = t7, void 0 !== e5 && (o5.options = e5), void 0 !== n13 && (o5.info = n13);
  })), o5;
}
function k3(t6, o5) {
  const e5 = t3(o5.vertexSpace), { scale: n13, orientation: l5 } = t6, { transform: a6 } = o5, s12 = T5(a6);
...
function z3(t6, o5, e5) {
  ...
  const n13 = o5.transform ??= new A2();
  D4(t6, n13, e5), P7(t6, n13, e5);
}
function D4(t6, o5, e5) {
...
//# sourceMappingURL=chunk-4UFQ4VTC.js.map
