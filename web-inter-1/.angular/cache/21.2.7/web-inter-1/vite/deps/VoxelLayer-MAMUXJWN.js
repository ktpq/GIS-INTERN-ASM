...
function h(r5) {
  o3(f3, r5), _3(f3, f3);
  const a6 = Math.atan2(f3[1], f3[0]), m4 = y(e3(), x, -a6);
  Q(f3, f3, m4);
  const c6 = -1 * Math.atan2(f3[2], f3[0]);
  return [c2(a6) + 270, c2(c6) + 90];
}
function j2(o7, a6) {
  return y(p2, x, u2(o7 - 270)), y(u4, b2, u2(a6 - 90)), v(l4, p2, u4), o3(f3, g3), Q(f3, f3, l4), _3(f3, f3), [f3[0], f3[1], f3[2]];
}
...
var f4 = class extends n2 {
  ...
  computeLayerSpaceLocation(e4) {
    ...
    const i6 = u(e4);
    if (s(i6, i6, this.voxelSizeInLayerSpaceSigned), c3(i6, i6, this.originInLayerSpace3D), "xyt" === this.volumeType) return new _({ x: i6[0], y: i6[1], spatialReference: this.spatialReference });
...
var _6 = class extends _5(l3(g2(_4(l(e(s4(s3(b)))))))) {
  constructor(e4) {
  ...
  createPopupTemplate(e4) {
    ...
    return d({ fields: t2, title: "{Voxel.Position}" }, e4);
  }
  getConfiguration() {
...
//# sourceMappingURL=VoxelLayer-MAMUXJWN.js.map
