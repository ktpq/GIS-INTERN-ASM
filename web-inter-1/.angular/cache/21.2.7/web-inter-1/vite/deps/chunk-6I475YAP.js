...
function n(n5, t4, r5 = false) {
  const o6 = `🛑 DEPRECATED - ${t4}`;
  if (!r5) return void n5.warn(o6);
  let i5 = e3.get(n5);
  i5 || (i5 = /* @__PURE__ */ new Set(), e3.set(n5, i5)), i5.has(t4) || (i5.add(t4), n5.warn(o6));
}
var t2 = "https://www.esriurl.com/";
function r2(e6, n5, r5, o6 = {}) {
  has("esri-deprecation-warnings") && m(e6, `This widget is deprecated. Use the ${n5} component instead.`, __spreadValues({ see: [`${n5} component reference: ${t2}${r5}/`, `Esri's move to web components: ${t2}components-transition-plan/`], replacement: `<${r5}></${r5}>`, warnOnce: true }, o6));
}
function o2(e6, n5, r5, o6 = {}) {
  has("esri-deprecation-warnings") && m(e6, `This class is deprecated. Use the ${n5} component instead.`, __spreadValues({ see: [`${n5} component reference: ${t2}${r5}/`, `Esri's move to web components: ${t2}components-transition-plan/`], replacement: `<${r5}></${r5}>`, warnOnce: true }, o6));
}
function i(e6, n5, t4 = {}) {
  has("esri-deprecation-warnings") && m(e6, `Module: ${$(n5)}`, t4);
}
function s2(e6, n5, t4 = {}) {
  if (has("esri-deprecation-warnings")) {
    const { moduleName: r5 } = t4;
    m(e6, `Function: ${(r5 ? $(r5) + "::" : "") + n5 + "()"}`, t4);
  }
}
function c2(e6, n5, t4 = {}) {
  if (has("esri-deprecation-warnings")) {
    const { moduleName: r5 } = t4;
    m(e6, `Property: ${(r5 ? $(r5) + "::" : "") + n5}`, t4);
  }
}
function p(e6, n5, t4 = {}) {
  has("esri-deprecation-warnings") && m(e6, `Multiple argument constructor: ${n5 = $(n5)}`, __spreadValues({ warnOnce: true, replacement: `new ${n5}({ <your properties here> })` }, t4));
}
function m(e6, t4, r5 = {}) {
  if (has("esri-deprecation-warnings")) {
...
function a3(t4) {
  ...
  if (b(t4)) return t4.map(a3);
  if (m2(t4)) throw new Error("Trying to clone an unclonable Accessor instance");
  const e6 = {};
  for (const r5 of Object.getOwnPropertyNames(t4)) e6[r5] = a3(t4[r5]);
  return e6;
}
function p2(t4, n5) {
...
function O(t4) {
  ...
  if (t4 instanceof Map) {
    ...
    for (const [e6, r5] of t4) n5.set(e6, a3(r5));
    return n5;
  }
  if (t4 instanceof Set) {
    const n5 = /* @__PURE__ */ new Set();
    for (const e6 of t4) n5.add(a3(e6));
    return n5;
  }
  return null;
}
...
function n2(r5, n5, t4 = false) {
  return f2(r5, n5, t4);
}
function t3(r5, n5) {
  if (null != n5) return n5[r5] || u2(r5.split("."), false, n5);
}
function e4(r5, n5, t4) {
...
function i2(r5, n5) {
  ...
  if ("object" == typeof r5) {
    if (Array.isArray(r5)) {
      ...
      for (let n6 = 0; n6 < r5.length; n6++) if (i2(r5[n6], t4[n6])) return true;
      return false;
    }
    if (Object.keys(r5).length !== Object.keys(n5).length) return true;
    for (const t4 in r5) {
      if (i2(r5[t4], n5[t4])) return true;
    }
    return false;
  }
  return r5 !== n5;
...
function f2(n5, t4, e6) {
  return t4 ? Object.keys(t4).reduce((n6, i5) => {
    ...
    return u4 === o6 ? n6 : void 0 === u4 ? (n6[i5] = a3(o6), n6) : (Array.isArray(o6) || Array.isArray(n6) ? (u4 = u4 ? Array.isArray(u4) ? n6[i5] = u4.slice() : n6[i5] = [u4] : n6[i5] = [], o6 && (Array.isArray(o6) || (o6 = [o6]), e6 ? o6.forEach((r5) => {
...
if (globalThis.esriConfig && (n2(s3, globalThis.esriConfig, true), delete s3.has), !s3.assetsPath) {
  {
    const e6 = "5.0.16";
    s3.assetsPath = `https://js.arcgis.com/${e6}/@arcgis/core/assets`;
  }
  s3.defaultAssetsPath = s3.assetsPath;
}
...
function r3(r5, o6) {
  return o6 ? r5.replaceAll(e5, "object" == typeof o6 ? (e6, r6) => n3(t3(r6, o6)) : (t4, e6) => n3(o6(e6))) : r5;
}
function o4(e6, n5) {
...
var n4 = class _n {
  ...
  _log(t4, r5, ...i5) {
    ...
    for (const n5 of s3.log.interceptors) if (n5(t4, this.module, ...i5)) return;
...
//# sourceMappingURL=chunk-6I475YAP.js.map
