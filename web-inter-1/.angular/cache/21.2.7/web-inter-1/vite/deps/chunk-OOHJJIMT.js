import {
  u
} from "./chunk-OLBZK5AE.js";
import {
  m
} from "./chunk-FFCOT5OW.js";
import {
  C,
  M,
  z
...
var d = class extends s {
  ...
  labelPointPolygon(e) {
    ...
    if (e.hasNonLinearSegments()) {
      const t3 = new mr({ copy: e }), a2 = ha(t3, 0.25 * n4, n4);
      n(a2 !== e), r = a2, o = r;
    }
    let u3 = 0, g = 0;
    ...
    const x2 = new mi();
    if (Math.abs(g) <= 2 * n4 * n4 ? x2.setNAN() : x2.assign(u(o, u3)), Number.isNaN(x2.x)) {
      const e2 = new n2();
    ...
    do {
      let e2 = Number.NaN;
      if (w2[1] = this.calculateParacentroid_(o, Q(v.xmin, v.xmax, E), n4), w2[1].isNAN() || (D = new m().getNearestCoordinate(o, w2[1], false, false), e2 = D.m_distance), e2 > n4 && 1 === Lo(o, w2[1], n4)) A = true, b2[1] = e2, C3[1] = mi.sqrDistance(w2[1], x2);
      else if (e2 > q && (q = e2, k.setCoordsPoint2D(w2[1])), E -= 0.01, E < 0.1) {
        if (!(q >= 0)) break;
        A = true, b2[1] = q, w2[1] = k, C3[1] = mi.sqrDistance(w2[1], x2);
      }
    } while (!A);
    A = false, E = 0.5, q = -1;
    let G = 0.01, M2 = 1;
    do {
      let e2 = Number.NaN;
      if (w2[2] = this.calculateParacentroid_(o, Q(v.xmin, v.xmax, E), n4), w2[2].isNAN() || (D = new m().getNearestCoordinate(o, w2[2], false, false), e2 = D.m_distance), e2 > n4 && 1 === Lo(o, w2[2], n4)) A = true, b2[2] = e2, C3[2] = mi.sqrDistance(w2[2], x2);
      else if (e2 > q && (q = e2, k.setCoordsPoint2D(w2[2])), E = 0.5 + G * M2, G += 0.01, M2 *= -1, E < 0.3 || E > 0.7) {
        if (!(q >= 0)) break;
        A = true, b2[2] = q, w2[2] = k, C3[2] = mi.sqrDistance(w2[2], x2);
      }
    } while (!A);
    A = false, E = 0.75, q = -1;
    do {
      let e2 = Number.NaN;
      if (w2[3] = this.calculateParacentroid_(o, Q(v.xmin, v.xmax, E), n4), w2[3].isNAN() || (D = new m().getNearestCoordinate(o, w2[3], false, false), e2 = D.m_distance), e2 > n4 && 1 === Lo(o, w2[3], n4)) A = true, b2[3] = e2, C3[3] = mi.sqrDistance(w2[3], x2);
      else if (e2 > q && (q = e2, k.setCoordsPoint2D(w2[3])), E += 0.01, E > 0.9) {
        if (!(q >= 0)) break;
        A = true, b2[3] = q, w2[3] = k, C3[3] = mi.sqrDistance(w2[3], x2);
      }
    } while (!A);
  ...
  calculateParacentroid_(e, t2, n4) {
    ...
    const y = new n2(), p2 = new mi(), P2 = new mi(), f = Ot(mi, 2), x2 = e.querySegmentIterator();
...
//# sourceMappingURL=chunk-OOHJJIMT.js.map
