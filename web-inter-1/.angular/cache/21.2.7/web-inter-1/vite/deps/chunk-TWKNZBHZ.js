...
var Button = class extends LitElement {
  ...
  render() {
    ...
    return this.interactiveContainer({ disabled: this.disabled, children: html2`<${DynamicHtmlTag} .ariaBusy=${this.loading} .ariaExpanded=${this.el.ariaExpanded ? this.el.ariaExpanded : null} .ariaLabel=${!this.loading ? getLabelText(this) : this.messages.loading} aria-live=polite class=${safeClassMap({
...
//# sourceMappingURL=chunk-TWKNZBHZ.js.map
