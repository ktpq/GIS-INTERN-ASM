...
async function k() {
  const [e7, r5, { Feature: t2 }] = await Promise.all([import("./arcade-WJBRWANA.js"), import("./arcade-DCIRNQNM.js"), import("./Feature-X3HS42D5.js")]);
  ...
  async _queryFeatureCount() {
    ...
    if ("subtype-group" === t2?.type && !l5) {
      if (this._set("featureCount", 0), this._destroyRelatedFeatureViewModels(), this.featurePage = 1, this.relatedFeatures.destroyAll(), s8 && null != u5) {
        const { default: e8 } = await import("./uniqueValues-5QGBMSPL.js"), { uniqueValueInfos: l6 } = await e8({ layer: t2, sqlWhere: `${s8} = '${u5}'`, field: t2.subtypeField, signal: r5?.signal }), a6 = l6.map(({ count: e9, value: r6 }) => {
...
//# sourceMappingURL=chunk-URFYP6AV.js.map
