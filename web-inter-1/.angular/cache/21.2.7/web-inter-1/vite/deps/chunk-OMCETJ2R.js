...
var u11 = i5 = class extends c6 {
  ...
  readColorRampName(o19, r11) {
    if (!o19) return null;
    const e6 = m6.jsonValues.find((r12) => r12.toLowerCase() === o19.toLowerCase());
    return e6 ? m6.fromJSON(e6) : null;
  }
  clone() {
...
var f5 = class extends l5 {
  ...
  _processPixels(t3) {
    ...
    return m4(e6, { inputRanges: u23, outputValues: a28, noDataRanges: o19, outputPixelType: n28, allowUnmatched: i22, isLastInputRangeInclusive: m17, replacementValue: c30 });
  }
  _getWebGLParameters() {
...
var l20 = p15 = class extends n17 {
  readColorRamp(o19) {
    if ("string" == typeof o19) {
      const e6 = m6.jsonValues.find((e7) => e7.toLowerCase() === o19.toLowerCase());
      return e6 ? d2(m6.fromJSON(e6)) : null;
    }
...
//# sourceMappingURL=chunk-OMCETJ2R.js.map
