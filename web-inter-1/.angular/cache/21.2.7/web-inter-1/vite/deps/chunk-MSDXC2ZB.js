...
async function i() {
  if (!o()) {
    const [n2, o2] = await Promise.all([import("./OperatorGeodeticLength-5VNSLTE5.js"), import("./SpatialReference-J73TUBVZ.js").then((e2) => e2.aP).then(({ injectPe: e2 }) => e2), P()]);
...
async function m() {
  if (!c2()) {
    const [e2] = await Promise.all([import("./apiConverter-XI625PME.js"), i()]);
...
//# sourceMappingURL=chunk-MSDXC2ZB.js.map
