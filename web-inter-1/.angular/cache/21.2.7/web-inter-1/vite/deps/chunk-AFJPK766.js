...
function e(e2, s, u) {
  const c = Array.isArray(e2), a2 = c ? e2.length / s : e2.byteLength / (4 * s), h = c ? e2 : new Uint32Array(e2, 0, a2 * s), y = u?.minReduction ?? 0, A = u?.originalIndices || null, g = A ? A.length : 0, m = u?.componentOffsets || null;
  let w = 0;
...
//# sourceMappingURL=chunk-AFJPK766.js.map
