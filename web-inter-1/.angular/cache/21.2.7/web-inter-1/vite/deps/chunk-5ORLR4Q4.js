...
import {
  c as c6,
  m as m3
} from "./chunk-YQQP4HNB.js";
import {
  A,
  B
} from "./chunk-SA7DK2E6.js";
import {
  f as f3
} from "./chunk-QAETF2LR.js";
import {
  a as a7
} from "./chunk-5IZL4ZTY.js";
import {
  h3,
  m as m2
...
var l3 = class extends g {
  constructor() {
    super(...arguments), this.shader = new t6(c6, () => import("./Compositing.glsl-XSN4O4AH.js"));
  }
...
var m4 = class extends g {
  constructor() {
    super(...arguments), this.shader = new t6(B, () => import("./Laserline.glsl-LKPZXB7N.js"));
  }
};
...
var l4 = class extends g {
  constructor(e8, r10) {
    super(e8, r10, t3(r10.spherical ? p6 : m5)), this.shader = new t6(f3, () => import("./LaserlinePath.glsl-7TAIMUXB.js"));
  }
};
...
function v6(e8, t9, r10, i5, s4, n6) {
  const d2 = l2(A3, o2(A3, e8[1] * r10, e8[0] * -r10), i5 + s4 / 2), h6 = u(E2, u(E2, u(E2, t9, l2(E2, e8, n6 / 2)), d2), d2);
...
//# sourceMappingURL=chunk-5ORLR4Q4.js.map
