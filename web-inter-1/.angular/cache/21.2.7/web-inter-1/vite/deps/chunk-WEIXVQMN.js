...
__decorate([a2({ type: Number, json: { write: true } })], n5.prototype, "pathId", void 0), __decorate([a2({ type: Number, json: { write: true } })], n5.prototype, "order", void 0), __decorate([a2({ type: n4, json: { write: true } })], n5.prototype, "startingPoint", void 0), __decorate([a2({ type: n4, json: { write: true } })], n5.prototype, "stoppingPoint", void 0), __decorate([a2({ type: [s3], json: { write: true } })], n5.prototype, "pathConnectivity", void 0), __decorate([a2({ type: y, json: { write: true } })], n5.prototype, "geometry", void 0), n5 = __decorate([c("esri.networks.support.CircuitPath")], n5);
var y2 = n5;

// node_modules/@arcgis/core/networks/support/Subcircuit.js
var p = class extends n2(n3) {
  constructor(t3) {
  ...
  initialize() {
    this.addHandles([a(() => this, "update", this._updateHandler)]);
  }
  getAttribute(t3) {
...
__decorate([a2({ type: String, json: { write: true } })], p.prototype, "name", void 0), __decorate([a2({ type: String, json: { write: true } })], p.prototype, "globalId", void 0), __decorate([a2({ type: String })], p.prototype, "providerId", void 0), __decorate([a2({ type: String })], p.prototype, "consumerId", void 0), __decorate([a2({ type: o2.apiValues, json: { type: o2.jsonValues, read: { reader: o2.read, source: "state" }, write: { writer: o2.write, target: "state" } } })], p.prototype, "state", void 0), __decorate([a2({ json: { write: { allowNull: true, writer: (t3, e3) => e3.attributes = t3 ?? {} } } })], p.prototype, "attributes", void 0), p = __decorate([c("esri.networks.support.Subcircuit")], p);

// node_modules/@arcgis/core/networks/support/CircuitSection.js
var d = class extends n2(n3) {
  constructor(t3) {
...
__decorate([a2({ json: { write: { allowNull: true, writer: (t3, i2) => i2.attributes = t3 ?? {} } } })], d.prototype, "attributes", void 0), __decorate([a2({ type: String, json: { write: true } })], d.prototype, "globalId", void 0), __decorate([a2({ type: Number, json: { write: true } })], d.prototype, "sectionId", void 0), __decorate([a2({ type: e.apiValues, json: { type: e.jsonValues, read: e.read }, readOnly: true })], d.prototype, "role", void 0), __decorate([a2({ type: i.apiValues, json: { type: i.jsonValues, read: i.read, write: i.write } })], d.prototype, "sectionType", void 0), __decorate([a2({ type: s2, json: { write: true } })], d.prototype, "startLocation", void 0), __decorate([a2({ type: s2, json: { write: true } })], d.prototype, "stopLocation", void 0), __decorate([a2({ type: p, json: { write: true } })], d.prototype, "subcircuit", void 0), __decorate([a2({ type: y2, readOnly: true })], d.prototype, "path", void 0), d = __decorate([c("esri.networks.support.CircuitSection")], d);
...
var S = class extends n2(n3) {
  ...
  initialize() {
    ...
    }, h), l2(this._applyEditsHandler), a(() => this, "edits", this._editsHandler)]);
  }
  normalizeCtorArgs(t3) {
    if (void 0 === t3) return t3;
...
__decorate([a2({ json: { write: { allowNull: true, writer: (t3, i2) => i2.attributes = t3 ?? {} } } })], S.prototype, "attributes", void 0), __decorate([a2()], S.prototype, "circuitManager", void 0), __decorate([a2({ type: i.apiValues, json: { type: i.jsonValues, read: i.read, write: i.write } })], S.prototype, "circuitType", void 0), __decorate([a2({ type: String, json: { write: true } })], S.prototype, "globalId", void 0), __decorate([a2({ type: Boolean, readOnly: true })], S.prototype, "isDeleted", null), __decorate([o("isDeleted")], S.prototype, "readIsDeleted", null), __decorate([a2({ type: Boolean, json: { write: true }, readOnly: true })], S.prototype, "isSectioned", null), __decorate([a2({ type: Date, readOnly: true })], S.prototype, "lastExportedTime", null), __decorate([o("lastExportedTime")], S.prototype, "readLastExportedTime", null), __decorate([a2({ type: Date, readOnly: true })], S.prototype, "lastVerifiedTime", null), __decorate([o("lastVerifiedTime")], S.prototype, "readLastVerifiedTime", null), __decorate([a2({ type: String, json: { write: true } })], S.prototype, "name", void 0), __decorate([a2({ json: { read: { source: ["sectionOrder", "sections"] }, write: true } })], S.prototype, "sections", void 0), __decorate([o("sections")], S.prototype, "readSections", null), __decorate([r("sections")], S.prototype, "writeSections", null), __decorate([a2({ type: s2, json: { write: true } })], S.prototype, "startLocation", void 0), __decorate([a2({ type: t.apiValues, json: { type: t.jsonValues, read: t.read } })], S.prototype, "status", null), __decorate([o("status")], S.prototype, "readStatus", null), __decorate([a2({ type: s2, json: { write: true } })], S.prototype, "stopLocation", void 0), __decorate([a2({ type: [p], json: { write: true } })], S.prototype, "subcircuits", void 0), S = __decorate([c("esri.networks.support.Circuit")], S);

export {
  y2 as y,
  S
};
//# sourceMappingURL=chunk-WEIXVQMN.js.map
