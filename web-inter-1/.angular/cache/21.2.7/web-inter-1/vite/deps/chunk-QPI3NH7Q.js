...
function i4() {
  return t3 ??= (async () => {
    const i8 = await import("./basis_transcoder-6E3BU56O.js"), t4 = await i8.default({ locateFile: (i9) => n3(`esri/libs/basisu/${i9}`) });
...
function h4(e3) {
  ...
  if (null == r7) throw new r2("texture:context-failed", "Failed to create 2d context from HTMLCanvasElement");
...
var M = class {
  ...
  _loadFromVideoElementAsync(e3, r7) {
    return this._loadAsync((i8) => new Promise((n6, m4) => {
      const l4 = () => {
        ...
        l4(), m4(e4 || new r2("texture:load-error", "Failed to load video"));
      };
  ...
  unload() {
    if (this._texture = r(this._texture), this._emptyTexture = null, null != this._loadingController) {
...
//# sourceMappingURL=chunk-QPI3NH7Q.js.map
