...
var p3 = class extends l2(n2) {
  constructor(o4) {
    super(o4), this.alias = null, this.name = void 0, this.fieldFormat = null;
  }
};
__decorate([m({ type: String, json: { write: true } })], p3.prototype, "alias", void 0), __decorate([m({ type: String, nonNullable: true, json: { write: { isRequired: true } } })], p3.prototype, "name", void 0), __decorate([m({ types: c2, json: { write: true } })], p3.prototype, "fieldFormat", void 0), p3 = __decorate([l("esri.layers.support.FieldConfiguration")], p3);
...
__decorate([a4({ type: String, json: { write: true } })], p4.prototype, "expression", void 0), __decorate([a4({ type: String, json: { write: true } })], p4.prototype, "title", void 0), __decorate([a4({ type: String, json: { write: true } })], p4.prototype, "returnType", void 0), p4 = __decorate([c("esri.layers.support.ExpressionInfo")], p4);
...
__decorate([a4({ type: Boolean, json: { write: true } })], a7.prototype, "isAutoGenerated", void 0), __decorate([a4({ clonable: false })], a7.prototype, "layer", void 0), __decorate([a4({ type: String, json: { write: true } })], a7.prototype, "name", void 0), __decorate([a4({ type: String, json: { write: true } })], a7.prototype, "alias", void 0), __decorate([a4({ type: String, json: { write: true } })], a7.prototype, "onStatisticField", void 0), __decorate([a4({ type: p4, json: { write: true } })], a7.prototype, "onStatisticExpression", void 0), __decorate([a4({ type: String, json: { write: true } })], a7.prototype, "statisticType", void 0), __decorate([a4({ readOnly: true, clonable: false, json: { read: false } })], a7.prototype, "type", null), a7 = p5 = __decorate([c("esri.layers.support.AggregateField")], a7);
...
__decorate([a4({ type: ["binning"], readOnly: true, json: { read: false, write: { ignoreOrigin: true } } })], x3.prototype, "type", void 0), __decorate([r2({ geohash: "geohash", square: "square" }), a4({ type: ["geohash", "square"], json: { write: { ignoreOrigin: true } } })], x3.prototype, "binType", void 0), __decorate([a4({ type: Number, json: { write: { ignoreOrigin: true } } })], x3.prototype, "fixedBinLevel", void 0), __decorate([a4(j())], x3.prototype, "labelingInfo", void 0), __decorate([a4(y())], x3.prototype, "labelsVisible", void 0), __decorate([a4(h())], x3.prototype, "layer", void 0), __decorate([a4(w())], x3.prototype, "maxScale", void 0), __decorate([a4(O2())], x3.prototype, "popupEnabled", void 0), __decorate([a4(b2())], x3.prototype, "popupTemplate", void 0), __decorate([a4({ cast: (e2) => "auto" === e2 ? e2 : a2(o2(e2)) })], x3.prototype, "size", void 0), __decorate([a4(m5())], x3.prototype, "fieldConfigurations", void 0), __decorate([a4(d2())], x3.prototype, "fields", void 0), __decorate([a4(c4())], x3.prototype, "fieldsIndex", void 0), __decorate([a4(I())], x3.prototype, "renderer", void 0), __decorate([o("renderer", ["drawingInfo.renderer"])], x3.prototype, "readRenderer", null), x3 = __decorate([c("esri.layers.support.FeatureReductionBinning")], x3);

// node_modules/@arcgis/core/layers/support/FeatureReductionCluster.js
function C(e2) {
  return "simple" === e2.type && !e2.visualVariables?.length;
}
var z = class extends a3(f) {
  constructor(e2) {
...
__decorate([a4({ type: ["cluster"], readOnly: true, json: { read: false, write: { ignoreOrigin: true } } })], z.prototype, "type", void 0), __decorate([a4({ cast: (e2) => "auto" === e2 ? e2 : a2(o2(e2)), json: { write: { ignoreOrigin: true } } })], z.prototype, "clusterRadius", null), __decorate([a4({ type: Number, cast: o2, json: { write: { ignoreOrigin: true } } })], z.prototype, "clusterMinSize", null), __decorate([a4({ type: Number, cast: o2, json: { write: { ignoreOrigin: true } } })], z.prototype, "clusterMaxSize", null), __decorate([a4(w())], z.prototype, "maxScale", void 0), __decorate([a4(O2())], z.prototype, "popupEnabled", void 0), __decorate([a4(b2())], z.prototype, "popupTemplate", void 0), __decorate([a4(I())], z.prototype, "renderer", void 0), __decorate([o("renderer", ["drawingInfo.renderer"])], z.prototype, "readRenderer", null), __decorate([a4({ types: g, json: { write: { ignoreOrigin: true } } })], z.prototype, "symbol", void 0), __decorate([o("symbol", ["drawingInfo.renderer"])], z.prototype, "readSymbol", null), __decorate([r3("symbol")], z.prototype, "writeSymbol", null), __decorate([a4(j())], z.prototype, "labelingInfo", void 0), __decorate([a4(y())], z.prototype, "labelsVisible", void 0), __decorate([a4(h())], z.prototype, "layer", void 0), __decorate([a4(m5())], z.prototype, "fieldConfigurations", void 0), __decorate([a4(d2())], z.prototype, "fields", void 0), __decorate([o("fields")], z.prototype, "readFields", null), __decorate([a4(c4())], z.prototype, "fieldsIndex", void 0), z = __decorate([c("esri.layers.support.FeatureReductionCluster")], z);

// node_modules/@arcgis/core/layers/support/featureReductionUtils.js
var o3 = { key: "type", base: null, typeMap: { cluster: z, binning: x3 } };
var r6 = { types: { key: "type", base: null, typeMap: { selection: p2, cluster: z, binning: x3 } }, json: { name: "layerDefinition.featureReduction", write: { allowNull: true }, origins: { "web-map": { types: o3 }, "portal-item": { types: o3 }, "web-scene": { types: { key: "type", base: null, typeMap: { selection: p2 } }, name: "layerDefinition.featureReduction", write: { allowNull: true, layerContainerTypes: a5 } } } } };
...
var p7 = (p8) => {
  ...
  let m7 = class extends h2 {
    constructor(...e2) {
      super(...e2), this.aggregateGraphicOrigin = new r5(this), this.addHandles([l3(() => this.renderer, () => {
    ...
    _withClusterVariable(e2, r7, t2) {
      ...
      if ("visualVariables" in i) {
        ...
        i.visualVariables.some((e3) => "size" === e3.type) || i.visualVariables.push(new V({ field: "cluster_count", stops: [new l5({ value: 1 }), new l5({ useMinValue: true, size: r7 }), new l5({ useMaxValue: true, size: t2 })] }));
      }
      return i;
    }
  ...
  return __decorate([a4({ readOnly: true, clonable: false })], m7.prototype, "aggregateGraphicOrigin", void 0), __decorate([a4(r6)], m7.prototype, "featureReduction", null), m7 = __decorate([c("esri.layers.mixins.FeatureReductionLayer")], m7), m7;
};
...
//# sourceMappingURL=chunk-HIRLENHO.js.map
