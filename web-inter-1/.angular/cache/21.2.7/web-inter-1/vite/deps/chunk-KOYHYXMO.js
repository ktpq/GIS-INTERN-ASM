...
async function u8(r6, o3, n7) {
  const { source: i4 } = o3, { loadGLTFMesh: a8 } = await p(import("./loadGLTFMesh-QWG4OBCN.js"), n7), c10 = await f6(i4, n7);
  s(n7);
...
__decorate([a2()], a7.prototype, "externalSources", void 0), __decorate([a2()], a7.prototype, "displaySource", null), __decorate([a2()], a7.prototype, "_implicitDisplaySource", null), __decorate([a2()], a7.prototype, "_explicitDisplaySource", void 0), a7 = __decorate([c("esri.geometry.support.meshUtils.Metadata")], a7);
...
var Y2 = Q2 = class extends l(p2(m(s2))) {
  ...
  async toBinaryGLTF(e7) {
    const [{ toBinaryGLTF: t3 }] = await Promise.all([import("./gltfexport-F5OKWOHF.js"), this.load(e7)]);
  ...
  static async createFromGLTF(e7, t3, r6) {
    ...
    const { loadGLTFMesh: o3 } = await p(import("./loadGLTFMesh-QWG4OBCN.js"), r6);
...
__decorate([a2({ type: [g2], json: { write: true } })], Y2.prototype, "components", void 0), __decorate([a2({ nonNullable: true, types: X2, constructOnly: true, json: { write: true }, clonable: (e7, t3) => n5(t3)?.vertexSpace ?? e7.clone(t3) })], Y2.prototype, "vertexSpace", void 0), __decorate([a2({ type: A2, clonable: (e7, t3) => {
  const r6 = n5(t3);
  return r6 && "transform" in r6 ? r6.transform : e7?.clone() ?? e7;
}, json: { write: true } })], Y2.prototype, "transform", void 0), __decorate([a2({ constructOnly: true, type: a7, clonable: (e7, t3) => n5(t3)?.metadata ?? e7.clone() })], Y2.prototype, "metadata", void 0), __decorate([a2()], Y2.prototype, "hasExtent", null), __decorate([a2()], Y2.prototype, "_transformedExtent", null), __decorate([a2()], Y2.prototype, "_untransformedBounds", null), __decorate([a2()], Y2.prototype, "origin", null), __decorate([a2({ readOnly: true, json: { read: false } })], Y2.prototype, "extent", null), __decorate([a2({ readOnly: true, json: { read: false, write: true, default: true } })], Y2.prototype, "hasZ", void 0), __decorate([a2({ readOnly: true, json: { read: false, write: true, default: false } })], Y2.prototype, "hasM", void 0), __decorate([a2({ type: u5, nonNullable: true, json: { write: true }, clonable: (e7, t3) => n5(t3)?.vertexAttributes ?? e7.clone(t3) })], Y2.prototype, "vertexAttributes", void 0), Y2 = Q2 = __decorate([c("esri.geometry.Mesh")], Y2);
var $ = g();

export {
  Y2 as Y
};
//# sourceMappingURL=chunk-KOYHYXMO.js.map
