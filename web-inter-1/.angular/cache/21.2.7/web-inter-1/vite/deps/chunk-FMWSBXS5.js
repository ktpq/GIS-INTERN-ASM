...
function p(r4, o2, s3, u6, l2, a5) {
  ...
  if ((null === p2 && !l2.allowNull && !l2.writerEnsuresNonNull || void 0 === p2) && l2.isRequired) {
    const i3 = new r2("web-document-write:property-required", `Missing value for required property '${s3}' on '${r4.declaredClass}'`, { propertyName: s3, target: r4 });
  ...
  if (!l2.ignoreOrigin && a5?.origin && o2.store.multipleOriginsSupported) {
    if (o2.store.originOf(s3) < r(a5.origin)) return false;
  }
  return true;
}
...
function c(r4, e, t3, i3) {
  const o2 = n2(r4), n6 = o2.metadata, s3 = r3(n6[e], i3);
...
//# sourceMappingURL=chunk-FMWSBXS5.js.map
