...
var s2 = class extends s {
  ...
  constructor(r2) {
    super(), this[i3] = true, this.type = "geo-rss", this.layer = r2;
  }
  get id() {
...
// node_modules/@arcgis/core/views/layers/GeoRSSLayerView.js
...
var g2 = class extends S(r) {
  ...
  async hitTest(e, r2) {
    ...
    const i4 = this.layer;
    return this.graphicsViews.reverse().flatMap((r3) => r3.hitTest(e)).map((r3) => ({ type: "graphic", graphic: r3, layer: i4, mapPoint: e }));
  }
  update(e) {
  ...
  attach() {
    this.addAttachHandles([l(() => this.layer?.featureCollections, (e) => {
      this._clear();
      const { layer: s3 } = this, t2 = new s2(this.layer);
      for (const { popupInfo: o2, featureSet: a, layerDefinition: p } of e) {
        const e2 = g.fromJSON(a), h2 = new q(e2.features), y = o2 ? q2.fromJSON(o2) : null;
        h2.forEach((e3) => {
          e3.layer = s3, e3.sourceLayer = s3, e3.popupTemplate = y, e3.origin = t2;
        });
        const g3 = p.drawingInfo, f2 = t(g3.renderer), w = new O({ requestUpdateCallback: () => this.requestUpdate(), view: this.view, graphics: h2, renderer: f2, container: new i(this.view.featuresTilingScheme) });
...
g2 = __decorate([c("esri.views.2d.layers.GeoRSSLayerView2D")], g2);
var f = g2;
export {
  f as default
};
//# sourceMappingURL=GeoRSSLayerView2D-HXVNXSF6.js.map
