...
function d(e, t2) {
  ...
  if (f(u)) {
    ...
    if (t3.getGeometryType() === a.enumLine) {
      const n3 = new se(), r = new Qs({ vd: e.getDescription() });
      return t3.queryStart(n3), r.startPathPoint(n3), t3.queryEnd(n3), r.lineToPoint(n3), r;
    }
    {
      const n3 = new Qs({ vd: e.getDescription() });
...
function _(t2, n3) {
  const r = v.executeMany(new t(t2), n3, null);
  return Array.from(r);
}
function D(e) {
...
//# sourceMappingURL=chunk-FNEZ3UGH.js.map
