import {
  Heading,
  SLOTS
} from "./chunk-QFKG3JOA.js";
import {
  defaultEndMenuPlacement
} from "./chunk-JNUO6NAC.js";
import {
  keyed
} from "./chunk-WOLKGPFD.js";
import {
  getIconScale,
  useSetFocus
} from "./chunk-FYWMO3YM.js";
import {
  useInteractive
} from "./chunk-RDXZJXVG.js";
import {
  useT9n
} from "./chunk-AR7FXFNL.js";
import {
  createObserver,
  updateRefObserver
} from "./chunk-PLYY5OAW.js";
import {
...
import {
  ...
  ref,
  safeClassMap
} from "./chunk-BKL5S7QF.js";

// node_modules/@esri/calcite-components/dist/chunks/header.js
var styles = css`.header{margin:0;display:flex;align-content:space-between;align-items:center;fill:var(--calcite-color-text-2);color:var(--calcite-color-text-2)}.heading{margin:0;padding:0;font-weight:var(--calcite-font-weight-medium)}.header .heading{flex:1 1 auto;padding:.5rem}`;
...
var Panel = class extends LitElement {
  ...
  renderFooterNode() {
    ...
    return html`<footer class=${safeClassMap(CSS.footer)} .hidden=${!showFooter}><div class=${safeClassMap(CSS.footerContent)} .hidden=${!hasFooterContent}><slot name=${SLOTS2.footer} @slotchange=${this.handleFooterSlotChange}></slot></div><div class=${safeClassMap(CSS.footerStart)} .hidden=${hasFooterContent || !hasFooterStartContent}><slot name=${SLOTS2.footerStart} @slotchange=${this.handleFooterStartSlotChange}></slot></div><div class=${safeClassMap(CSS.footerEnd)} .hidden=${hasFooterContent || !hasFooterEndContent}><slot name=${SLOTS2.footerEnd} @slotchange=${this.handleFooterEndSlotChange}></slot></div></footer>`;
  }
  renderContent() {
...
//# sourceMappingURL=chunk-CBN2IHSI.js.map
