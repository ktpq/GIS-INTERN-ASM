...
var m5 = class extends e2 {
  ...
  updateMatrix(o7, a4) {
    ...
    const x2 = (a4.extent.xmax - a4.extent.xmin) / a4.size[0] / o7.resolution, l8 = s2(o7.rotation), { displayViewScreenMat3: p3 } = this.transforms;
...
function x(t7, e7) {
  const i5 = new _({ x: (t7.xmax + t7.xmin) / 2, y: (t7.ymax + t7.ymin) / 2, spatialReference: t7.spatialReference }), r8 = t7.xmax - t7.xmin, s12 = t7.ymax - t7.ymin, n6 = Math.abs(Math.cos(s2(e7))), m6 = Math.abs(Math.sin(s2(e7))), p3 = n6 * r8 + m6 * s12, u8 = m6 * r8 + n6 * s12, c5 = new z({ xmin: i5.x - p3 / 2, ymin: i5.y - u8 / 2, xmax: i5.x + p3 / 2, ymax: i5.y + u8 / 2, spatialReference: t7.spatialReference });
...
//# sourceMappingURL=chunk-IUYPA3KV.js.map
