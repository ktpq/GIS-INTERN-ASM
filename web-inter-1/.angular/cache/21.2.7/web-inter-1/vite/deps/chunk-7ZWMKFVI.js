...
var T = class extends b {
  ...
  async _fetchAvailabilityUpsamplePrefetch(e4, t, i2, r4, l3) {
    ...
    }), c2 || (c2 = true, this.removeHandles(o)), a2(a4)) return;
    const p = new e2(e4, t, i2), f2 = __spreadProps(__spreadValues({}, r4), { signal: a4.signal }), u2 = this.layer.tileInfo;
...
__decorate([a3({ constructOnly: true })], T.prototype, "layer", void 0), __decorate([a3({ constructOnly: true })], T.prototype, "minLOD", void 0), __decorate([a3({ constructOnly: true })], T.prototype, "maxLOD", void 0), __decorate([a3({ constructOnly: true })], T.prototype, "request", void 0), __decorate([a3({ constructOnly: true })], T.prototype, "size", void 0), T = g = __decorate([c("esri.layers.support.TilemapCache")], T);

export {
  T
};
//# sourceMappingURL=chunk-7ZWMKFVI.js.map
