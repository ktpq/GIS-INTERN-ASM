...
function u(o) {
  const r = [];
  return y2(y(o), r), r.length ? new g(M(r[0])) : null;
}
function y2(e, t) {
  if (!e) return;
  let n;
  ...
  if (i?.symbolLayers) for (const l of i.symbolLayers) {
    ...
    if (c) {
      if (n) {
        ...
        if ((C(l) || m(l) && l.markerPlacement && p(l.markerPlacement)) && "fill" === e3 || h(l) && "outline" === e3) continue;
      } else if (C(l) || m(l) && l.markerPlacement && p(l.markerPlacement)) continue;
    }
    const e2 = t.toArray();
    switch (l.type) {
      case "CIMPictureMarker":
...
//# sourceMappingURL=chunk-52GYCIV3.js.map
