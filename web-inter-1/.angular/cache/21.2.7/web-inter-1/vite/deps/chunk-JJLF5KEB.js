...
async function S2(e3, t4) {
  if ("Utility Network Layer" === e3) {
    const { default: e4 } = await import("./UtilityNetwork-O7GZ7ISA.js");
...
var k2 = class extends e2(u2) {
  ...
  async queryNamedTraceConfigurations(e3, t4) {
    const [{ queryNamedTraceConfigurations: r5 }, { default: o4 }] = await Promise.all([import("./queryNamedTraceConfigurations-GYVBXCAN.js"), import("./QueryNamedTraceConfigurationsParameters-HR6M2XB3.js")]), s5 = this.networkServiceUrl, i6 = o4.from(e3);
  ...
  async validateTopology(e3, t4) {
    ...
    const [{ validateNetworkTopology: r5 }, { default: s5 }] = await Promise.all([import("./validateNetworkTopology-M5IIFYY5.js"), import("./ValidateNetworkTopologyParameters-VGH2AI75.js")]), i6 = s5.from(e3);
  ...
  async submitTopologyValidationJob(e3, t4) {
    ...
    const [{ submitValidateNetworkTopologyJob: i6 }, { default: a4 }] = await Promise.all([import("./validateNetworkTopology-M5IIFYY5.js"), import("./ValidateNetworkTopologyParameters-VGH2AI75.js")]), n5 = a4.from(e3);
...
var S3 = class extends V {
  ...
  async getCircuitManager(e3) {
    ...
    if (!t4) return null;
    const { default: r5 } = await import("./CircuitManager-74LFJY7F.js");
  ...
  async getUnitIdentifierManager() {
    ...
    const { default: e3 } = await import("./UnitIdentifierManager-PA3HGOF5.js");
  ...
  async queryAssociations(e3, t4) {
    const [{ queryAssociations: r5 }, { default: s5 }] = await Promise.all([import("./queryAssociations-HVTFCD7A.js"), import("./QueryAssociationsParameters-2VK2ISSL.js")]), o4 = s5.from(e3);
  ...
  async synthesizeAssociationGeometries(e3) {
    const [{ synthesizeAssociationGeometries: t4 }, { default: r5 }] = await Promise.all([import("./synthesizeAssociationGeometries-7KGHF6U2.js"), import("./SynthesizeAssociationGeometriesParameters-2L3JWHBN.js")]), s5 = r5.from(e3);
    return s5.gdbVersion = this.gdbVersion, s5.moment = this.historicMoment, t4(this.networkServiceUrl, s5);
  }
  async trace(e3) {
    const [{ trace: t4 }, { default: r5 }] = await Promise.all([import("./trace-6X4NGI5Y.js"), import("./TraceParameters-MV4CLOO6.js")]), s5 = r5.from(e3);
    return s5.gdbVersion = this.gdbVersion, s5.moment = this.historicMoment, t4(this.networkServiceUrl, s5);
  }
  async submitTraceJob(e3) {
    const [{ submitTraceJob: t4 }, { default: r5 }] = await Promise.all([import("./trace-6X4NGI5Y.js"), import("./TraceParameters-MV4CLOO6.js")]), s5 = r5.from(e3);
...
//# sourceMappingURL=chunk-JJLF5KEB.js.map
