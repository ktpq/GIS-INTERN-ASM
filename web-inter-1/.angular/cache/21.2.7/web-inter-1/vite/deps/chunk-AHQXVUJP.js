import {
  s as s2
} from "./chunk-FQGIMGUB.js";
import {
  i as i3
} from "./chunk-GGZGOVV4.js";
import {
  G
} from "./chunk-DCS7BAOQ.js";
import {
  E as E2,
  _ as _3,
  c as c4,
  ...
  v as v2,
  y as y2
} from "./chunk-BHT5OEU3.js";
import {
  o
} from "./chunk-NEPE6OF2.js";
import {
  v as v3
} from "./chunk-2LFJNASM.js";
import {
  x as x2
} from "./chunk-DYFGMWPB.js";
import {
  U
...
function p(e4) {
  const p5 = n2("esri/themes/base/images/files/");
  return e4 ? "text/plain" === e4 ? `${p5}text-32.svg` : "application/pdf" === e4 ? `${p5}pdf-32.svg` : "text/csv" === e4 ? `${p5}csv-32.svg` : "application/gpx+xml" === e4 ? `${p5}gpx-32.svg` : "application/x-dwf" === e4 ? `${p5}cad-32.svg` : "application/postscript" === e4 || "application/json" === e4 || "text/xml" === e4 || "model/vrml" === e4 ? `${p5}code-32.svg` : "application/x-zip-compressed" === e4 || "application/x-7z-compressed" === e4 || "application/x-gzip" === e4 || "application/x-tar" === e4 || "application/x-gtar" === e4 || "application/x-bzip2" === e4 || "application/gzip" === e4 || "application/x-compress" === e4 || "application/x-apple-diskimage" === e4 || "application/x-rar-compressed" === e4 || "application/zip" === e4 ? `${p5}zip-32.svg` : e4.includes("image/") ? `${p5}image-32.svg` : e4.includes("audio/") ? `${p5}sound-32.svg` : e4.includes("video/") ? `${p5}video-32.svg` : e4.includes("msexcel") || e4.includes("ms-excel") || e4.includes("spreadsheetml") ? `${p5}excel-32.svg` : e4.includes("msword") || e4.includes("ms-word") || e4.includes("wordprocessingml") ? `${p5}word-32.svg` : e4.includes("powerpoint") || e4.includes("presentationml") ? `${p5}report-32.svg` : `${p5}generic-32.svg` : `${p5}generic-32.svg`;
}
...
var T2 = class extends O {
  ...
  initialize() {
    this.addHandles([a(() => this.viewModel?.attachmentInfos, "change", () => this.scheduleRender()), a(() => this.viewModel?.fileInfos, "change", () => this.scheduleRender()), l(() => this.viewModel?.mode, () => this._modeChanged(), h)]);
  }
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-6UYXZHFB.js") });
  }
  get capabilities() {
  ...
  addAttachment() {
    ...
    return this._set("submitting", true), this._set("error", null), t3.addAttachment(e4).then((e5) => (this._set("submitting", false), this._set("error", null), t3.mode = "view", e5)).catch((e5) => {
      throw this._set("submitting", false), this._set("error", new r3("attachments:add-attachment", this.messages.addErrorMessage, e5)), e5;
    });
  }
  deleteAttachment(e4) {
    ...
    return this._set("submitting", true), this._set("error", null), t3.deleteAttachment(e4).then((e5) => (this._set("submitting", false), this._set("error", null), t3.mode = "view", e5)).catch((e5) => {
      throw this._set("submitting", false), this._set("error", new r3("attachments:delete-attachment", this.messages.deleteErrorMessage, e5)), e5;
    });
  }
  updateAttachment() {
    ...
    return this._set("submitting", true), this._set("error", null), e4.updateAttachment(t3).then((t4) => (this._set("submitting", false), this._set("error", null), e4.mode = "view", t4)).catch((e5) => {
      throw this._set("submitting", false), this._set("error", new r3("attachments:update-attachment", this.messages.updateErrorMessage, e5)), e5;
    });
  }
  addFile() {
  ...
  _renderAddForm() {
    const { submitting: e4, selectedFile: t3 } = this, s3 = e4 || !t3, i5 = this.visibleElements.cancelAddButton ? x("button", { bind: this, class: this.classes(e.button, e.buttonTertiary, e.buttonSmall, e.buttonHalf, e4 && e.buttonDisabled), disabled: e4, onclick: this._cancelForm, type: "button" }, this.messages.cancel) : null, a3 = this.visibleElements.addSubmitButton ? x("button", { class: this.classes(e.button, e.buttonSecondary, e.buttonSmall, e.buttonHalf, { [e.buttonDisabled]: s3 }), disabled: s3, type: "submit" }, this.messages.add) : null, n5 = t3 ? x("span", { class: I.fileName, key: "file-name" }, t3.name) : null, r5 = x("form", { afterCreate: h2, afterRemoved: E, bind: this, "data-node-ref": "_addAttachmentForm", onsubmit: this._submitAddAttachment }, x("fieldset", { class: I.fileFieldset }, n5, x("label", { class: this.classes(I.fileLabel, e.button, e.buttonSecondary) }, t3 ? this.messages.changeFile : this.messages.selectFile, x("input", { bind: this, class: I.fileInput, name: "attachment", onchange: this._handleFileInputChange, type: "file" }))), a3, i5);
    return x("div", { class: I.formNode, key: "add-form-container" }, r5);
  }
  _renderDetailsForm(e4) {
    const { visibleElements: t3, viewModel: s3, selectedFile: i5, submitting: a3 } = this, { capabilities: n5 } = s3, r5 = a3 || !i5;
    let l4, d2, c6, m4;
    ...
    const h6 = n5.editing && n5.operations?.delete && t3.deleteButton ? x("button", { bind: this, class: this.classes(e.button, e.buttonSmall, e.buttonTertiary, I.deleteButton, { [e.buttonDisabled]: a3 }), disabled: a3, key: "delete-button", onclick: (t4) => this._submitDeleteAttachment(t4, e4), type: "button" }, this.messages.delete) : void 0, u4 = n5.editing && n5.operations?.update && t3.updateButton ? x("button", { class: this.classes(e.button, e.buttonSmall, e.buttonThird, { [e.buttonDisabled]: r5 }), disabled: r5, key: "update-button", type: "submit" }, this.messages.update) : void 0, p5 = this.visibleElements.cancelUpdateButton ? x("button", { bind: this, class: this.classes(e.button, e.buttonSmall, e.buttonTertiary, e.buttonThird, { [e.buttonDisabled]: a3 }), disabled: a3, key: "cancel-button", onclick: this._cancelForm, type: "button" }, this.messages.cancel) : void 0, b3 = n5.editing && n5.operations?.update ? x("fieldset", { class: I.fileFieldset, key: "file" }, x("span", { class: I.fileName, key: "file-name" }, d2), x("label", { class: this.classes(I.fileLabel, e.button, e.buttonSecondary) }, this.messages.changeFile, x("input", { bind: this, class: I.fileInput, name: "attachment", onchange: this._handleFileInputChange, type: "file" }))) : void 0, _5 = x("fieldset", { class: I.metadataFieldset, key: "size" }, x("label", null, G(this.messagesUnits, c6 ?? 0))), v6 = x("fieldset", { class: I.metadataFieldset, key: "content-type" }, x("label", null, l4)), y6 = null != m4 ? x("a", { class: I.itemLink, href: m4, rel: "noreferrer", target: "_blank" }, this._renderImageMask(e4, 400), x("div", { class: I.itemLinkOverlay }, x("span", { class: I.itemLinkOverlayIcon }, x("calcite-icon", { icon: "launch" })))) : this._renderImageMask(e4, 400), w3 = x("form", { afterCreate: h2, afterRemoved: E, bind: this, "data-node-ref": "_updateAttachmentForm", onsubmit: (t4) => this._submitUpdateAttachment(t4, e4) }, x("div", { class: I.metadata }, _5, v6), b3, x("div", { class: I.actions }, h6, p5, u4));
  ...
  _renderGenericImageMask(e4, t3) {
    const { supportsResizeAttachments: s3 } = this.viewModel, i5 = p(t3), a3 = { [I.itemImageResizable]: s3 };
  ...
  _renderImageMaskForAttachment(e4, t3) {
    ...
    if (!e4) return null;
    const { contentType: i5, name: a3, size: n5, url: r5 } = e4;
    if (!s3 || !e2(i5)) return this._renderGenericImageMask(a3, i5);
    const l4 = this._getCSSTransform(e4), o2 = l4 ? { transform: l4, "image-orientation": "none" } : {}, d2 = `${r5}${r5?.includes("?") ? "&" : "?"}w=${t3}&s=${n5}`, c6 = { [I.itemImageResizable]: s3 };
  ...
  _renderFile(e4) {
    const { file: t3 } = e4;
    return x("li", { class: I.item, key: t3 }, x("button", { "aria-label": this.messages.attachmentDetails, bind: this, class: I.itemButton, key: "details-button", onclick: () => this._startEditFile(e4), title: this.messages.attachmentDetails, type: "button" }, this._renderImageMask(e4), x("label", { class: I.itemLabel }, x("span", { class: I.itemFilename }, t3.name || this.messages.noTitle), x("span", { "aria-hidden": "true", class: this.classes(I.itemChevronIcon, y(this.container) ? i4.left : i4.right) }))));
  }
  _renderAttachmentInfo({ attachmentInfo: e4, displayType: t3 }) {
    const { viewModel: s3, effectiveDisplayType: i5 } = this, { capabilities: a3, supportsResizeAttachments: n5 } = s3, { contentType: r5, name: l4, url: o2 } = e4, d2 = this._renderImageMask(e4, "list" === t3 ? 48 : 400), c6 = a3.editing ? x("span", { "aria-hidden": "true", class: this.classes(I.itemChevronIcon, y(this.container) ? i4.left : i4.right) }) : null, m4 = [d2, "preview" === i5 && n5 && e2(r5) ? null : x("label", { class: I.itemLabel }, x("span", { class: I.itemFilename }, l4 || this.messages.noTitle), c6)], h6 = a3.editing ? x("button", { "aria-label": this.messages.attachmentDetails, bind: this, class: I.itemButton, "data-attachment-info-id": e4.id, key: "details-button", onclick: () => this._startEditAttachment(e4), title: this.messages.attachmentDetails, type: "button" }, m4) : x("a", { class: I.itemButton, href: o2 ?? void 0, key: "details-link", rel: "noreferrer", target: "_blank" }, m4);
    return x("li", { class: I.item, key: e4 }, h6);
  }
  _renderAttachmentContainer() {
    const { effectiveDisplayType: e4, viewModel: t3, visibleElements: s3 } = this, { attachmentInfos: i5, capabilities: a3, fileInfos: n5 } = t3, r5 = !!i5?.length, l4 = !!n5?.length, o2 = { [I.containerList]: "preview" !== e4, [I.containerPreview]: "preview" === e4 }, d2 = a3.editing && a3.operations?.add && s3.addButton ? x("button", { bind: this, class: this.classes(e.button, e.buttonTertiary, I.addAttachmentButton), onclick: () => this._startAddAttachment(), type: "button" }, x("span", { "aria-hidden": "true", class: this.classes(I.itemAddIcon, i4.plus) }), this.messages.add) : void 0, c6 = r5 ? x("ul", { class: I.items, key: "attachments-list" }, i5.toArray().map((t4) => this._renderAttachmentInfo({ attachmentInfo: t4, displayType: e4 }))) : void 0, m4 = l4 ? x("ul", { class: I.items, key: "file-list" }, n5.toArray().map((e5) => this._renderFile(e5))) : void 0, h6 = l4 || r5 ? void 0 : x("div", { class: e.empty }, this.messages.noAttachments);
...
__decorate([a2()], T2.prototype, "capabilities", null), __decorate([a2()], T2.prototype, "displayType", void 0), __decorate([a2({ readOnly: true })], T2.prototype, "effectiveDisplayType", null), __decorate([a2()], T2.prototype, "attachmentKeywords", null), __decorate([a2()], T2.prototype, "attachmentTypes", null), __decorate([a2({ type: j })], T2.prototype, "graphic", null), __decorate([a2()], T2.prototype, "icon", null), __decorate([a2()], T2.prototype, "label", null), __decorate([a2(), v("esri/widgets/Attachments/t9n/Attachments")], T2.prototype, "messages", void 0), __decorate([a2(), v("esri/core/t9n/Units")], T2.prototype, "messagesUnits", void 0), __decorate([a2({ readOnly: true })], T2.prototype, "selectedFile", void 0), __decorate([a2({ readOnly: true })], T2.prototype, "submitting", void 0), __decorate([a2({ readOnly: true })], T2.prototype, "error", void 0), __decorate([a2({ type: y2 })], T2.prototype, "viewModel", void 0), __decorate([a2()], T2.prototype, "visibleElements", void 0), __decorate([m("visibleElements")], T2.prototype, "castVisibleElements", null), T2 = __decorate([c("esri.widgets.Attachments")], T2);

// node_modules/@arcgis/core/widgets/Feature/support/FeatureElementInfo.js
var n3 = "esri-feature-element-info";
var l2 = { base: n3, title: `${n3}__title`, description: `${n3}__description` };
var p2 = class extends O {
  ...
  _renderTitle() {
    const { title: e4 } = this;
    return e4 ? x(i3, { class: l2.title, innerHTML: e4, level: this.headingLevel }) : null;
  }
  _renderDescription() {
...
__decorate([a2()], p2.prototype, "description", void 0), __decorate([a2()], p2.prototype, "headingLevel", void 0), __decorate([a2()], p2.prototype, "title", void 0), p2 = __decorate([c("esri.widgets.Feature.support.FeatureElementInfo")], p2);

// node_modules/@arcgis/core/widgets/Feature/FeatureAttachments.js
var p3 = { base: "esri-feature-attachments" };
var h4 = class extends O {
  ...
  initialize() {
    this._featureElementInfo = new p2(), this.addHandles([l(() => [this.viewModel?.description, this.viewModel?.title, this.headingLevel], () => this._setupFeatureElementInfo(), h), l(() => this.viewModel, (e4) => this.attachmentsWidget.viewModel = e4, h)]);
  }
  destroy() {
  ...
  render() {
    ...
    return x("div", { class: p3.base }, this._featureElementInfo?.render(), e4?.render());
  }
...
__decorate([a2({ readOnly: true })], h4.prototype, "attachmentsWidget", void 0), __decorate([a2()], h4.prototype, "description", null), __decorate([a2()], h4.prototype, "displayType", null), __decorate([a2()], h4.prototype, "graphic", null), __decorate([a2()], h4.prototype, "headingLevel", void 0), __decorate([a2()], h4.prototype, "title", null), __decorate([a2({ type: s })], h4.prototype, "viewModel", void 0), h4 = __decorate([c("esri.widgets.Feature.FeatureAttachments")], h4);

// node_modules/@arcgis/core/widgets/Feature/FeatureContent.js
var n4 = "esri-feature-content";
var l3 = { base: n4, loaderContainer: `${n4}__loader-container`, loader: `${n4}__loader` };
...
__decorate([a2()], c5.prototype, "creator", null), __decorate([a2()], c5.prototype, "graphic", null), __decorate([a2({ type: c4 })], c5.prototype, "viewModel", void 0), c5 = __decorate([c("esri.widgets.Feature.FeatureContent")], c5);
...
function r4(r5, t3) {
  ...
  const n5 = p4.find((e4) => e4.pattern.test(t3));
  if (!n5) return t3;
  const i5 = t3.match(n5.pattern), l4 = i5?.[2], o2 = r2(r2(n5.label, { messages: r5, hierPart: l4 }), { appName: n5.appName }), m4 = n5.target ? ` target="${n5.target}"` : "", g3 = "_blank" === n5.target ? ' rel="noreferrer"' : "";
  return t.sanitizeUrl(_(t3)).replace(n5.pattern, `<a${m4} href="$1"${g3}>${o2}</a>`);
}
...
var h5 = class extends O {
  ...
  initialize() {
    this._featureElementInfo = new p2(), this.addHandles(l(() => [this.viewModel?.description, this.viewModel?.title], () => this._setupFeatureElementInfo(), h));
  }
  destroy() {
  ...
  _renderFieldInfo(e4, t3) {
    const { attributes: s3 } = this.viewModel, i5 = e4.fieldName || "", r5 = e4.label || i5, o2 = s3 ? null == s3[i5] ? "" : s3[i5] : "", l4 = !("date-time" !== e4?.fieldFormat?.type), n5 = "number" == typeof o2 && !l4 ? this._forceLTR(o2) : r4(this.messagesURIUtils, o2), d2 = { [m2.fieldDataDate]: l4 };
    return x("tr", { key: `fields-element-info-row-${i5}-${t3}` }, x("th", { class: m2.fieldHeader, innerHTML: r5, key: `fields-element-info-row-header-${i5}-${t3}` }), x("td", { class: this.classes(m2.fieldData, d2), innerHTML: n5, key: `fields-element-info-row-data-${i5}-${t3}` }));
  }
  _renderFields() {
...
__decorate([a2()], h5.prototype, "attributes", null), __decorate([a2()], h5.prototype, "description", null), __decorate([a2()], h5.prototype, "expressionInfos", null), __decorate([a2()], h5.prototype, "fieldInfos", null), __decorate([a2()], h5.prototype, "title", null), __decorate([a2({ type: f, nonNullable: true })], h5.prototype, "viewModel", void 0), __decorate([a2(), v("esri/widgets/Feature/t9n/Feature")], h5.prototype, "messages", void 0), __decorate([a2(), v("esri/widgets/support/t9n/uriUtils")], h5.prototype, "messagesURIUtils", void 0), h5 = __decorate([c("esri.widgets.Feature.FeatureFields")], h5);
...
var T3 = class extends O {
  constructor(e4, t3) {
    super(e4, t3), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new v2(), this.messages = null, this._disposeChart = (e5) => {
      ...
      if (t4 || !i5 || !e5) return;
      const { createRoot: a3 } = await import("./chartUtilsAm5-XH5CHKXG.js"), r5 = await a3(e5);
      this._chartRootMap.set(e5, r5), await this._renderChart({ mediaInfo: i5.activeMediaInfo, root: r5 });
    };
  }
  initialize() {
    this._featureElementInfo = new p2(), this.addHandles([l(() => [this.viewModel?.activeMediaInfo, this.viewModel?.activeMediaInfoIndex], () => this._setupMediaRefreshTimer(), h), l(() => [this.viewModel?.description, this.viewModel?.title], () => this._setupFeatureElementInfo(), h)]);
  }
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-6UYXZHFB.js") });
  }
  ...
  _renderImageMediaInfo(e4) {
    ...
    const { _refreshIntervalInfo: t3 } = this, { activeMediaInfoIndex: i5, formattedMediaInfoCount: a3 } = this.viewModel, { value: r5, refreshInterval: o2, altText: s3, title: n5, type: l4 } = e4, { sourceURL: d2, linkURL: m4 } = r5, c6 = U(m4 ?? void 0) ? "_blank" : "_self", p5 = "_blank" === c6 ? "noreferrer" : "", f3 = o2 ? t3 : null, g3 = f3 ? f3.timestamp : 0, M3 = f3 ? f3.sourceURL : d2, _5 = x("img", { alt: s3 || n5, key: `media-${l4}-${i5}-${a3}-${g3}`, src: M3 ?? void 0 });
    return (m4 ? x("a", { href: m4, rel: p5, target: c6, title: n5 }, _5) : null) ?? _5;
  }
  ...
  _renderMediaPageButton(e4) {
    ...
    const t3 = "previous" === e4, i5 = t3 ? this.messages.previous : this.messages.next, a3 = t3 ? "chevron-left" : "chevron-right", r5 = t3 ? "media-previous" : "media-next", o2 = t3 ? this._previous : this._next;
    return x("button", { "aria-label": i5, bind: this, class: _4.mediaPaginationButton, key: r5, onclick: o2, tabIndex: 0, title: i5, type: "button" }, x("calcite-icon", { class: _4.mediaPaginationIcon, icon: a3, scale: "s" }));
  }
  _setupFeatureElementInfo() {
    const { description: e4, title: t3 } = this;
    this._featureElementInfo?.set({ description: e4, title: t3 });
  ...
  async _getSeriesColors(e4) {
    const { colorAm5: t3 } = await import("./chartCommon-VYZ2NOQ7.js"), i5 = /* @__PURE__ */ new Map();
    return e4.forEach((e5) => {
      e5.color && i5.set(e5, t3(e5.color.toCss(true)));
    }), i5;
  }
  async _getRendererColors() {
    const { colorAm5: e4 } = await import("./chartCommon-VYZ2NOQ7.js"), t3 = /* @__PURE__ */ new Map(), i5 = this._getRenderer(), a3 = "default";
    if (!i5) return t3;
    const r5 = await x2(i5);
    r5.delete(a3);
    return Array.from(r5.values()).every((e5) => 1 === e5?.length) ? (Array.from(r5.keys()).forEach((i6) => {
      const a4 = r5.get(i6)?.[0]?.toCss(true);
      a4 && t3.set(i6, e4(a4));
    }), t3) : t3;
  }
  ...
  async _renderChart(e4) {
    const { root: t3, mediaInfo: i5 } = e4, { value: a3, type: r5 } = i5, { ResponsiveThemeAm5: o2, DarkThemeAm5: s3, AnimatedThemeAm5: n5, ColorSetAm5: d2, ThemeAm5: m4, esriChartColorSet: c6 } = await import("./chartCommon-VYZ2NOQ7.js"), h6 = m4.new(t3);
    h6.rule("ColorSet").set("colors", c6), h6.rule("ColorSet").set("reuse", true);
    const p5 = [o2.new(t3), h6];
    c2(this.container) && p5.push(s3.new(t3)), this._canAnimateChart() && p5.push(n5.new(t3)), t3.setThemes(p5);
    ...
    }).filter((e5) => "pie-chart" !== r5 || null != e5.value && e5.value > 0);
    await ("pie-chart" === r5 ? this._createPieChart(e4, v6) : this._createXYChart(e4, v6));
  }
  _getDirection() {
    return y(this.container) ? "rtl" : "ltr";
  }
  async _customizeChartTooltip(e4, t3 = "horizontal") {
    const { colorAm5: i5 } = await import("./chartCommon-VYZ2NOQ7.js");
  ...
  async _createPieChart(e4, t3) {
    const { TooltipAm5: i5 } = await import("./chartCommon-VYZ2NOQ7.js"), { PieChartAm5: a3, PieSeriesAm5: r5 } = await import("./pieChart-UV6JQL72.js"), { mediaInfo: o2, root: s3 } = e4, { title: n5 } = o2, l4 = 5, d2 = o2?.altText || o2?.title || "", m4 = s3.container.children.push(a3.new(s3, { ariaLabel: d2, focusable: true, paddingBottom: l4, paddingTop: l4, paddingLeft: l4, paddingRight: l4 })), c6 = "{category}: {valuePercentTotal.formatNumber('0.00')}%\n ({value})", h6 = i5.new(s3, { labelText: c6 }), p5 = m4.series.push(r5.new(s3, { name: n5, valueField: A, categoryField: w2, tooltip: h6 }));
    p5.ticks.template.set("forceHidden", true), p5.labels.template.set("forceHidden", true), p5.slices.template.states.create("active", { shiftRadius: l4 }), await this._customizeChartTooltip(h6), p5.slices.template.setAll({ ariaLabel: c6, focusable: true, templateField: "columnSettings" }), p5.data.setAll(t3), await p5.appear(this._getChartSeriesAnimationMS()), await m4.appear(this._getChartAnimationMS()), m4.root.dom.classList.toggle(_4.mediaChartRendered, true);
  }
  ...
  async _createColumnChart(e4, t3, i5) {
    const { TooltipAm5: a3, ScrollbarAm5: r5 } = await import("./chartCommon-VYZ2NOQ7.js"), { CategoryAxisAm5: o2, AxisRendererXAm5: s3, ValueAxisAm5: n5, AxisRendererYAm5: l4, ColumnSeriesAm5: d2 } = await import("./xyChart-LIAYYLK3.js"), { mediaInfo: m4, root: c6 } = t3, { value: h6, title: p5 } = m4;
    ...
    const g3 = e4.yAxes.push(n5.new(c6, { renderer: l4.new(c6, { inside: false }), min: this._getMinSeriesValue(h6.series) }));
    g3.get("renderer").labels.template.setAll({ direction: this._getDirection() });
    const M3 = "{categoryX}", _5 = a3.new(c6, { labelText: M3 }), I4 = e4.series.push(d2.new(c6, { name: p5, xAxis: u4, yAxis: g3, valueYField: A, categoryXField: w2, tooltip: _5 }));
    await this._customizeChartTooltip(_5), I4.columns.template.setAll({ ariaLabel: M3, focusable: true, templateField: "columnSettings" }), h6.series.length > v4 && e4.set("scrollbarX", r5.new(c6, { orientation: "horizontal" })), u4.data.setAll(i5), I4.data.setAll(i5), await I4.appear(this._getChartSeriesAnimationMS()), await e4.appear(this._getChartAnimationMS());
  }
  async _createBarChart(e4, t3, i5) {
    ...
    u4.get("renderer").labels.template.setAll({ forceHidden: true });
    const g3 = e4.xAxes.push(n5.new(c6, { renderer: s3.new(c6, { inside: false, inversed: y(this.container) }), min: this._getMinSeriesValue(h6.series) }));
    g3.get("renderer").labels.template.setAll({ direction: this._getDirection() });
    const M3 = "{categoryY}", _5 = a3.new(c6, { labelText: M3 }), I4 = e4.series.push(d2.new(c6, { name: p5, xAxis: g3, yAxis: u4, valueXField: A, categoryYField: w2, tooltip: _5 }));
    await this._customizeChartTooltip(_5, "vertical"), I4.columns.template.setAll({ ariaLabel: M3, focusable: true, templateField: "columnSettings" }), h6.series.length > v4 && e4.set("scrollbarY", r5.new(c6, { orientation: "vertical" })), u4.data.setAll(i5), I4.data.setAll(i5), await I4.appear(this._getChartSeriesAnimationMS()), await e4.appear(this._getChartAnimationMS());
  }
  async _createLineChart(e4, t3, i5) {
    const { TooltipAm5: a3, ScrollbarAm5: r5 } = await import("./chartCommon-VYZ2NOQ7.js"), { CategoryAxisAm5: o2, AxisRendererXAm5: s3, ValueAxisAm5: n5, AxisRendererYAm5: l4, LineSeriesAm5: d2 } = await import("./xyChart-LIAYYLK3.js"), { root: m4, mediaInfo: c6 } = t3, { value: h6, title: p5 } = c6;
    e4.setAll({ wheelX: "panX", wheelY: "zoomX" });
    const u4 = e4.xAxes.push(o2.new(m4, { renderer: s3.new(m4, { inversed: y(this.container) }), categoryField: w2 }));
    u4.get("renderer").labels.template.setAll({ forceHidden: true });
    const g3 = e4.yAxes.push(n5.new(m4, { renderer: l4.new(m4, { inside: false }), min: this._getMinSeriesValue(h6.series) }));
    g3.get("renderer").labels.template.setAll({ direction: this._getDirection() });
    ...
    const C3 = e4.series.push(d2.new(m4, { name: p5, xAxis: u4, yAxis: g3, valueYField: A, categoryXField: w2, tooltip: I4 }));
    C3.strokes.template.setAll({ templateField: "lineSettings" }), await this._customizeChartTooltip(I4, "vertical"), h6.series.length > v4 && e4.set("scrollbarX", r5.new(m4, { orientation: "horizontal" })), u4.data.setAll(i5), C3.data.setAll(i5), await C3.appear(this._getChartSeriesAnimationMS()), await e4.appear(this._getChartAnimationMS());
  }
  async _createXYChart(e4, t3) {
    const { XYChartAm5: i5, XYCursorAm5: a3 } = await import("./xyChart-LIAYYLK3.js"), { root: r5, mediaInfo: o2 } = e4, { type: s3 } = o2, n5 = o2?.altText || o2?.title || "", l4 = r5.container.children.push(i5.new(r5, { ariaLabel: n5, focusable: true, panX: true, panY: true }));
    l4.set("cursor", a3.new(r5, {})), "column-chart" === s3 && await this._createColumnChart(l4, e4, t3), "bar-chart" === s3 && await this._createBarChart(l4, e4, t3), "line-chart" === s3 && await this._createLineChart(l4, e4, t3), l4.root.dom.classList.toggle(_4.mediaChartRendered, true);
  }
  ...
  _getImageSource(e4, t3) {
    const i5 = e4.includes("?") ? "&" : "?", [a3, r5 = ""] = e4.split("#");
    return `${a3}${i5}timestamp=${t3}${r5 ? "#" : ""}${r5}`;
  }
};
__decorate([a2()], T3.prototype, "_refreshIntervalInfo", void 0), __decorate([a2()], T3.prototype, "attributes", null), __decorate([a2()], T3.prototype, "activeMediaInfoIndex", null), __decorate([a2()], T3.prototype, "description", null), __decorate([a2()], T3.prototype, "fieldInfoMap", null), __decorate([a2()], T3.prototype, "layer", null), __decorate([a2()], T3.prototype, "mediaInfos", null), __decorate([a2()], T3.prototype, "popupTemplate", null), __decorate([a2()], T3.prototype, "relatedInfos", null), __decorate([a2()], T3.prototype, "title", null), __decorate([a2({ type: v2 })], T3.prototype, "viewModel", void 0), __decorate([a2(), v("esri/widgets/Feature/t9n/Feature")], T3.prototype, "messages", void 0), T3 = __decorate([c("esri.widgets.Feature.FeatureMedia")], T3);
...
var g = class extends O {
  ...
  loadDependencies() {
    return c3({ loader: () => import("./calcite-loader-VVZPHK6B.js") });
  }
  destroy() {
...
__decorate([a2({ type: E2 })], g.prototype, "viewModel", void 0), g = __decorate([c("esri.widgets.Feature.FeatureExpression")], g);
...
var M2 = b2 = class extends O {
  constructor(e4, t3) {
    super(e4, t3), this._featureElementInfo = null, this._relatedFeatureIntersectionObserverNode = null, this._relatedFeatureIntersectionObserver = new IntersectionObserver(([e5]) => {
      ...
      const { state: e5, showAllEnabled: t4, relatedFeatures: s3, featuresPerPage: i5, featurePage: r5 } = this.viewModel;
      "ready" === e5 && t4 && s3.length >= i5 * r5 && this.viewModel.featurePage++;
    };
  }
  initialize() {
    this._featureElementInfo = new p2(), this.addHandles([l(() => [this.viewModel.description, this.viewModel.title, this.headingLevel], () => this._setupFeatureElementInfo(), h), l(() => [this.viewModel.state, this.viewModel.showAllEnabled, this._relatedFeatureIntersectionObserverNode], () => this._handleRelatedFeatureObserverChange()), a(() => this.viewModel.relatedFeatureViewModels, "change", () => this._setupRelatedFeatureViewModels())]);
  }
  loadDependencies() {
    return c3({ chip: () => import("./calcite-chip-XVBOSDXF.js"), icon: () => import("./calcite-icon-6UYXZHFB.js"), list: () => import("./calcite-list-6DLENFMV.js"), "list-item": () => import("./calcite-list-item-HIYDKA7X.js"), loader: () => import("./calcite-loader-VVZPHK6B.js"), notice: () => import("./calcite-notice-NS6DRQIM.js") });
  }
  destroy() {
    this._unobserveRelatedFeatureObserver(), this._featureElementInfo = u(this._featureElementInfo);
  }
  get displayShowAllButton() {
    const { showAllEnabled: e4, featureCount: t3, displayCount: s3, state: i5, allCategoriesCount: r5 } = this.viewModel;
    return !e4 && "ready" === i5 && (!!r5 && (r5 > s3 || 0 === s3) || !!t3 && (t3 > s3 || 0 === s3));
  }
  ...
  get allItemsDescription() {
    const { messages: e4 } = this, { featureCount: i5, allCategories: r5, allCategoriesCount: o2 } = this.viewModel;
    return w(e4?.numberRecords, { number: h3(r5 ? o2 : i5) });
  }
  get description() {
    return this.viewModel.description;
  }
  ...
  async _selectRecord(e4) {
    ...
    const { default: i5 } = await import("./Feature-IAOKUPH5.js");
  ...
  _renderCategory(e4) {
    const { count: t3, name: i5, value: r5 } = e4, o2 = h3(t3);
    return x("calcite-list-item", { class: F2.listItem, disabled: !t3, key: r5, label: i5, onCalciteListItemSelect: () => this._selectCategory(e4) }, x("calcite-chip", { label: o2, scale: "s", slot: "content-end" }, o2), this._renderChevronIconNode());
  }
  ...
  _setupRelatedFeatureViewModels() {
    ...
    this.removeHandles(t3), e4?.forEach((e5) => {
      this.addHandles(l(() => [e5.title, e5.state], () => this.scheduleRender(), h), t3);
    }), this.scheduleRender();
  }
  _setupFeatureElementInfo() {
...
__decorate([a2()], M2.prototype, "_relatedFeatureIntersectionObserverNode", void 0), __decorate([a2({ readOnly: true })], M2.prototype, "displayShowAllButton", null), __decorate([a2({ readOnly: true })], M2.prototype, "displayListItems", null), __decorate([a2({ readOnly: true })], M2.prototype, "allItemsDescription", null), __decorate([a2()], M2.prototype, "description", null), __decorate([a2()], M2.prototype, "featureVisibleElements", void 0), __decorate([a2()], M2.prototype, "flowItems", void 0), __decorate([a2()], M2.prototype, "flowType", void 0), __decorate([a2()], M2.prototype, "headingLevel", void 0), __decorate([a2()], M2.prototype, "title", null), __decorate([a2({ type: _3 })], M2.prototype, "viewModel", void 0), __decorate([a2(), v("esri/widgets/Feature/t9n/Feature")], M2.prototype, "messages", void 0), __decorate([a2(), v("esri/t9n/common")], M2.prototype, "messagesCommon", void 0), __decorate([a2()], M2.prototype, "visibleElements", void 0), __decorate([m("visibleElements")], M2.prototype, "castVisibleElements", null), M2 = b2 = __decorate([c("esri.widgets.Feature.FeatureRelationship")], M2);
...
var g2 = class extends O {
  ...
  initialize() {
    this._featureElementInfo = new p2(), this.addHandles([l(() => [this.viewModel.description, this.viewModel.title, this.headingLevel], () => this._setupFeatureElementInfo(), h)]);
  }
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-6UYXZHFB.js"), list: () => import("./calcite-list-6DLENFMV.js"), "list-item": () => import("./calcite-list-item-HIYDKA7X.js"), loader: () => import("./calcite-loader-VVZPHK6B.js"), notice: () => import("./calcite-notice-NS6DRQIM.js") });
  }
  destroy() {
...
__decorate([a2({ constructOnly: true })], g2.prototype, "onSelectAssociationType", void 0), __decorate([a2()], g2.prototype, "flowType", void 0), __decorate([a2()], g2.prototype, "flowItems", void 0), __decorate([a2()], g2.prototype, "parentFeatureViewModel", void 0), __decorate([a2()], g2.prototype, "featureVisibleElements", void 0), __decorate([a2()], g2.prototype, "description", null), __decorate([a2()], g2.prototype, "headingLevel", void 0), __decorate([a2()], g2.prototype, "title", null), __decorate([a2({ type: v3 })], g2.prototype, "viewModel", void 0), __decorate([a2(), v("esri/widgets/Feature/t9n/Feature")], g2.prototype, "messages", void 0), __decorate([a2(), v("esri/t9n/common")], g2.prototype, "messagesCommon", void 0), __decorate([a2({ type: s2, nonNullable: true })], g2.prototype, "visibleElements", void 0), g2 = __decorate([c("esri.widgets.Feature.FeatureUtilityNetworkAssociations")], g2);
...
var k2 = class extends d(O) {
  constructor(e4, t3) {
    super(e4, t3), this._contentWidgets = [], this.flowType = "feature", this.flowItems = null, this.headingLevel = 2, this.messages = null, this.messagesCommon = null, this.visibleElements = __spreadValues({}, j2), this.viewModel = new ne(), true !== e4?.suppressDeprecationWarning && (this.announceDeprecation = () => {
      r(n.getLogger(this), "Feature", "arcgis-feature", { version: "4.34" });
    });
  }
  normalizeCtorArgs(e4 = {}) {
  ...
  loadDependencies() {
    return c3({ notice: () => import("./calcite-notice-NS6DRQIM.js"), loader: () => import("./calcite-loader-VVZPHK6B.js") });
  }
  destroy() {
  ...
  _renderTitle() {
    ...
    return e4.title ? x(i3, { class: t2.title, innerHTML: t3, level: this.headingLevel }) : null;
  }
  _renderContent() {
  ...
  _renderLastEditInfo() {
    ...
    const { date: n5, user: r5 } = s3, o2 = "edit" === s3.type ? r5 ? t3.lastEditedByUser : t3.lastEdited : r5 ? t3.lastCreatedByUser : t3.lastCreated, l4 = w(o2, { date: n5, user: r5 });
  ...
  _setupContentWidgets() {
    this._destroyContentWidgets();
    const { headingLevel: e4, visibleElements: t3, flowItems: i5, viewModel: s3 } = this, n5 = s3?.content, { contentViewModels: r5 } = s3;
    if (Array.isArray(n5)) n5.forEach((n6, o2) => {
      if ("attachments" === n6.type && (this._contentWidgets[o2] = new h4({ displayType: n6.displayType, headingLevel: t3.title && e4 < 6 ? e4 + 1 : e4, viewModel: r5[o2] })), "fields" === n6.type && (this._contentWidgets[o2] = new h5({ viewModel: r5[o2] })), "media" === n6.type && (this._contentWidgets[o2] = new T3({ viewModel: r5[o2] })), "text" === n6.type && (this._contentWidgets[o2] = new c5({ viewModel: r5[o2] })), "custom" === n6.type && (this._contentWidgets[o2] = new c5({ viewModel: r5[o2] })), "expression" === n6.type && (this._contentWidgets[o2] = new g({ viewModel: r5[o2] })), "relationship" === n6.type) {
        const e5 = new M2({ flowItems: i5, featureVisibleElements: t3, viewModel: r5[o2] });
        this._contentWidgets[o2] = e5;
      }
      if ("utility-network-associations" === n6.type) {
        const e5 = async (e6) => {
          const { viewModel: n8, listType: r6, title: o3 } = e6;
          if (!i5) return;
          n8.activeAssociationType = r6;
          const { default: l4 } = await import("./FeatureUtilityNetworkAssociationList-ZBBAQQDV.js"), d2 = new l4({ viewModel: n8, parentFeatureViewModel: s3, listType: r6, title: o3, featureVisibleElements: t3, description: s3.title, flowItems: i5 });
          i5.push(d2);
        }, n7 = new g2({ flowItems: i5, onSelectAssociationType: e5, parentFeatureViewModel: s3, featureVisibleElements: t3, viewModel: r5[o2] });
        this._contentWidgets[o2] = n7;
      }
    }, this);
    else {
      const e5 = r5[0];
...
__decorate([a2()], k2.prototype, "flowType", void 0), __decorate([a2({ type: j })], k2.prototype, "graphic", null), __decorate([a2()], k2.prototype, "defaultPopupTemplateEnabled", null), __decorate([a2()], k2.prototype, "flowItems", void 0), __decorate([a2()], k2.prototype, "headingLevel", void 0), __decorate([a2({ readOnly: true })], k2.prototype, "isTable", null), __decorate([a2()], k2.prototype, "icon", null), __decorate([a2()], k2.prototype, "label", null), __decorate([a2({ type: _2 })], k2.prototype, "location", null), __decorate([a2(), v("esri/widgets/Feature/t9n/Feature")], k2.prototype, "messages", void 0), __decorate([a2(), v("esri/t9n/common")], k2.prototype, "messagesCommon", void 0), __decorate([a2()], k2.prototype, "spatialReference", null), __decorate([a2()], k2.prototype, "timeZone", null), __decorate([a2({ readOnly: true })], k2.prototype, "title", null), __decorate([a2()], k2.prototype, "visibleElements", void 0), __decorate([m("visibleElements")], k2.prototype, "castVisibleElements", null), __decorate([a2()], k2.prototype, "map", null), __decorate([a2()], k2.prototype, "view", null), __decorate([a2({ type: ne })], k2.prototype, "viewModel", void 0), k2 = __decorate([c("esri.widgets.Feature")], k2);
...
//# sourceMappingURL=chunk-AHQXVUJP.js.map
