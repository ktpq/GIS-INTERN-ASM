...
var s4 = class extends s2 {
  constructor(t7) {
    super(new i2(t7)), this._observer && e4.register(this, new WeakRef(this._observer), this);
  }
  destroy() {
...
var i2 = class {
  ...
  destroy() {
    this.destroyed = true, this._notify = r2;
  }
};
var e4 = new FinalizationRegistry((t7) => {
  t7.deref()?.destroy();
});
function r2() {
}
...
var t2 = class {
  constructor(t7 = 50, o8 = 50) {
    this._pool = new e2(() => [], void 0, r3, o8, t7);
  }
  acquire() {
...
function o5(l6, o8) {
  ...
  function a3() {
    if (!e11 || s7) return;
    if (u4) return void c2(a3);
    const n6 = i5;
    e11.clear(), u4 = true, s7 = true, i5 = f(e11, l6), s7 = false, u4 = false, o8(i5, n6), f3();
  }
  function m6() {
...
function i4(l6, o8) {
  ...
  function m6() {
    i5 = false, a3 && !e11 && (u4 ? c2(m6) : (a3.clear(), u4 = true, e11 = true, f(a3, l6), e11 = false, u4 = false, f3()));
  }
  function p4() {
...
function c2(n6) {
  l4.includes(n6) || l4.unshift(n6);
}
function f3() {
  for (; l4.length; ) l4.pop()();
}
...
function b(e11, r7, l6) {
  let o8 = l(e11, r7, l6, (e12, r8, l7) => {
    let i5, n6, s7 = e6(() => u2(e12, r8), (t7, s8) => {
...
function O(e11) {
  return n2(p2, (t7) => t7.oldValue === e11);
}
...
var t4 = Object.freeze({ done: true, value: void 0 });
function e7(n6) {
  const e11 = [];
  ...
  async function r7() {
    ...
    try {
      const n7 = await l6;
      return l6 = null, n7.done ? (u8 = true, t4) : (e11.push(n7.value), n7);
    } catch (r8) {
...
var n4 = class extends s3 {
  ...
  getComputed(t7, a3) {
    ...
    const { host: m6 } = t7;
    g3 & i.AutoTracked ? d2 = f(this.trackingTarget, a3, m6) : (m(m6, this), d2 = a3.call(m6)), this.flags |= i.DepTrackingInitialized, n6.set(l6, d2, 1);
    const c3 = n6.get(l6);
...
//# sourceMappingURL=chunk-2HP4RAZC.js.map
