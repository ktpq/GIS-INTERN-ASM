...
import {
  P
} from "./chunk-2MBP2AU2.js";
import {
  r
} from "./chunk-HN2DLRDR.js";
import {
  i as i2
} from "./chunk-BI6ZNLS5.js";
import {
  i as i4
...
var i6 = (i7) => {
  ...
  return __decorate([a()], p.prototype, "exportImageParameters", void 0), __decorate([a({ readOnly: true })], p.prototype, "floors", null), __decorate([a({ readOnly: true })], p.prototype, "exportImageVersion", null), __decorate([a()], p.prototype, "layer", void 0), __decorate([a()], p.prototype, "suspended", void 0), __decorate([a({ readOnly: true })], p.prototype, "timeExtent", null), p = __decorate([c("esri.views.layers.MapImageLayerView")], p), p;
};

// node_modules/@arcgis/core/views/2d/layers/MapImageLayerView2D.js
var w = class extends i6(i3(S(I))) {
  constructor() {
  ...
  fetchImage(t, i7, e2, r3) {
    return this.layer.fetchImage(t, i7, e2, __spreadValues({ timeExtent: this.timeExtent, floors: this.floors }, r3));
  }
  fetchImageBitmap(t, i7, e2, r3) {
    return this.layer.fetchImageBitmap(t, i7, e2, __spreadValues({ timeExtent: this.timeExtent, floors: this.floors }, r3));
  }
  highlight(t, e2) {
    const r3 = i4(t);
    if (0 === r3.length) return e();
    const h = r2(e2);
    return this._addHighlightGraphics(r3, h), e(() => !this.destroyed && this._removeHighlightGraphics(r3, h));
  }
  _processHighlight() {
...
//# sourceMappingURL=MapImageLayerView2D-6XP6CGNU.js.map
