...
async function c() {
  if (!u2()) {
    const [n2, t2] = await Promise.all([import("./OperatorProject-LRGB4CBI.js"), import("./SpatialReference-QMDBPWPX.js").then((n3) => n3.aP).then(({ injectPe: n3 }) => n3), P()]);
...
//# sourceMappingURL=chunk-NEG7AWOP.js.map
