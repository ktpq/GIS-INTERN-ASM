...
var T2 = class extends O {
  ...
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-U2373TSY.js") });
  }
  get capabilities() {
...
function r5(r6, t3) {
  ...
  if (!n6) return t3;
  const i5 = t3.match(n6.pattern), l4 = i5?.[2], o2 = r2(r2(n6.label, { messages: r6, hierPart: l4 }), { appName: n6.appName }), m4 = n6.target ? ` target="${n6.target}"` : "", g3 = "_blank" === n6.target ? ' rel="noreferrer"' : "";
...
var T3 = class extends O {
  constructor(e4, t3) {
    super(e4, t3), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new v2(), this.messages = null, this._disposeChart = (e5) => {
      ...
      if (t4 || !i5 || !e5) return;
      const { createRoot: a3 } = await import("./chartUtilsAm5-BZ4D5CFN.js"), r6 = await a3(e5);
  ...
  async _renderChart(e4) {
    const { root: t3, mediaInfo: i5 } = e4, { value: a3, type: r6 } = i5, { ResponsiveThemeAm5: o2, DarkThemeAm5: s3, AnimatedThemeAm5: n6, ColorSetAm5: d2, ThemeAm5: m4, esriChartColorSet: c6 } = await import("./chartCommon-VYZ2NOQ7.js"), h6 = m4.new(t3);
  ...
  async _createPieChart(e4, t3) {
    const { TooltipAm5: i5 } = await import("./chartCommon-VYZ2NOQ7.js"), { PieChartAm5: a3, PieSeriesAm5: r6 } = await import("./pieChart-UV6JQL72.js"), { mediaInfo: o2, root: s3 } = e4, { title: n6 } = o2, l4 = 5, d2 = o2?.altText || o2?.title || "", m4 = s3.container.children.push(a3.new(s3, { ariaLabel: d2, focusable: true, paddingBottom: l4, paddingTop: l4, paddingLeft: l4, paddingRight: l4 })), c6 = "{category}: {valuePercentTotal.formatNumber('0.00')}%\n ({value})", h6 = i5.new(s3, { labelText: c6 }), p6 = m4.series.push(r6.new(s3, { name: n6, valueField: A, categoryField: w2, tooltip: h6 }));
  ...
  async _createColumnChart(e4, t3, i5) {
    const { TooltipAm5: a3, ScrollbarAm5: r6 } = await import("./chartCommon-VYZ2NOQ7.js"), { CategoryAxisAm5: o2, AxisRendererXAm5: s3, ValueAxisAm5: n6, AxisRendererYAm5: l4, ColumnSeriesAm5: d2 } = await import("./xyChart-LIAYYLK3.js"), { mediaInfo: m4, root: c6 } = t3, { value: h6, title: p6 } = m4;
  ...
  async _createLineChart(e4, t3, i5) {
    const { TooltipAm5: a3, ScrollbarAm5: r6 } = await import("./chartCommon-VYZ2NOQ7.js"), { CategoryAxisAm5: o2, AxisRendererXAm5: s3, ValueAxisAm5: n6, AxisRendererYAm5: l4, LineSeriesAm5: d2 } = await import("./xyChart-LIAYYLK3.js"), { root: m4, mediaInfo: c6 } = t3, { value: h6, title: p6 } = c6;
    e4.setAll({ wheelX: "panX", wheelY: "zoomX" });
...
var g = class extends O {
  ...
  loadDependencies() {
    return c3({ loader: () => import("./calcite-loader-Y6EK7FKB.js") });
  }
  destroy() {
...
var M2 = b2 = class extends O {
  ...
  loadDependencies() {
    return c3({ chip: () => import("./calcite-chip-IHCK5NQU.js"), icon: () => import("./calcite-icon-U2373TSY.js"), list: () => import("./calcite-list-MGE6ZTNQ.js"), "list-item": () => import("./calcite-list-item-2TI7SVNH.js"), loader: () => import("./calcite-loader-Y6EK7FKB.js"), notice: () => import("./calcite-notice-EOBFSRHI.js") });
  }
  destroy() {
  ...
  async _selectRecord(e4) {
    ...
    const { default: i5 } = await import("./Feature-BY7JPZU3.js");
...
var g2 = class extends O {
  ...
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-U2373TSY.js"), list: () => import("./calcite-list-MGE6ZTNQ.js"), "list-item": () => import("./calcite-list-item-2TI7SVNH.js"), loader: () => import("./calcite-loader-Y6EK7FKB.js"), notice: () => import("./calcite-notice-EOBFSRHI.js") });
  }
  destroy() {
...
var k2 = class extends d(O) {
  ...
  loadDependencies() {
    return c3({ notice: () => import("./calcite-notice-EOBFSRHI.js"), loader: () => import("./calcite-loader-Y6EK7FKB.js") });
  }
  destroy() {
    ...
    if (Array.isArray(n6)) n6.forEach((n7, o2) => {
      ...
      if ("utility-network-associations" === n7.type) {
        const e5 = async (e6) => {
          ...
          const { default: l4 } = await import("./FeatureUtilityNetworkAssociationList-ABW6YT2B.js"), d2 = new l4({ viewModel: n9, parentFeatureViewModel: s3, listType: r7, title: o3, featureVisibleElements: t3, description: s3.title, flowItems: i5 });
          i5.push(d2);
...
//# sourceMappingURL=chunk-PMMA7OW2.js.map
