...
var s = class {
  ...
  remove(i) {
    ...
    for (w.clear(), j.clear(); h || w.length > 0; ) {
      if (h || (h = w.pop(), s2 = w.data[w.length - 1], a2 = j.pop() ?? 0, r4 = true), h.leaf && (e = b(h.children, r(i), h.children.length, h.indexHint), -1 !== e)) return h.children.splice(e, 1), w.push(h), this._condense(w), this;
  ...
  _build(t2, i, n, e) {
    ...
    if (h <= s2) {
      const e2 = new y2(t2.slice(i, n + 1));
  ...
  _split(t2, i) {
    ...
    if (!s2) return;
    const a2 = n.children.splice(s2, n.children.length - s2), r4 = n.leaf ? new y2(a2) : new F(a2);
  ...
  _condense(i) {
    for (let n = i.length - 1; n >= 0; n--) {
      ...
      if (0 === e.children.length) if (n > 0) {
        ...
        s2.splice(b(s2, e, s2.length, h.indexHint), 1);
      } else this.clear();
...
function c(t2, i, n, e, h) {
  h || (h = new y2([])), h.minX = 1 / 0, h.minY = 1 / 0, h.maxX = -1 / 0, h.maxY = -1 / 0;
...
var S = class extends b2 {
  constructor() {
    super(...arguments), this.height = 1, this.indexHint = new y();
  }
};
...
//# sourceMappingURL=chunk-AEE6QW6C.js.map
