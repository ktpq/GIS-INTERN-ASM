...
var InputMessage = class extends LitElement {
  ...
  static {
    this.properties = { icon: [3, { converter: stringOrBoolean, type: String }, { reflect: true }], iconFlipRtl: [7, {}, { reflect: true, type: Boolean }], scale: [3, {}, { reflect: true }], status: [3, {}, { reflect: true }] };
  }
  static {
    this.styles = styles;
  }
...
//# sourceMappingURL=chunk-RFOLF4TL.js.map
