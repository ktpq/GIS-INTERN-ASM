...
var n5 = null;
function r6() {
  return n5 || (n5 = import("./lerc-wasm-5GAHVIGM.js").then(({ default: t6 }) => t6({ locateFile: (t7) => n3(`esri/layers/raster/formats/${t7}`) })).then((e6) => {
    l2(e6);
  }), n5);
}
...
var r8;
function o5() {
  return r8 ??= import("./qb3-wasm-MQUYROPY.js").then(({ default: e6 }) => e6({ locateFile: (e7) => n3(`esri/layers/raster/formats/${e7}`) })).then((t6) => {
    l3(t6);
  }), r8;
}
...
//# sourceMappingURL=chunk-JCYVYAPI.js.map
