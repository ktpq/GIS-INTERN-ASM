...
var ActionGroup = class extends LitElement {
  ...
  setRoleOnActions() {
    this.actions.forEach((action) => {
      action.aria = __spreadProps(__spreadValues({}, action.aria), {
    ...
    if (this.selectionMode === "none") {
      this.actions.forEach((action) => {
        if (action.aria) {
          ...
          action.aria = __spreadValues({}, action.aria);
        }
      });
    }
  }
...
//# sourceMappingURL=chunk-IBLNP6OH.js.map
