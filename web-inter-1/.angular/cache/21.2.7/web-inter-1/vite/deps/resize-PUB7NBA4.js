import {
  p
} from "./chunk-SD5KGYC2.js";
import "./chunk-MHKOJKLF.js";
...
async function s2(s3, n, p2) {
  const m = f2(s3), u2 = __spreadProps(__spreadValues({}, n.toJSON()), { f: "json" }), f3 = u(__spreadValues(__spreadValues({}, m.query), u2)), a = s(f3, __spreadProps(__spreadValues({}, p2), { method: "post", authMode: "no-prompt" })), d = `${m.path}/unitIdentifiers/resize`, { data: j } = await f(d, a);
  return p.fromJSON(j);
}
export {
  s2 as resize
};
//# sourceMappingURL=resize-PUB7NBA4.js.map
