...
var R = class extends g2 {
  constructor(e7, t6) {
    let i5 = t(k(t6));
    t6.instanced && t6.instancedDoublePrecision && (i5 = i5.concat(t(u4(t6)))), super(e7, t6, i5), this.shader = new t3(K, () => import("./DefaultMaterial.glsl-K3N4YDKT.js"));
  }
  _makePipeline(e7, t6) {
...
var t5 = class extends R {
  constructor() {
    super(...arguments), this.shader = new t3(z2, () => import("./RealisticTree.glsl-LRMRUN6Q.js"));
  }
};
...
//# sourceMappingURL=chunk-637BPDHA.js.map
