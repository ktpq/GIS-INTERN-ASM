...
function T2(e5, i4, s8, t5, n5) {
  const o5 = i4.get(n5);
  o5 ? s8.has(o5.name) ? "all" !== t5 && false === t5?.has(o5.type) && e5.set(n5, { type: "invalid-type", fieldName: o5.name, fieldType: i2.fromJSON(o5.type), allowedFieldTypes: Array.from(t5, (e6) => i2.fromJSON(e6)) }) : e5.set(n5, { type: "missing-field", fieldName: o5.name }) : e5.set(n5, { type: "invalid-field", fieldName: n5 });
}
...
var J = class {
  ...
  async _getAggregateGeometry(e5, n5) {
    ...
    if ("EnvelopeAggregate" === l8) {
      ...
      const e6 = h4 ? l5(h4) : r3(l4(o5(m8, p4)));
...
//# sourceMappingURL=chunk-CUIOGO3I.js.map
