...
export {
  tn as canProjectWithoutEngine,
  sn as initializeProjection,
  on as isEqualBaseGCS,
  V as isLoaded,
  X as isLoadedOrLoad,
  Y as isLoadedOrLoadFor,
  F as load,
  H as project,
  rn as projectAsync,
  dn as projectExtent,
  J as projectMany,
  cn as projectMultipoint,
  Q as projectOrLoad,
  $ as projectOrLoadMany,
  ln as projectPoint,
  hn as projectPolygon,
  pn as projectPolyline,
  an as projectWithoutEngine,
  q as requiresLoad,
  en as test,
  N as tryProject,
  nn as unload
