...
async function o2(o3) {
  const a2 = "portalItem" in o3 ? o3 : { portalItem: o3 }, { fromItem: e } = await import("./portalLayers-OGF2SOBQ.js");
  try {
    return await e(a2);
  } catch (p) {
...
var b = class extends n2(o(u)) {
  ...
  static async fromArcGISServerUrl(t) {
    ...
    return (await import("./arcgisLayers-XKD56DX3.js")).fromUrl(e);
  }
...
//# sourceMappingURL=chunk-4N35QWIB.js.map
