...
import {
  ...
  x,
  y as y2
} from "./chunk-TW5YGHVN.js";
import {
  T
} from "./chunk-3G2EIBVV.js";
import {
  D,
  I as I3,
  O,
...
var G;
async function H2() {
  null == G && (G = await import("./operators-X53U2QQV.js"), await G.loadAll());
}
function F(H5, F4) {
  H5.disjoint = function(e4, n7) {
    ...
    return F4(e4, n7, (t5, r5, u4) => (oe(u4, 2, 2, e4, n7), u4[0] === u4[1] || (u4[0] instanceof s2 && u4[1] instanceof s2 ? G.equals.execute(u4[0], u4[1]) : (ne(u4[0]) && ne(u4[1]) || ie(u4[0]) && ie(u4[1]) || !(!re(u4[0]) || !re(u4[1]))) && u4[0].equals(u4[1]))));
  }, H5.relate = function(e4, t5) {
    return F4(e4, t5, (a3, l5, o6) => {
      if (o6 = Je(o6), oe(o6, 3, 3, e4, t5), o6[0] instanceof s2 && o6[1] instanceof s2) return G.relate.execute(o6[0], o6[1], ge(o6[2]));
      if (o6[0] instanceof s2 && null === o6[1]) return false;
      if (o6[1] instanceof s2 && null === o6[0]) return false;
    ...
    return F4(e4, i5, (a3, l5, o6) => {
      ...
      if (1 === o6.length) if (o(o6[0])) {
        for (const t5 of Je(o6[0])) if (null !== t5) {
          if (!(t5 instanceof s2)) throw new n4(e4, "InvalidParameter", i5);
          u4.push(t5);
        }
      } else {
        if (!te(o6[0])) {
          if (o6[0] instanceof s2) return je(o2(o6[0]), e4.spatialReference);
    ...
    return F4(e4, t5, (a3, l5, o6) => {
      ...
      if (null === o6[0]) return null;
      if (!(o6[0] instanceof s2)) throw new n4(e4, "InvalidParameter", t5);
    ...
    return F4(e4, a3, (l5, o6, u4) => {
      ...
      if (null === u4[0]) return [];
      if (!(u4[0] instanceof s2)) throw new n4(e4, "InvalidParameter", a3);
    ...
    return F4(e4, t5, (a3, l5, o6) => {
      ...
      if (!(u4 instanceof s2)) throw new n4(e4, "InvalidParameter", t5);
    ...
    return F4(e4, t5, (a3, l5, o6) => {
      ...
      let u4 = o6[0];
      if ((o(o6[0]) || te(o6[0])) && (u4 = Pe(o6[0], e4.spatialReference)), !(u4 instanceof s2)) throw new n4(e4, "InvalidParameter", t5);
      let c3 = o6[1];
      if ((o(o6[1]) || te(o6[1])) && (c3 = Pe(o6[1], e4.spatialReference)), !(c3 instanceof s2)) throw new n4(e4, "InvalidParameter", t5);
    ...
    return F4(e4, t5, (e5, t6, a3) => {
      ...
      if (!(o6 instanceof s2)) throw new n4(e5, "InvalidParameter", t6);
    ...
    return F4(t5, a3, (l5, o6, u4) => {
      if (u4 = Je(u4), oe(u4, 2, 2, t5, a3), !(u4[0] instanceof s2 || null === u4[0])) throw new n4(t5, "InvalidParameter", a3);
...
function le(n7, t5, r5) {
  const o6 = re2(n7, r2(t5));
  if (null == o6) throw ne2().error(`Internal error: Symbol "${t5.name}" not declared.`), new s(null, "NeverReach", t5);
  if (null != r5 && o6.scope !== r5) throw ne2().error(`Internal error: Expected to resolve "${t5.name}" in the ${r5} scope but is in the ${o6.scope} scope.`), new s(null, "NeverReach", t5);
  return o6;
}
function ae(n7, t5) {
...
function ce(e4, n7) {
  switch (n7.type) {
    ...
    case "SafeMemberExpression":
      throw ne2().error("SafeMemberExpression outside of MemberAccessChainExpression"), new s(null, "Unrecognized", n7);
    default:
...
function he(e4, n7) {
  ...
  switch ("VariableDeclaration" === n7.left.type ? (r5 = le(e4, n7.left.declarations[0].id), l5 += me(e4, n7.left)) : r5 = oe2(e4, n7.left), r5.scope) {
    ...
    case "global":
      ...
      break;
    default:
      throw r5.scope, new s(null, "NeverReach", n7.left);
  }
...
function be(e4, n7) {
  ...
  switch (Oe(r5), r5.scope) {
    ...
    default:
      throw r5.scope, new s(null, "NeverReach", n7.argument);
  }
}
function $e(e4, n7) {
  let t5 = "lastStatement = lc.voidOperation; \n";
...
function ke(e4, n7) {
  ...
  switch (Oe(r5), r5.scope) {
    ...
    default:
      throw r5.scope, new s(null, "NeverReach", n7.id);
  }
}
function Ee(e4, n7) {
...
function Be(e4, n7, t5) {
  for (const r5 of t5) switch (r5.type) {
    ...
    case "CallExpression":
      ...
      break;
    default:
      throw new s(null, "Unrecognized", r5);
  }
  return n7;
}
...
function Ge(e4, n7) {
  ...
  switch (Oe(t5), t5.scope) {
    ...
    default:
      throw t5.scope, new s(null, "NeverReach", n7);
  }
}
function qe(e4, n7) {
...
async function sn() {
  return en([await import("./geomasync-CVKEF2PT.js")], "async"), true;
}
...
async function q2() {
  await sn(), x3 = await import("./arcadeAsyncRuntime-T74SUEWK.js");
...
async function X() {
  await N2();
  const [e4, r5, n7, s10, a3, o6] = await Promise.all([import("./featureSetUtils-SXTVTCOI.js"), import("./featuresetbase-SHW3OIZI.js"), import("./featuresetgeom-XJ3XS37S.js"), import("./featuresetstats-IZQEFJH5.js"), import("./featuresetstring-YZGCRT2D.js"), import("./knowledgegraph-TYVDVZYQ.js")]);
...
//# sourceMappingURL=chunk-ZQV6LGFV.js.map
