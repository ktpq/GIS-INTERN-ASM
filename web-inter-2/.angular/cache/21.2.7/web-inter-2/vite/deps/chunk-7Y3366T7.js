...
import {
  ...
  d,
  z as z3
} from "./chunk-PRGQEMCH.js";
import {
  t as t4
} from "./chunk-VSV5RZS5.js";
import {
  t as t5
} from "./chunk-TZUET3WW.js";
import {
  r as r4
...
function s4(e3) {
  ...
  if (!f(s8, r7)) throw a2().error(`Internal error: exported undeclared symbols {${Array.from(c(s8, r7)).join(", ")}}`), new s2(null, "NeverReach", null);
  return { globals: r7, exports: s8 };
}
function i5(e3) {
  const r7 = /* @__PURE__ */ new Set(), o4 = /* @__PURE__ */ new Set();
  if (c2(e3.body, r7, o4), o4.size > 0) throw a2().error(`Internal error: cannot export locals {${Array.from(o4.values()).join(", ")}}`), new s2(null, "NeverReach", null);
  return r7;
}
function l2(e3) {
  const t8 = [];
...
function F(F4) {
  function p8(n8, e3, o4) {
    ...
    if (o(n8)) return n8;
    throw new n5(e3, "InvalidParameter", o4);
  }
  function y3(n8, t8) {
  ...
  function N2(n8, r7, o4, u4) {
    oe(o4, 1, 2, n8, r7);
    let s8 = o4[0];
    if (te(s8) && (s8 = s8.toArray()), false === o(s8)) throw new n5(n8, "InvalidParameter", r7);
    if (o4.length > 1) {
      if (false === L(o4[1])) throw new n5(n8, "InvalidParameter", r7);
      let e3 = s8;
  ...
  F4.functions.array = function(r7, a5) {
    return F4.standardFunction(r7, a5, (s8, c5, l6) => {
      ...
      if (o(l6[0])) {
        if (2 === l6.length && false === t(l6[1])) throw new n5(r7, "InvalidParameter", a5);
      ...
      const f7 = Se(l6[0]);
      if (isNaN(f7) || false === r(f7)) throw new n5(r7, "InvalidParameter", a5);
    ...
    return F4.standardFunction(n8, r7, (o4, u4, a5) => {
      if (oe(a5, 1, 1, n8, r7), te(a5[0])) {
        if (a5[0].length() <= 0) throw new n5(n8, "OutOfBounds", r7);
        return a5[0].get(0);
      }
      if (o(a5[0])) {
        if (a5[0].length <= 0) throw new n5(n8, "OutOfBounds", r7);
      ...
      throw new n5(n8, "InvalidParameter", r7);
    });
    ...
    return F4.standardFunction(n8, r7, (o4, i9, u4) => {
      if (oe(u4, 1, 1, n8, r7), o(u4[0])) {
        if (u4[0].length <= 0) throw new n5(n8, "OutOfBounds", r7);
    ...
    return F4.standardFunction(n8, r7, (o4, i9, l6) => {
      if (oe(l6, 2, 2, n8, r7), o(l6[0])) {
        let e3 = Se(l6[1]);
        if (isNaN(e3) || false === r(e3)) throw new n5(n8, "InvalidParameter", r7);
        const o5 = l6[0];
        if (o5.length <= 0) throw new n5(n8, "OutOfBounds", r7);
        if (e3 < 0 && (e3 = o5.length + e3), e3 < 0) throw new n5(n8, "OutOfBounds", r7);
        if (e3 >= o5.length) throw new n5(n8, "OutOfBounds", r7);
    ...
    return F4.standardFunction(n8, r7, (o4, i9, l6) => {
      if (oe(l6, 3, 3, n8, r7), o(l6[0])) {
        ...
        if (e3 > i10.length) throw new n5(n8, "OutOfBounds", r7);
        if (e3 < 0 && e3 < -1 * i10.length) throw new n5(n8, "OutOfBounds", r7);
    ...
    return F4.standardFunction(n8, r7, (n9, r8, o4) => {
      ...
      throw new n5(n9, "InvalidParameter", r8);
    });
    ...
    return F4.standardFunction(n8, r7, (i9, s8, c5) => {
      if (oe(c5, 2, 3, n8, r7), o(c5[0])) {
        const e3 = Se(c5[1]);
        if (isNaN(e3) || false === r(e3)) throw new n5(n8, "InvalidParameter", r7);
        if (e3 < 0) throw new n5(n8, "InvalidParameter", r7);
    ...
    return F4.standardFunction(n8, r7, (a5, s8, c5) => {
      if (oe(c5, 1, 3, n8, r7), o(c5[0])) {
        ...
        if (isNaN(e3) || false === r(e3)) throw new n5(n8, "InvalidParameter", r7);
        if (isNaN(i9) || false === r(i9)) throw new n5(n8, "InvalidParameter", r7);
        return c5[0].slice(e3, i9);
      }
      if (te(c5[0])) {
        const e3 = c5[0], i9 = Se(z2(c5[1], 0)), a6 = Se(z2(c5[2], e3.length()));
        if (isNaN(i9) || false === r(i9)) throw new n5(n8, "InvalidParameter", r7);
        if (isNaN(a6) || false === r(a6)) throw new n5(n8, "InvalidParameter", r7);
...
function j2(e3, t8) {
  e3.today = function(r7, e4) {
    return t8(r7, e4, (t9, o4, i9) => {
      ...
      return a5.setHours(0, 0, 0, 0), m2.dateJSAndZoneToArcadeDate(a5, Ke(r7));
    });
  }, e3.time = function(r7, e4) {
    return t8(r7, e4, (t9, f7, m6) => {
      switch (oe(m6, 0, 4, r7, e4), m6.length) {
        case 0: {
          const e5 = m2.nowToArcadeDate(Ke(r7));
      ...
      throw new n5(r7, "InvalidParameter", e4);
    });
    ...
    return t8(e4, i9, (t9, a5, s8) => {
      ...
      if (re(s8[0])) throw new n5(e4, "CannotChangeTimeZoneDateOnly", i9);
      if (re(s8[0])) throw new n5(e4, "CannotChangeTimeZoneTime", i9);
      const d5 = Ze(s8[0], Ke(e4));
      if (null === d5) throw new n5(e4, "InvalidParameter", i9);
      const h3 = h(Z2(ge(s8[1]), e4), false);
      if (null === h3) return null;
      const N2 = m2.arcadeDateAndZoneToArcadeDate(d5, h3);
    ...
    return t8(r7, e4, (t9, o4, i9) => {
      ...
      return "system" === f7 ? m2.systemTimeZoneCanonicalName : "utc" === f7.toLowerCase() ? "UTC" : "unknown" === f7.toLowerCase() ? "Unknown" : f7;
    });
    ...
    return t8(n8, r7, (e4, t9, a5) => {
      ...
      if (c5 < 0 || c5 > 6) throw new n5(n8, "InvalidParameter", r7);
    ...
    return t8(e4, o4, (t9, s8, d5) => {
      if (oe(d5, 0, 8, e4, o4), 3 === d5.length) {
        if (re(d5[0]) && ie(d5[1]) && e(d5[2])) {
          ...
          return null === t10 ? null : p6(m2.fromParts(d5[0].year, d5[0].month, d5[0].day, d5[1].hour, d5[1].minute, d5[1].second, d5[1].millisecond, t10));
        }
        return p6(m2.fromParts(Se(d5[0]), Se(d5[1]) + 1, Se(d5[2]), 0, 0, 0, 0, Ke(e4)));
      }
      if (4 === d5.length) return p6(m2.fromParts(Se(d5[0]), Se(d5[1]) + 1, Se(d5[2]), Se(d5[3]), 0, 0, 0, Ke(e4)));
      if (5 === d5.length) return p6(m2.fromParts(Se(d5[0]), Se(d5[1]) + 1, Se(d5[2]), Se(d5[3]), Se(d5[4]), 0, 0, Ke(e4)));
      if (6 === d5.length) return p6(m2.fromParts(Se(d5[0]), Se(d5[1]) + 1, Se(d5[2]), Se(d5[3]), Se(d5[4]), Se(d5[5]), 0, Ke(e4)));
      if (7 === d5.length) return p6(m2.fromParts(Se(d5[0]), Se(d5[1]) + 1, Se(d5[2]), Se(d5[3]), Se(d5[4]), Se(d5[5]), Se(d5[6]), Ke(e4)));
      if (8 === d5.length) {
        const t10 = h(Z2(ge(d5[7]) ?? "unknown", e4), false);
        return null === t10 ? null : p6(m2.fromParts(Se(d5[0]), Se(d5[1]) + 1, Se(d5[2]), Se(d5[3]), Se(d5[4]), Se(d5[5]), Se(d5[6]), t10));
      }
      if (2 === d5.length) {
        if (re(d5[0]) && e(d5[1])) {
          const t11 = h(Z2(ge(d5[1]) ?? "unknown", e4), false);
          return null === t11 ? null : p6(m2.fromParts(d5[0].year, d5[0].month, d5[0].day, 0, 0, 0, 0, t11));
        }
        if (re(d5[0]) && ie(d5[1])) return p6(m2.fromParts(d5[0].year, d5[0].month, d5[0].day, d5[1].hour, d5[1].minute, d5[1].second, d5[1].millisecond, "unknown"));
        let t10, o5 = ge(d5[1]);
        return "" === o5 ? null : (o5 = ce(o5, true), t10 = "X" === o5 ? DateTime.fromSeconds(Se(d5[0])) : "x" === o5 ? DateTime.fromMillis(Se(d5[0])) : DateTime.fromFormat(ge(d5[0]), o5, { locale: i(), numberingSystem: "latn" }), t10.isValid ? m2.dateTimeToArcadeDate(t10) : null);
      }
      if (1 === d5.length) {
        if (re(d5[0])) return p6(m2.fromParts(d5[0].year, d5[0].month, d5[0].day, 0, 0, 0, 0, "unknown"));
        if (e(d5[0])) {
        ...
        if (false === isNaN(r7)) {
          ...
          return t10.isValid ? m2.dateTimeAndZoneToArcadeDate(t10, Ke(e4)) : null;
        }
        return Ze(d5[0], Ke(e4));
      }
      return 0 === d5.length ? m2.nowToArcadeDate(Ke(e4)) : null;
    });
    ...
    return t8(r7, e4, (t9, o4, i9) => {
      ...
      let N2 = z2(i9[3], "");
      return "" !== N2 && null !== N2 ? (N2 = Z2(ge(N2), r7), s8 = m2.arcadeDateAndZoneToArcadeDate(s8, N2), h3 = m2.arcadeDateAndZoneToArcadeDate(h3, N2)) : s8.timeZone !== h3.timeZone && (s8.isUnknownTimeZone ? s8 = m2.arcadeDateAndZoneToArcadeDate(s8, h3.timeZone) : h3 = (h3.isUnknownTimeZone, m2.arcadeDateAndZoneToArcadeDate(h3, s8.timeZone))), s8.diff(h3, U2(i9[2]));
    });
...
function P5(o4, w, P7) {
  o4.domain = function(e3, r7) {
    return w(e3, r7, (o5, m6, c5) => {
      ...
      throw new n5(e3, "InvalidParameter", r7);
    });
    ...
    return w(e3, r7, (t8, o5, i9) => {
      if (i9.length < 1) throw new n5(e3, "WrongNumberOfParameters", r7);
      return P2;
    });
    ...
    return w(e3, r7, (e4, r8, t8) => {
      ...
      if (!H(o5) || !e(s8)) throw new n5(e4, "InvalidParameter", r8);
    ...
    return w(r7, t8, (r8, t9, o5) => {
      if (oe(o5, 1, 1, r8, t9), H(o5[0])) {
        if (o5[0].hasField(i4)) {
          ...
          return n4(t10) ? m2.epochToArcadeDate(t10, r8.timeZone ?? "system") : ne(t10) ? t10 : null;
        }
        return null;
      }
      throw new n5(r8, "InvalidParameter", t9);
    });
  };
}
  ...
  _4.ringisclockwise = function(e3, t8) {
    return E4(e3, t8, (n8, a5, s8) => {
      ...
      if (o(s8[0])) for (const i9 of s8[0]) {
        if (!(i9 instanceof _)) throw new n5(e3, "InvalidParameter", t8);
        f7.push(i9.hasZ ? i9.hasM ? [i9.x, i9.y, i9.z, i9.m] : [i9.x, i9.y, i9.z] : [i9.x, i9.y]);
      }
      else if (s8[0] instanceof i3) f7 = s8[0]._elements;
      else {
        if (!te(s8[0])) throw new n5(e3, "InvalidParameter", t8);
        for (const n9 of s8[0].toArray()) {
          if (!(n9 instanceof _)) throw new n5(e3, "InvalidParameter", t8);
    ...
    return E4(e3, t8, (a5, i9, o4) => {
      ...
      if (null !== c5 && false === c5.spatialReference.equals(e3.spatialReference)) throw new n5(e3, "WrongSpatialReference", t8);
      return De(c5);
    });
    ...
    return E4(e3, t8, (a5, i9, o4) => {
      ...
      if (oe(o4, 1, 1, e3, t8), o4[0] instanceof p2) {
        ...
        if (null == t9) return null;
        c5 = t9;
      } else if (o4[0] instanceof m) c5 = u(o4[0].toJSON());
      else {
        const t9 = JSON.parse(o4[0]);
        t9 && !t9.spatialReference && (t9.spatialReference = e3.spatialReference), c5 = je(new m(t9), e3.spatialReference);
      }
      if (null !== c5 && false === c5.spatialReference.equals(e3.spatialReference)) throw new n5(e3, "WrongSpatialReference", t8);
      return De(c5);
    });
    ...
    return E4(e3, t8, (a5, i9, o4) => {
      ...
      else if (o4[0] instanceof m) u4 = u(o4[0].extent?.toJSON());
      ...
      if (null !== u4 && false === u4.spatialReference.equals(e3.spatialReference)) throw new n5(e3, "WrongSpatialReference", t8);
      return De(u4);
    });
    ...
    return E4(e3, t8, (n8, a5, i9) => {
      if (oe(i9, 2, 2, e3, t8), !H(i9[0])) throw new n5(e3, "InvalidParameter", t8);
      if (true === i9[0].immutable) throw new n5(e3, "Immutable", t8);
      if (!(i9[1] instanceof s || null === i9[1])) throw new n5(e3, "InvalidParameter", t8);
      return i9[0]._geometry = i9[1], P2;
    });
  }, _4.feature = function(e3, t8) {
    return E4(e3, t8, (i9, l6, o4) => {
      if (0 === o4.length) throw new n5(e3, "WrongNumberOfParameters", t8);
      let f7;
      if (1 === o4.length) if (e(o4[0])) f7 = I2.fromJson(JSON.parse(o4[0]), e3.timeZone);
      else if (H(o4[0])) f7 = I2.createFromArcadeFeature(o4[0]);
      else if (o4[0] instanceof s) f7 = I2.createFromGraphicLikeObject(o4[0], null, null, e3.timeZone);
      else {
        if (!(o4[0] instanceof p2)) throw new n5(e3, "InvalidParameter", t8);
        {
          ...
          if (K(n8)) l7 = a(n8, e3.spatialReference);
            ...
            if (null != n8 && !U(n8)) throw new n5(e3, "InvalidParameter", t8);
            l7 = n8;
          }
          if (K(i10)) s8 = I2.parseAttributesFromDictionary(i10);
          else {
            if (null != i10) throw new n5(e3, "InvalidParameter", t8);
            s8 = null;
          }
        ...
        if (null !== o4[0]) if (o4[0] instanceof s) i10 = o4[0];
        else {
          if (!(o4[0] instanceof p2)) throw new n5(e3, "InvalidParameter", t8);
          i10 = a(o4[0], e3.spatialReference);
        }
        if (null !== o4[1]) {
          if (!(o4[1] instanceof p2)) throw new n5(e3, "InvalidParameter", t8);
        ...
        for (let n8 = 1; n8 < o4.length; n8 += 2) {
          ...
          if (!(null == i11 || e(i11) || isNaN(i11) || ne(i11) || n4(i11) || ie(i11) || re(i11) || t(i11))) throw new n5(e3, "InvalidParameter", t8);
          if (L(i11) || false === V(i11)) throw new n5(e3, "InvalidParameter", t8);
    ...
    return E4(e3, t8, (a5, i9, l6) => {
      ...
      if (1 === l6.length && e(l6[0])) try {
        ...
        throw new n5(e3, "InvalidParameter", t8);
      }
      if (1 === l6.length && l6[0] instanceof s) try {
      ...
      if (l6.length % 2 != 0) throw new n5(e3, "WrongNumberOfParameters", t8);
      const s8 = /* @__PURE__ */ Object.create(null);
      for (let n8 = 0; n8 < l6.length; n8 += 2) {
        const a6 = ge(l6[n8]), i10 = l6[n8 + 1];
        if (!(null == i10 || e(i10) || isNaN(i10) || ne(i10) || n4(i10) || t(i10) || re(i10) || ie(i10) || o(i10) || te(i10))) throw new n5(e3, "InvalidParameter", t8);
        if (L(i10)) throw new n5(e3, "InvalidParameter", t8);
    ...
    return E4(e3, t8, (n8, a5, i9) => {
      if (i9 = Je(i9), oe(i9, 2, 3, e3, t8), !(i9[0] instanceof _)) throw new n5(e3, "InvalidParameter", t8);
      if (!(i9[1] instanceof _)) throw new n5(e3, "InvalidParameter", t8);
      if (i9.length > 2 && !(i9[2] instanceof _)) throw new n5(e3, "InvalidParameter", t8);
...
function g4(g6, d5) {
  ...
  g6.number = function(r7, n8) {
    ...
    return d5(u4, e3, (u5, e4, o4) => {
      if (oe(o4, 1, 2, u5, e4), o4.length >= 2 && !t(o4[1])) throw new n5(u5, "InvalidParameter", e4);
...
function a4(u4, a5) {
  u4.stdev = function(n8, r7) {
    ...
    return a5(u5, f7, (a6, c5, m6) => {
      ...
      throw new n5(u5, "InvalidParameter", f7);
    });
  };
}
...
var b3 = "°";
function O2(e3) {
  if (false === e(e3)) throw new n5(null, "InvalidParameter", null);
  return e3;
}
function G(e3, n8) {
  const t8 = 10 ** n8;
...
function P6(e3) {
  switch (e3) {
    ...
    case 8:
      return F3;
    default:
      throw new n5(null, "LogicError", null, { reason: "unsupported evaluations" });
  }
}
var j3 = new o2([], [["NORTH", 1], ["NORTH AZIMUTH", 1], ["POLAR", 2], ["QUADRANT", 3], ["SOUTH", 4], ["SOUTH AZIMUTH", 4]]);
function z4(e3) {
  const n8 = j3.lookup(e3);
  if (null == n8) throw new n5(null, "LogicError", null, { reason: "unsupported directionType" });
  return n8;
}
...
function C3(e3) {
  ...
  if (null == n8) throw new n5(null, "LogicError", null, { reason: "unsupported units" });
  return n8;
}
var W2 = class _W {
  ...
  getField(e3) {
    switch (e3) {
      ...
      default:
        throw new n5(null, "LogicError", null, { reason: "unexpected evaluation" });
    }
  }
...
function Y2(e3, n8, r7) {
  if (3 === r7) throw new n5(null, "LogicError", null, { reason: "conversion error" });
  if (3 === n8) {
...
function ne2(e3) {
  ...
  if (n4(n8)) {
    if (isNaN(n8)) throw new n5(null, "LogicError", null, { reason: "invalid conversion" });
    return n8;
  }
  throw new n5(null, "LogicError", null, { reason: "invalid conversion" });
}
function te2(e3, n8, s8) {
  const i9 = 3 === s8;
  let o4 = null, c5 = null, a5 = 0, u4 = 0, l6 = 0;
  if (i9) {
    if (e3.length < 2) throw new n5(null, "LogicError", null, { reason: "conversion error" });
    l6 = 1;
    const n9 = $2(ge(e3[e3.length - 1]));
    if (n9 ? (o4 = n9.first, c5 = n9.second) : (a5 = 1, o4 = ee(ge(e3[0])), c5 = ee(ge(e3[e3.length - 1]))), null === o4 || null === c5) throw new n5(null, "LogicError", null, { reason: "invalid conversion" });
  }
  switch (n8) {
    case 1:
    case 4:
    case 5:
      if (0 === e3.length) throw new n5(null, "LogicError", null, { reason: "invalid conversion" });
...
function he(n8, s8, i9) {
  if (!(s8 instanceof p2)) throw new n5(null, "InvalidParameter", null);
  if (false === s8.hasField("directionType")) throw new n5(null, "LogicError", null, { reason: "missing directionType" });
  if (false === s8.hasField("angleType")) throw new n5(null, "LogicError", null, { reason: "missing angleType" });
  const o4 = z4(O2(s8.field("directiontype"))), c5 = se2(n8, C3(O2(s8.field("angletype"))), o4);
  if (!(i9 instanceof p2)) throw new n5(null, "InvalidParameter", null);
  if (false === i9.hasField("directionType")) throw new n5(null, "LogicError", null, { reason: "missing directionType" });
  if (false === i9.hasField("outputType")) throw new n5(null, "LogicError", null, { reason: "missing angleType" });
  ...
  if (!a5 || !l6) throw new n5(null, "LogicError", null, { reason: "conversion error" });
  if (!(u4 || "TEXT" === l6 && i9.hasField("format"))) throw new n5(null, "LogicError", null, { reason: "invalid unit" });
  switch (l6) {
    case "VALUE":
    ...
    default:
      throw new n5(null, "InvalidParameter", null);
  }
}
...
function B3(n8, o4, i9) {
  if (null !== n8) if (o(n8)) {
    ...
    if (t(n8)) o4.updateUint8Array([true === n8 ? 1 : 0, 113]);
      ...
      if (n4(n8)) return o4.updateFloatArray([n8]), void o4.updateUint8Array([173]);
      if (n8 instanceof t5) throw new n5(i9.context, "UnsupportedHashType", i9.node);
      if (n8 instanceof t4) throw new n5(i9.context, "UnsupportedHashType", i9.node);
      if (!(n8 instanceof p2)) {
        if (H(n8)) throw new n5(i9.context, "UnsupportedHashType", i9.node);
        ...
        if (L(n8)) throw new n5(i9.context, "UnsupportedHashType", i9.node);
        if (B(n8)) throw new n5(i9.context, "UnsupportedHashType", i9.node);
        if (X(n8)) throw new n5(i9.context, "UnsupportedHashType", i9.node);
        if (n8 === P2) throw new n5(i9.context, "UnsupportedHashType", i9.node);
        throw new n5(i9.context, "UnsupportedHashType", i9.node);
      }
...
function E3(e3, m6) {
  e3.portal = function(e4, r7) {
    ...
    return m6(t8, e4, (r7, n8, i9) => {
      oe(i9, 1, 1, t8, e4);
      const s8 = E(i9[0]);
      if ("Unrecognized Type" === s8) throw new n5(t8, "UnrecognizedType", e4);
      return s8;
    });
  ...
  e3.guid = function(t8, e4) {
    ...
    return m6(t8, e4, (r7, n8, i9) => {
      ...
      throw new n5(t8, "InvalidParameter", e4);
    });
    ...
    return m6(t8, e4, (n8, u4, s8) => {
      if (oe(s8, 1, 1, t8, e4), false === e(s8[0])) throw new n5(t8, "InvalidParameter", e4);
    ...
    return m6(t8, e4, (r7, n8, u4) => {
      ...
      if (f7.length <= l6 || l6 < 0) throw new n5(t8, "OutOfBounds", e4);
    ...
    return m6(t8, e4, (r7, n8, o4) => {
      if (o4.length < 1) throw new n5(t8, "WrongNumberOfParameters", e4);
    ...
    return m6(e4, n8, (u4, s8, l6) => {
      ...
      throw new n5(e4, "InvalidParameter", n8);
    });
    ...
    return m6(t8, e4, (t9, e5, r7) => {
      ...
      const [n8] = r7;
      if (null == n8) return "";
      if (!e(n8)) throw new n5(t9, "InvalidParameter", e5);
...
var c4;
async function s7() {
  null == c4 && (c4 = await import("./geodeticDistanceOperator-4CN7URKG.js"), await c4.load());
}
function i8(t8) {
  const n8 = t8.track;
  if (null == n8) throw new n5(t8, "InvalidParameter", null);
  return n8;
}
...
function l5(t8, n8) {
  const e3 = f6(t8, n8);
  if (e3 < 0 || e3 >= t8.observations.length) throw new n5(null, "InvalidParameter", null);
  return e3;
}
function d4(t8, n8) {
...
function b4(r7, c5) {
  r7[r4("TrackIndex")] = function(t8, n8) {
    ...
    return c5(n8, r8, (n9, r9, o4) => (oe(o4, 0, 0, n9, r9), m2.epochToArcadeDate(i8(n9).observations[0].startTime, n9.timeZone ?? "system")));
  }, r7[r4("TrackCurrentTime")] = function(n8, r8) {
    return c5(n8, r8, (n9, r9, o4) => {
      oe(o4, 0, 0, n9, r9);
      const a5 = i8(n9);
      return m2.epochToArcadeDate(a5.observations[a5.currentObservationIndex].startTime, n9.timeZone ?? "system");
    });
...
//# sourceMappingURL=chunk-7Y3366T7.js.map
