...
import {
  K
} from "./chunk-A6TD643C.js";
import {
  z as z2
} from "./chunk-N2UMNEZT.js";
import {
  c as c3,
  n as n3
} from "./chunk-AE44A4VJ.js";
import {
  o as o4
...
var R = class extends g2 {
  constructor(e7, t6) {
    let i5 = t(k(t6));
    t6.instanced && t6.instancedDoublePrecision && (i5 = i5.concat(t(u4(t6)))), super(e7, t6, i5), this.shader = new t3(K, () => import("./DefaultMaterial.glsl-W56XRHX2.js"));
  }
  _makePipeline(e7, t6) {
...
var t5 = class extends R {
  constructor() {
    super(...arguments), this.shader = new t3(z2, () => import("./RealisticTree.glsl-QA44RANF.js"));
  }
};
...
//# sourceMappingURL=chunk-GLXPYA6F.js.map
