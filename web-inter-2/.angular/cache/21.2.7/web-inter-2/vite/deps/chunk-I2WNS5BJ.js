...
__decorate([a3({ type: String, json: { write: true } })], l3.prototype, "label", void 0), __decorate([a3({ type: Number, cast: o3, json: { write: { isRequired: true } } })], l3.prototype, "size", null), __decorate([a3({ type: Number, json: { write: { isRequired: true } } })], l3.prototype, "value", void 0), __decorate([a3({ type: Boolean, json: { write: false } })], l3.prototype, "useMinValue", void 0), __decorate([a3({ type: Boolean, json: { write: false } })], l3.prototype, "useMaxValue", void 0), l3 = o4 = __decorate([c("esri.renderers.visualVariables.support.SizeStop")], l3);

// node_modules/@arcgis/core/renderers/visualVariables/support/VisualVariableLegendOptions.js
var i3 = class extends l(n3) {
  constructor(o5) {
    super(o5), this.showLegend = null, this.title = null;
  }
};
__decorate([a3({ type: Boolean, json: { write: true } })], i3.prototype, "showLegend", void 0), __decorate([a3({ type: String, json: { write: true } })], i3.prototype, "title", void 0), i3 = __decorate([c("esri.renderers.visualVariables.support.VisualVariableLegendOptions")], i3);
var p2 = i3;

// node_modules/@arcgis/core/renderers/visualVariables/VisualVariable.js
var a5 = new o({ colorInfo: "color", transparencyInfo: "opacity", rotationInfo: "rotation", sizeInfo: "size" });
...
__decorate([a3()], u2.prototype, "index", void 0), __decorate([a3({ type: a5.apiValues, readOnly: true, json: { read: a5.read, write: { writer: a5.write, isRequired: true } } })], u2.prototype, "type", void 0), __decorate([a3({ type: String, json: { write: true } })], u2.prototype, "field", void 0), __decorate([m("field")], u2.prototype, "castField", null), __decorate([a3({ type: String, json: { write: true } })], u2.prototype, "valueExpression", void 0), __decorate([a3({ type: String, json: { write: true } })], u2.prototype, "valueExpressionTitle", void 0), __decorate([a3({ readOnly: true })], u2.prototype, "arcadeRequired", null), __decorate([a3({ type: p2, json: { write: true } })], u2.prototype, "legendOptions", void 0), u2 = __decorate([c("esri.renderers.visualVariables.VisualVariable")], u2);
...
var w = new o({ unknown: "unknown", inch: "inches", foot: "feet", yard: "yards", mile: "miles", "nautical-mile": "nautical-miles", millimeter: "millimeters", centimeter: "centimeters", decimeter: "decimeters", meter: "meters", kilometer: "kilometers" });
function v2(e3) {
...
var V = z = class extends u2 {
  ...
  get cache() {
    return { ipData: this._interpolateData(), hasExpression: !!this.valueExpression, compiledFunc: null, isScaleDriven: null != this.valueExpression && f.test(this.valueExpression) };
  }
  set index(e3) {
  ...
  set maxSize(e3) {
    e3 && this.stops && (n2.getLogger(this).warn("cannot set maxSize when stops is not null."), e3 = null), this._set("maxSize", v2(e3));
  }
  readMaxSize(e3, t2, i8) {
    return g(e3, t2, i8);
  }
  writeMaxSize(e3, t2, i8, s7) {
    return f3(e3, t2, i8, s7);
  }
  set minDataValue(e3) {
  ...
  set minSize(e3) {
    e3 && this.stops && (n2.getLogger(this).warn("cannot set minSize when stops is not null."), e3 = null), this._set("minSize", v2(e3));
  }
...
__decorate([a3({ readOnly: true })], V.prototype, "cache", null), __decorate([a3({ type: x3.apiValues, json: { type: x3.jsonValues, origins: { "web-map": { read: false } }, read: x3.read, write: x3.write } })], V.prototype, "axis", void 0), __decorate([a3()], V.prototype, "index", null), __decorate([a3({ type: String, readOnly: true })], V.prototype, "inputValueType", null), __decorate([a3({ type: i4, json: { write: true } })], V.prototype, "legendOptions", void 0), __decorate([a3({ type: Number, value: null, json: { write: true } })], V.prototype, "maxDataValue", null), __decorate([a3({ type: Number, useTypeForAutocast: false, value: null, json: { write: true } })], V.prototype, "maxSize", null), __decorate([o2("maxSize")], V.prototype, "readMaxSize", null), __decorate([r("maxSize")], V.prototype, "writeMaxSize", null), __decorate([a3({ type: Number, value: null, json: { write: true } })], V.prototype, "minDataValue", null), __decorate([a3({ type: Number, useTypeForAutocast: false, value: null, json: { write: true } })], V.prototype, "minSize", null), __decorate([o2("minSize")], V.prototype, "readMinSize", null), __decorate([r("minSize")], V.prototype, "writeMinSize", null), __decorate([a3({ type: String, json: { write: true } })], V.prototype, "normalizationField", void 0), __decorate([a3({ readOnly: true })], V.prototype, "arcadeRequired", null), __decorate([a3({ type: String })], V.prototype, "scaleBy", void 0), __decorate([a3({ type: [l3], value: null, json: { write: true } })], V.prototype, "stops", null), __decorate([a3({ type: ["outline"], json: { write: true } })], V.prototype, "target", void 0), __decorate([a3({ type: String, readOnly: true })], V.prototype, "transformationType", null), __decorate([a3({ type: ["size"], json: { type: ["sizeInfo"] } })], V.prototype, "type", void 0), __decorate([a3({ type: Boolean, json: { write: true, origins: { "web-map": { read: false } } } })], V.prototype, "useSymbolValue", void 0), __decorate([a3({ type: String, json: { write: true } })], V.prototype, "valueExpression", void 0), __decorate([o2("valueExpression", ["valueExpression", "expression"])], V.prototype, "readValueExpression", null), __decorate([r("web-scene", "valueExpression")], V.prototype, "writeValueExpressionWebScene", null), __decorate([a3({ type: ["radius", "diameter", "area", "width", "distance"], json: { write: true } })], V.prototype, "valueRepresentation", void 0), __decorate([a3({ type: w.apiValues, json: { write: w.write, origins: { "web-map": { read: false }, "web-scene": { write: true }, "portal-item": { write: true } } } })], V.prototype, "valueUnit", void 0), __decorate([o2("valueUnit")], V.prototype, "readValueUnit", null), V = z = __decorate([c("esri.renderers.visualVariables.SizeVariable")], V);

// node_modules/@arcgis/core/renderers/support/AuthoringInfoClassBreakInfo.js
var s4;
var a6 = s4 = class extends n3 {
  constructor(e3) {
...
__decorate([a3({ type: Number, json: { write: true } })], a6.prototype, "minValue", void 0), __decorate([a3({ type: Number, json: { write: true } })], a6.prototype, "maxValue", void 0), a6 = s4 = __decorate([c("esri.renderers.support.AuthoringInfoClassBreakInfo")], a6);
var i5 = a6;

// node_modules/@arcgis/core/renderers/support/AuthoringInfoFieldInfo.js
var n7;
var l4 = n7 = class extends n3 {
  constructor(o5) {
...
__decorate([a3({ type: String, json: { write: true } })], l4.prototype, "field", void 0), __decorate([a3({ type: String, json: { write: true } })], l4.prototype, "normalizationField", void 0), __decorate([a3({ type: String, json: { write: true } })], l4.prototype, "label", void 0), __decorate([a3({ type: [i5], json: { write: true } })], l4.prototype, "classBreakInfos", void 0), l4 = n7 = __decorate([c("esri.renderers.support.AuthoringInfoFieldInfo")], l4);
var a7 = l4;

// node_modules/@arcgis/core/renderers/support/AuthoringInfoSizeStop.js
var s5;
var i6 = s5 = class extends n3 {
  constructor(e3) {
...
__decorate([a3({ type: String, json: { write: true } })], i6.prototype, "label", void 0), __decorate([a3({ type: Number, json: { write: true } })], i6.prototype, "size", void 0), __decorate([a3({ type: Number, json: { write: true } })], i6.prototype, "value", void 0), i6 = s5 = __decorate([c("esri.renderers.support.AuthoringInfoSizeStop")], i6);
var l5 = i6;

// node_modules/@arcgis/core/renderers/support/AuthoringInfoVisualVariable.js
var p3;
var a8 = new o({ percentTotal: "percent-of-total", ratio: "ratio", percent: "percent" });
...
var f4 = p3 = class extends n3 {
  ...
  clone() {
    return new p3({ endTime: this.endTime, field: this.field, maxSliderValue: this.maxSliderValue, minSliderValue: this.minSliderValue, normalizationField: this.normalizationField, referenceSizeScale: this.referenceSizeScale, referenceSizeSymbolStyle: this.referenceSizeSymbolStyle, spikeSymbolStyle: this.spikeSymbolStyle, sizeStops: a(this.sizeStops), startTime: this.startTime, style: this.style, theme: this.theme, type: this.type, units: this.units });
  }
};
__decorate([a3({ types: y, json: { write: true } })], f4.prototype, "endTime", void 0), __decorate([s2("endTime")], f4.prototype, "castEndTime", null), __decorate([a3({ type: String, json: { write: true } })], f4.prototype, "field", void 0), __decorate([a3({ type: Number, json: { write: true } })], f4.prototype, "maxSliderValue", void 0), __decorate([a3({ type: Number, json: { write: true } })], f4.prototype, "minSliderValue", void 0), __decorate([a3({ type: String, json: { origins: { "web-scene": { write: false } }, write: true } })], f4.prototype, "normalizationField", null), __decorate([a3({ type: Number, value: null, json: { origins: { "web-scene": { write: false } }, write: true } })], f4.prototype, "referenceSizeScale", null), __decorate([a3({ type: h, value: null, json: { origins: { "web-scene": { write: false } }, write: true } })], f4.prototype, "referenceSizeSymbolStyle", null), __decorate([a3({ type: d, value: null, json: { origins: { "web-scene": { write: false } }, write: true } })], f4.prototype, "spikeSymbolStyle", null), __decorate([a3({ types: y, json: { write: true } })], f4.prototype, "startTime", void 0), __decorate([s2("startTime")], f4.prototype, "castStartTime", null), __decorate([a3({ type: [l5], json: { origins: { "web-scene": { write: false } }, write: true } })], f4.prototype, "sizeStops", null), __decorate([a3({ type: a8.apiValues, value: null, json: { type: a8.jsonValues, read: a8.read, write: a8.write } })], f4.prototype, "style", null), __decorate([a3({ type: S, value: null, json: { type: S, origins: { "web-scene": { type: m3, write: { writer: (e3, t2) => {
  m3.includes(e3) && (t2.theme = e3);
} } } }, write: true } })], f4.prototype, "theme", null), __decorate([a3({ type: u3.apiValues, json: { type: u3.jsonValues, read: u3.read, write: u3.write } })], f4.prototype, "type", void 0), __decorate([a3({ type: c2, json: { type: c2, write: true } })], f4.prototype, "units", void 0), f4 = p3 = __decorate([c("esri.renderers.support.AuthoringInfoVisualVariable")], f4);
var g2 = f4;
...
var f5 = ["high-to-low", "above-and-below", "above", "below"];
var v3 = ["flow-line", "wave-front"];
var w2 = ["caret", "circle-caret", "arrow", "circle-arrow", "plus-minus", "circle-plus-minus", "square", "circle", "triangle", "happy-sad", "thumb", "custom"];
...
__decorate([a3({ type: b2, json: { write: true } })], a9.prototype, "authoringInfo", void 0), __decorate([a3({ type: n8.apiValues, readOnly: true, json: { type: n8.jsonValues, read: false, write: { writer: n8.write, ignoreOrigin: true, isRequired: true } } })], a9.prototype, "type", void 0), a9 = __decorate([c("esri.renderers.Renderer")], a9);

// node_modules/@arcgis/core/renderers/visualVariables/ColorVariable.js
var i7;
var l6 = i7 = class extends u2 {
  constructor(t2) {
...
var v4 = { base: u2, key: "type", typeMap: { opacity: a10, color: l6, rotation: s6, size: V } };
var m5 = (t2) => {
  const l8 = t2;
...
var y5 = { types: D2, json: { write: { writer: s3 }, origins: { "web-scene": { types: F, write: { writer: s3 }, read: { reader: s({ types: F }) } } } } };
var m6 = n({ json: { origins: { "web-scene": { write: { isRequired: true } } } } }, y5);
var n9 = { types: { base: n5, key: "type", typeMap: { "simple-fill": x.typeMap["simple-fill"], "picture-fill": x.typeMap["picture-fill"], "polygon-3d": x.typeMap["polygon-3d"], cim: x.typeMap.cim } }, json: { write: { writer: s3 }, origins: { "web-scene": { type: f2, write: { writer: s3 } } } } };
...
//# sourceMappingURL=chunk-I2WNS5BJ.js.map
