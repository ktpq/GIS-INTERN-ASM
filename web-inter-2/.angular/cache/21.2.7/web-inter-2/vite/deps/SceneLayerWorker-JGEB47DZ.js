...
async function g(e) {
  ...
  let y2;
  const [{ projectBuffer: h3 }, { initializeProjection: d3 }] = await Promise.all([import("./projectBuffer-TWQF2CE7.js"), import("./projectionUtils-5J2QPYBP.js")]);
  await d3(l, u2);
  const g2 = [0, 0, 0];
  ...
  if ("georeferenced" === c2.type && null == c2.origin) {
    ...
    const e2 = "georeferenced" === c2.type ? c.fromJSON(c2) : i.fromJSON(c2), { projectMeshVertexPositions: r } = await import("./projectMeshVertexPositions-UREIU4TZ.js"), t = r({ vertexAttributes: { position: f2 }, transform: m2 ? { localMatrix: m2 } : void 0, vertexSpace: e2, spatialReference: l }, u2);
...
//# sourceMappingURL=SceneLayerWorker-JGEB47DZ.js.map
