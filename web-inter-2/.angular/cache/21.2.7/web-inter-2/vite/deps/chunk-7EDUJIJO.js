...
var S = class extends b {
  ...
  async featureSetFromJSON(e, t, r2) {
    ...
    const { meshFeatureSetFromJSON: s } = await p(import("./meshFeatureSet-4EFU4F2G.js"), r2);
  ...
  async executeRelationshipQuery(e, t) {
    const [{ default: r2 }, { executeRelationshipQuery: s }] = await p(Promise.all([import("./RelationshipQuery-MV7CPICL.js"), import("./executeRelationshipQuery-5OMP7SLZ.js")]), t);
    let i2 = r2.from(e);
  ...
  async executeRelationshipQueryForCount(e, t) {
    const [{ default: r2 }, { executeRelationshipQueryForCount: s }] = await p(Promise.all([import("./RelationshipQuery-MV7CPICL.js"), import("./executeRelationshipQuery-5OMP7SLZ.js")]), t);
    let i2 = r2.from(e);
    return (this.gdbVersion || this.dynamicDataSource) && (i2 = i2.clone(), i2.gdbVersion = i2.gdbVersion || this.gdbVersion, i2.dynamicDataSource = i2.dynamicDataSource || this.dynamicDataSource), s(this.url, i2, t);
  }
  async executeAttachmentQuery(e, t) {
    const { executeAttachmentQuery: r2, fetchAttachments: s, processAttachmentQueryResult: i2 } = await p(import("./queryAttachments-G7Q65S4P.js"), t), u = f(this.url);
    return i2(u, await (this.queryAttachmentsSupported ? r2(u, e, t) : s(u, e, t)));
  }
  async executeAttributeBinsQuery(e, t) {
    const { executeAttributeBinsQuery: r2 } = await p(import("./executeAttributeBinsQuery-HSO62EKO.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executePivotQuery(e, t) {
    const { executePivotQuery: r2 } = await p(import("./executePivotQuery-HBOFWFFG.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeTopFeaturesQuery(e, t) {
    const { executeTopFeaturesQuery: r2 } = await p(import("./executeTopFeaturesQuery-N4LEGYJI.js"), t);
    return r2(this.parsedUrl, e, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e, t) {
    const { executeForTopIds: r2 } = await p(import("./executeForTopIds-MVCMOCNK.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopExtents(e, t) {
    const { executeForTopExtents: r2 } = await p(import("./executeForTopExtents-NYL4EXMX.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopCount(e, t) {
    const { executeForTopCount: r2 } = await p(import("./executeForTopCount-G5AFIQYA.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  _normalizeQuery(e) {
    let t = R.from(e);
...
//# sourceMappingURL=chunk-7EDUJIJO.js.map
