...
var p2 = class extends n2 {
  constructor(t10) {
    super(t10), this.extent = null, this.height = null, this.href = null, this.opacity = 1, this.rotation = 0, this.scale = null, this.visible = true, this.width = null;
  }
};
__decorate([a({ type: z })], p2.prototype, "extent", void 0), __decorate([a()], p2.prototype, "height", void 0), __decorate([a()], p2.prototype, "href", void 0), __decorate([a()], p2.prototype, "opacity", void 0), __decorate([a()], p2.prototype, "rotation", void 0), __decorate([a()], p2.prototype, "scale", void 0), __decorate([a()], p2.prototype, "visible", void 0), __decorate([a()], p2.prototype, "width", void 0), p2 = __decorate([c("esri.layers.support.MapImage")], p2);
...
__decorate([a({ json: { write: true } })], i4.prototype, "area", void 0), __decorate([r2(s4)], i4.prototype, "units", void 0), i4 = __decorate([c("esri.rest.support.ArealUnit")], i4);
...
__decorate([a({ json: { write: true } })], p3.prototype, "distance", void 0), __decorate([r2(t2)], p3.prototype, "units", void 0), p3 = __decorate([c("esri.rest.support.LinearUnit")], p3);
  ...
  switch (e8) {
    ...
    case "feature-record-set-layer":
      ...
      if ("layerDefinition" in t10) {
        const e9 = new (0, (await import("./@arcgis_core_layers_FeatureLayer.js")).default)(), { layerDefinition: a7, featureSet: o14 } = t10;
...
var g3 = class extends n2 {
  ...
  async fetchResultMapImageLayer() {
    ...
    return new (0, (await import("./MapImageLayer-PFZSMYAF.js")).default)({ url: o14 });
  }
...
async function o6(s30) {
  if (s30) {
    const { default: s31 } = await import("./arcgis-knowledge-client-core-simd-IF7YHJFI.js").then((e8) => e8.a);
    return s31({ locateFile: (s32) => n3(t6 + s32) });
  }
  const { default: r9 } = await import("./arcgis-knowledge-client-core-Q445CQHR.js").then((e8) => e8.a);
...
function u3(t10, i9) {
  if (t10 instanceof m2) return g4(t10, i9);
...
function w4(e8, t10, n9) {
  ...
  return new s5({ path: s30 });
}
function b3(e8, t10, n9) {
  const r9 = e8.type_name, o14 = j4(e8, t10, n9);
  return new s6(Object.assign({ typeName: r9, id: e8.get_id(), originId: e8.get_origin_entity_id(), destinationId: e8.get_destination_entity_id() }, o14));
}
function O4(e8) {
  const n9 = [];
...
//# sourceMappingURL=chunk-ABKQDIW4.js.map
