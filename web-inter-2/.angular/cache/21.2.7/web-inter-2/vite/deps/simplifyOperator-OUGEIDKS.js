import {
  ...
  t,
  u
} from "./chunk-HSACVHS7.js";
import {
  Qe,
  Xe,
  Ye
} from "./chunk-EFCG7PCZ.js";
...
function p(t2) {
  const r = Ye(t2), c = r.getSpatialReference();
  return Qe(t(r.getGeometry(), c, false), c);
}
function a(e) {
  const [r, o2] = Xe(e);
  return u(r, o2, false).map((e2) => Qe(e2, o2));
}
function i(e) {
  const t2 = Ye(e);
  return o(t2.getGeometry(), t2.getSpatialReference(), false);
}
export {
  p as execute,
  a as executeMany,
...
//# sourceMappingURL=simplifyOperator-OUGEIDKS.js.map
