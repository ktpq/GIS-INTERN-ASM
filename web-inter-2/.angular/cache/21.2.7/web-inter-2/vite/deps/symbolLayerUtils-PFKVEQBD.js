...
async function f2(e2, o = null) {
  if (!e2.isPrimitive) {
    ...
    const s = c2.get(o2);
    if (null != s) return s;
    const { fetch: n2 } = await import("./objectResourceUtils-EDQNP73B.js"), a3 = await n2(o2, { disableTextures: true, spherical: true }), u2 = z(a3.referenceBoundingBox, n());
...
//# sourceMappingURL=symbolLayerUtils-PFKVEQBD.js.map
