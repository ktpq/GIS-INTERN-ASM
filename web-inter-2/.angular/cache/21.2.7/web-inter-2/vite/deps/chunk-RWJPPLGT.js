...
function a3(e8) {
  return { type: g, nonNullable: e8?.nonNullable, json: { type: [D2], default: null, read: { source: ["color", "transparency"], reader: s3 }, write: { target: { color: { type: [D2], isRequired: e8?.colorRequiredOnWrite }, transparency: { type: D2 } }, writer: c4 } } };
}
...
__decorate([a2(a3({ colorRequiredOnWrite: true }))], c7.prototype, "color", void 0), __decorate([a2(__spreadProps(__spreadValues({}, i5), { json: { write: { isRequired: true } } }))], c7.prototype, "size", null), __decorate([a2(o5)], c7.prototype, "pattern", void 0), __decorate([a2({ type: u, json: { default: "butt", write: { overridePolicy() {
...
var d3 = l8 = class extends n2 {
  ...
  writeHref(r6, e8, t6, p20) {
    r6 && (tt(r6) ? e8.dataURI = r6 : (e8.href = m(r6, p20), Y(e8.href) && (e8.href = K(e8.href))));
  }
  clone() {
...
__decorate([a2({ type: p8, json: { write: true } })], j3.prototype, "material", void 0), __decorate([r({ Line: "line" }, { readOnly: true })], j3.prototype, "type", void 0), __decorate([a2({ type: l3, json: { write: true, default: "miter" } })], j3.prototype, "join", void 0), __decorate([a2({ type: u, json: { write: true, default: "butt" } })], j3.prototype, "cap", void 0), __decorate([a2(__spreadProps(__spreadValues({}, i5), { json: { write: { isRequired: true } } }))], j3.prototype, "size", null), __decorate([a2(o5)], j3.prototype, "pattern", void 0), __decorate([a2()], j3.prototype, "imagePattern", void 0), __decorate([a2({ types: { key: "type", base: c8, typeMap: { style: c8 } }, json: { write: true } })], j3.prototype, "marker", void 0), j3 = h4 = __decorate([c("esri.symbols.LineSymbol3DLayer")], j3);
...
__decorate([a2({ type: p8, json: { write: true } })], n13.prototype, "material", void 0), __decorate([a2({ type: Boolean, nonNullable: true, json: { write: true, default: true } })], n13.prototype, "castShadows", void 0), __decorate([r({ Path: "path" }, { readOnly: true })], n13.prototype, "type", void 0), __decorate([a2({ type: ["circle", "quad"], nonNullable: true, json: { write: true, default: "circle" } })], n13.prototype, "profile", void 0), __decorate([a2({ type: l3, nonNullable: true, json: { write: true, default: "miter" } })], n13.prototype, "join", void 0), __decorate([a2({ type: i2, nonNullable: true, json: { write: true, default: "butt" } })], n13.prototype, "cap", void 0), __decorate([a2({ type: Number, json: { write: { enabled: true, target: { width: { type: Number }, size: { type: Number } } } } })], n13.prototype, "width", void 0), __decorate([o("width", ["width", "size", "height"])], n13.prototype, "readWidth", null), __decorate([a2({ type: Number, json: { write: true } })], n13.prototype, "height", void 0), __decorate([o("height", ["height", "size", "width"])], n13.prototype, "readHeight", null), __decorate([a2({ type: ["center", "bottom", "top"], nonNullable: true, json: { write: true, default: "center" } })], n13.prototype, "anchor", void 0), __decorate([a2({ type: ["heading", "all"], nonNullable: true, json: { write: true, default: "all" } })], n13.prototype, "profileRotation", void 0), n13 = h5 = __decorate([c("esri.symbols.PathSymbol3DLayer")], n13);
...
var c11 = m11 = class extends n5 {
  ...
  async _fetchSymbol(t6) {
    ...
    const { resolveWebStyleSymbol: s7 } = await import("./webStyleSymbolUtils-TSTL5YVL.js");
    s(t6);
...
var x2 = { base: n5, key: "type", typeMap: { "simple-fill": m5, "picture-fill": f3, "picture-marker": c3, "simple-line": d, "simple-marker": u2, text: u3, "label-3d": f2, "line-3d": b5, "mesh-3d": n15, "point-3d": w2, "polygon-3d": f4, "web-style": c11, cim: m6 }, errorContext: "symbol" };
var M2 = { base: n5, key: "type", typeMap: { "picture-marker": c3, "simple-marker": u2, "point-3d": w2, cim: m6 }, errorContext: "symbol" };
var C2 = { base: n5, key: "type", typeMap: { "simple-line": d, "line-3d": b5, cim: m6 }, errorContext: "symbol" };
var h7 = { base: n5, key: "type", typeMap: { "simple-fill": m5, "picture-fill": f3, "polygon-3d": f4, cim: m6 }, errorContext: "symbol" };
var g5 = { base: n5, key: "type", typeMap: { "picture-marker": c3, "simple-marker": u2, text: u3, "web-style": c11, cim: m6 }, errorContext: "symbol" };
var w3 = s2({ types: x2 });
var D3 = { base: n5, key: "type", typeMap: { "simple-fill": m5, "picture-fill": f3, "picture-marker": c3, "simple-line": d, "simple-marker": u2, text: u3, "line-3d": b5, "mesh-3d": n15, "point-3d": w2, "polygon-3d": f4, "web-style": c11, cim: m6 }, errorContext: "symbol" };
var P = { base: n5, key: "type", typeMap: { text: u3, "label-3d": f2 }, errorContext: "symbol" };
...
//# sourceMappingURL=chunk-RWJPPLGT.js.map
