...
function de(e4, t4, r4) {
  ...
  if (e4 === P) {
    ...
    if (e2(t4)) return me(e4, Se(t4), r4);
    if (ne(t4)) return me(e4, t4.toNumber(), r4);
    if (ie(t4)) return me(e4, t4.toNumber(), r4);
    if (re(t4)) return me(e4, t4.toNumber(), r4);
  } else if (e2(e4)) {
    if (e2(t4)) return me(ge(e4), ge(t4), r4);
    ...
    if (ne(t4)) return e4.timeZone !== t4.timeZone && (e4.isUnknownTimeZone ? e4 = m2.arcadeDateAndZoneToArcadeDate(e4, t4.timeZone) : t4.isUnknownTimeZone && (t4 = m2.arcadeDateAndZoneToArcadeDate(t4, e4.timeZone))), me(e4.toNumber(), t4.toNumber(), r4);
    if (null === t4 || t4 === P) return me(e4.toNumber(), 0, r4);
    if (n(t4)) return me(e4.toNumber(), t4, r4);
    if (t(t4)) return me(e4.toNumber(), Se(t4), r4);
    if (e2(t4)) return me(e4.toNumber(), Se(t4), r4);
    ...
    if (re(t4)) return me(Se(e4), t4.toNumber(), r4);
    if (null === t4 || t4 === P) return me(Se(e4), 0, r4);
    if (e2(t4)) return me(Se(e4), Se(t4), r4);
  } else if (re(e4)) {
...
function pe(e4, { useNumbersForDates: t4 }) {
  ...
  for (const r4 in e4) {
    "" !== n4 && (n4 += ",");
    const i5 = e4[r4];
    null == i5 ? n4 += JSON.stringify(r4) + ":null" : t(i5) || n(i5) || e2(i5) ? n4 += JSON.stringify(r4) + ":" + JSON.stringify(i5) : U(i5) ? n4 += JSON.stringify(r4) + ":" + be(i5) : ie(i5) || re(i5) ? n4 += `${JSON.stringify(r4)}:${JSON.stringify(i5.toString())}` : te(i5) || Array.isArray(i5) ? n4 += JSON.stringify(r4) + ":" + be(i5, null, t4) : ne(i5) ? n4 += t4 ? JSON.stringify(r4) + ":" + JSON.stringify(i5.getTime()) : JSON.stringify(r4) + ":" + i5.stringify() : null !== i5 && "object" == typeof i5 && "castToText" in i5 && (n4 += JSON.stringify(r4) + ":" + i5.castToText(t4));
  }
  return "{" + n4 + "}";
}
function ge(e4, t4) {
...
function Se(e4, t4) {
  return n(e4) ? e4 : null === e4 || "" === e4 ? 0 : ne(e4) || re(e4) || ie(e4) ? NaN : t(e4) ? e4 ? 1 : 0 : o(e4) || "" === e4 || void 0 === e4 ? NaN : void 0 !== t4 && e2(e4) ? (t4 = Y(t4, "‰", ""), t4 = Y(t4, "¤", ""), p(e4, { pattern: t4 })) : e4 === P ? 0 : Number(e4);
}
function Ze(e4, t4) {
  if (ne(e4)) return e4;
  if (e2(e4)) {
...
function Pe(e4, t4) {
  if (o(e4) || te(e4)) {
    ...
    return 0 === i5.length ? null : new m({ points: i5, spatialReference: a, hasZ: n4, hasM: r4 });
  }
  return e4;
}
...
function Xe(r4, i5) {
  ...
  return "system" === r4 && (r4 = a), { version: et, engineVersion: e, timeZone: r4, userTimeZone: a, spatialReference: i5 instanceof S ? i5.toJSON() : i5, application: s.applicationName ?? "", engine: "web", locale: i() };
}
var et = "1.35";
...
//# sourceMappingURL=chunk-PNSNEWSP.js.map
