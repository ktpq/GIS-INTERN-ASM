...
var P2 = class extends b {
  ...
  _updatePointSymbology(e4) {
    ...
    r3 && "getSymbolAsync" in r3 ? r3.getSymbolAsync(e4).then(async (i3) => {
      ...
      n4 && (S2 || (S2 = (await import("./visualVariableUtils-726SJIZ6.js")).getSize), l3 = S2(n4, e4, { view: o5.type, scale: o5.scale, shape: "simple-marker" === i3.type ? i3.style : null })), l3 ||= "width" in i3 && "height" in i3 && null != i3.width && null != i3.height ? Math.max(i3.width, i3.height) : "size" in i3 ? i3.size : 16, s4?.includes(e4) && (this._setGraphicSymbol(e4, new u4({ style: "square", size: l3, color: new g([255, 255, 255, 1 / 255]), xoffset: "xoffset" in i3 ? i3.xoffset : 0, yoffset: "yoffset" in i3 ? i3.yoffset : 0 })), a6(e4));
    }) : a6(e4);
  }
  get _updateContext() {
...
//# sourceMappingURL=chunk-SQOSFQN7.js.map
