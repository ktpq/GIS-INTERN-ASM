...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (u(e2)) {
      case "CatalogLayer":
        r2.push(import("./CatalogLayer-JS4BIJUU.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r2.push(import("./@arcgis_core_layers_FeatureLayer.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r2.push(import("./OrientedImageryLayer-OEWI6XSK.js").then((e3) => e3.default));
    }
  });
...
//# sourceMappingURL=featureLayerUtils-VFSXD66B.js.map
