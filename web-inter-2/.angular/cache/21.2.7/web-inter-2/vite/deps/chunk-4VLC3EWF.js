...
var h = (h3) => {
  ...
  let v = class extends b {
    ...
    async fetchSublayerInfo(e5, r5) {
      ...
      if ("data-layer" === s9.type) {
        ...
        if (i5 && e5.originIdOf("url") > 2) try {
          const e6 = await this._fetchAllLayersAndTablesFromService(i5), t3 = m(i5)?.sublayer ?? s9.mapLayerId, r6 = structuredClone(e6.get(t3));
          if (null != r6) {
    ...
    async _fetchAllLayersAndTablesFromService(e5, a4) {
      ...
      const l5 = m(e5), p4 = e(this._allLayersAndTablesMap, l5?.url.path, () => f(V(l5?.url.path, "/layers"), { query: __spreadProps(__spreadValues({ f: "json" }, this.customParameters), { token: this.apiKey }) }).then(async (e6) => {
...
function ee(e5, r5, t2) {
  ...
  return !!i5 && e5.originIdOf(r5) >= r2(i5);
}
...
var S4 = (S5) => {
  ...
  let v = class extends m6 {
    ...
    readSublayers(e5, r5) {
      if (!r5 || !e5) return;
      const { sublayersSourceJSON: s9 } = this, t2 = r2(r5.origin);
      if (t2 < 2) return;
    ...
    createSublayersForOrigin(e5) {
      let r5;
      const s9 = r2("web-document" === e5 ? "web-map" : e5);
...
//# sourceMappingURL=chunk-4VLC3EWF.js.map
