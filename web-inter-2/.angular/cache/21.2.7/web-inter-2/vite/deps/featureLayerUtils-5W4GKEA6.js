...
import {
  n,
  u
} from "./chunk-GMX33354.js";
import "./chunk-ACKD7YCS.js";
...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (u(e2)) {
      case "CatalogLayer":
        r2.push(import("./CatalogLayer-36YUMBC5.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r2.push(import("./FeatureLayer-PQRJU5VR.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r2.push(import("./OrientedImageryLayer-P5IRE7OF.js").then((e3) => e3.default));
    }
  });
...
//# sourceMappingURL=featureLayerUtils-5W4GKEA6.js.map
