import {
  s as s2
} from "./chunk-CXXJKDFD.js";
import {
  G
} from "./chunk-46ULTMCK.js";
import {
  E as E2,
  _ as _3,
  c as c4,
...
var T2 = class extends O {
  constructor(e4, t3) {
    super(e4, t3), this.displayType = "auto", this.messages = null, this.messagesUnits = null, this.selectedFile = null, this.submitting = false, this.viewModel = null, this.visibleElements = __spreadValues({}, F), this._supportsImageOrientation = $ && $.supports && $.supports("image-orientation", "from-image"), this._addAttachmentForm = null, this._updateAttachmentForm = null, e4?.suppressDeprecationWarning || (this.announceDeprecation = () => {
      i2(n.getLogger("esri.widgets.Attachments"), "esri.widgets.Attachments", { replacement: "Use the Popup and Editor components to view and edit attachments respectively.", version: "5.0", see: "https://www.esriurl.com/components-transition-plan/", warnOnce: true });
    });
  }
  ...
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-VXSOFU5M.js") });
  }
  get capabilities() {
...
function r5(r6, t3) {
  ...
  if (!n6) return t3;
  const i5 = t3.match(n6.pattern), l4 = i5?.[2], o2 = r(r(n6.label, { messages: r6, hierPart: l4 }), { appName: n6.appName }), m4 = n6.target ? ` target="${n6.target}"` : "", g3 = "_blank" === n6.target ? ' rel="noreferrer"' : "";
...
var T3 = class extends O {
  constructor(e4, t3) {
    super(e4, t3), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new v2(), this.messages = null, this._disposeChart = (e5) => {
      ...
      if (t4 || !i5 || !e5) return;
      const { createRoot: a3 } = await import("./chartUtilsAm5-MGKEZS2O.js"), r6 = await a3(e5);
  ...
  async _getSeriesColors(e4) {
    const { colorAm5: t3 } = await import("./chartCommon-3F573QR3.js"), i5 = /* @__PURE__ */ new Map();
    return e4.forEach((e5) => {
      e5.color && i5.set(e5, t3(e5.color.toCss(true)));
    }), i5;
  }
  async _getRendererColors() {
    const { colorAm5: e4 } = await import("./chartCommon-3F573QR3.js"), t3 = /* @__PURE__ */ new Map(), i5 = this._getRenderer(), a3 = "default";
    if (!i5) return t3;
  ...
  async _renderChart(e4) {
    const { root: t3, mediaInfo: i5 } = e4, { value: a3, type: r6 } = i5, { ResponsiveThemeAm5: o2, DarkThemeAm5: s3, AnimatedThemeAm5: n6, ColorSetAm5: d2, ThemeAm5: m4, esriChartColorSet: c6 } = await import("./chartCommon-3F573QR3.js"), h6 = m4.new(t3);
  ...
  async _customizeChartTooltip(e4, t3 = "horizontal") {
    const { colorAm5: i5 } = await import("./chartCommon-3F573QR3.js");
  ...
  async _createPieChart(e4, t3) {
    const { TooltipAm5: i5 } = await import("./chartCommon-3F573QR3.js"), { PieChartAm5: a3, PieSeriesAm5: r6 } = await import("./pieChart-UV6JQL72.js"), { mediaInfo: o2, root: s3 } = e4, { title: n6 } = o2, l4 = 5, d2 = o2?.altText || o2?.title || "", m4 = s3.container.children.push(a3.new(s3, { ariaLabel: d2, focusable: true, paddingBottom: l4, paddingTop: l4, paddingLeft: l4, paddingRight: l4 })), c6 = "{category}: {valuePercentTotal.formatNumber('0.00')}%\n ({value})", h6 = i5.new(s3, { labelText: c6 }), p6 = m4.series.push(r6.new(s3, { name: n6, valueField: A, categoryField: w2, tooltip: h6 }));
  ...
  async _createColumnChart(e4, t3, i5) {
    const { TooltipAm5: a3, ScrollbarAm5: r6 } = await import("./chartCommon-3F573QR3.js"), { CategoryAxisAm5: o2, AxisRendererXAm5: s3, ValueAxisAm5: n6, AxisRendererYAm5: l4, ColumnSeriesAm5: d2 } = await import("./xyChart-LIAYYLK3.js"), { mediaInfo: m4, root: c6 } = t3, { value: h6, title: p6 } = m4;
  ...
  async _createLineChart(e4, t3, i5) {
    const { TooltipAm5: a3, ScrollbarAm5: r6 } = await import("./chartCommon-3F573QR3.js"), { CategoryAxisAm5: o2, AxisRendererXAm5: s3, ValueAxisAm5: n6, AxisRendererYAm5: l4, LineSeriesAm5: d2 } = await import("./xyChart-LIAYYLK3.js"), { root: m4, mediaInfo: c6 } = t3, { value: h6, title: p6 } = c6;
    e4.setAll({ wheelX: "panX", wheelY: "zoomX" });
...
var g = class extends O {
  ...
  loadDependencies() {
    return c3({ loader: () => import("./calcite-loader-3HRSMTEQ.js") });
  }
  destroy() {
...
var M2 = b2 = class extends O {
  ...
  loadDependencies() {
    return c3({ chip: () => import("./calcite-chip-EGCKSNNT.js"), icon: () => import("./calcite-icon-VXSOFU5M.js"), list: () => import("./calcite-list-XUAYDLHX.js"), "list-item": () => import("./calcite-list-item-JQOX4GB5.js"), loader: () => import("./calcite-loader-3HRSMTEQ.js"), notice: () => import("./calcite-notice-R5JZWVKU.js") });
  }
  destroy() {
  ...
  async _selectRecord(e4) {
    ...
    const { default: i5 } = await import("./Feature-O4YPIFVX.js");
  ...
  _renderRelatedFeature(e4) {
    ...
    return x("calcite-list-item", { class: this.classes(F2.listItem, { [F2.listItemHidden]: i5 }), description: i(e4.description ?? ""), key: e4.uid, label: i(s3), onCalciteListItemSelect: () => this._selectRecord(e4) }, this._renderChevronIconNode());
  }
...
var g2 = class extends O {
  ...
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-VXSOFU5M.js"), list: () => import("./calcite-list-XUAYDLHX.js"), "list-item": () => import("./calcite-list-item-JQOX4GB5.js"), loader: () => import("./calcite-loader-3HRSMTEQ.js"), notice: () => import("./calcite-notice-R5JZWVKU.js") });
  }
  destroy() {
  ...
  _renderAssociationType(e4) {
    ...
    return x("calcite-list-item", { description: i(e4.description), key: `association-type-${e4.type}`, label: i(i5), value: e4.type, onCalciteListItemSelect: () => this.onSelectAssociationType({ viewModel: t3, listType: e4, title: i5 }) }, x("calcite-icon", { flipRtl: true, icon: "chevron-right", scale: "s", slot: "content-end" }));
  }
...
var k2 = class extends d(O) {
  ...
  loadDependencies() {
    return c3({ notice: () => import("./calcite-notice-R5JZWVKU.js"), loader: () => import("./calcite-loader-3HRSMTEQ.js") });
  }
  destroy() {
    ...
    if (Array.isArray(n6)) n6.forEach((n7, o2) => {
      ...
      if ("utility-network-associations" === n7.type) {
        const e5 = async (e6) => {
          ...
          const { default: l4 } = await import("./FeatureUtilityNetworkAssociationList-6P3CMKIS.js"), d2 = new l4({ viewModel: n9, parentFeatureViewModel: s3, listType: r7, title: o3, featureVisibleElements: t3, description: s3.title, flowItems: i5 });
          i5.push(d2);
...
//# sourceMappingURL=chunk-VNIJEWUM.js.map
