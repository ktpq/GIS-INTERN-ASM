...
function r4(n5) {
  ...
  for (const l7 of f3) {
    ...
    if (!f4) continue;
    const r7 = t3 && t3 !== f4.alias ? t3 : null, a8 = m3(l7, f4);
...
function c3(e2, o4, s2) {
  ...
  for (const n5 of s2) {
    ...
    n5.label = s3?.alias || o5.alias, n5.format = d(o5) && s3?.fieldFormat ? x2(s3.fieldFormat, o5) : null, i = true, l7.delete(o5.name);
  }
...
function m4(n5, e2) {
  ...
  if (!a8 || !s2 && !r7) return;
  const u6 = s2 || a8.alias, c6 = d(a8) && r7 ? x2(r7, a8) : null;
  return new u({ fieldName: a8.name, label: u6, format: c6, visible: false, isEditable: K(a8, n5) });
}
...
function I() {
  return { types: m2, json: { write: { target: "drawingInfo.renderer", ignoreOrigin: true } } };
}
function _(e2, r7) {
  e2?.forEach((e3) => {
    e3.layer = r7;
...
function d3(e2, r7) {
  let s2 = r7.clone();
  if (!m6(s2)) return s2;
  if (r7.symbols.some((e3) => p6.has(e3.type)) && (s2 = new n4({ symbol: new u2() })), s2.authoringInfo || (s2.authoringInfo = new b()), s2.authoringInfo.isAutoGenerated = true, "visualVariables" in s2) {
...
function c5(e2, r7, t2, a8) {
  const o4 = x(r7), l7 = "mode" === t2 ? `cluster_type_${o4}` : "sum" === t2 ? `cluster_sum_${o4}` : `cluster_avg_${o4}`;
...
var p7 = (p8) => {
  ...
  let m7 = class extends h2 {
    constructor(...e2) {
      super(...e2), this.aggregateGraphicOrigin = new r5(this), this.addHandles([l2(() => this.renderer, () => {
...
//# sourceMappingURL=chunk-GECYJV7L.js.map
