...
import {
  r as r4
} from "./chunk-PNEUMX5E.js";
import {
  l2 as l4,
  n as n7,
  o2
} from "./chunk-OYUQQNUW.js";
import {
  i as i4,
  o as o3,
  t as t4,
...
function s(s3) {
  ...
  const a5 = null != s3.offset ? s3.offset : a4, n8 = null != s3.rotation ? s3.rotation : 0, e4 = null != s3.scale ? s3.scale : i3, f3 = n3(1, 0, 0, 0, 1, 0, a5[0], a5[1], 1), c = n3(Math.cos(n8), -Math.sin(n8), 0, Math.sin(n8), Math.cos(n8), 0, 0, 0, 1), m2 = n3(e4[0], 0, 0, 0, e4[1], 0, 0, 0, 1), u4 = e();
...
function j2(e4, t6) {
  ...
  for (let o4 = 0; o4 < w3.length; o4++) {
    ...
    for (const t7 in u5) {
      ...
      c2.push([t7, new t(r6, n9, e6.valuesPerElement, true)]);
    }
    ...
    if (null == C) {
      ...
      const r6 = E3 ? U2(E3.alphaChannelUsage) : void 0, n9 = { ambient: u2(e6.diffuse), diffuse: u2(e6.diffuse), opacity: 1 - (e6.transparency || 0), textureAlphaMode: r6, textureAlphaCutoff: 0.33, textureId: k, doubleSided: true, cullFace: 0, colorMixMode: e6.externalColorMixMode || "tint", textureAlphaPremultiplied: E3?.parameters.preMultiplyAlpha ?? false };
...
async function z2(e4, r5) {
  ...
  if (r5.cache) s3 = await r5.cache.loadGLTF(o4.url, r5, !!r5.usePBR, !!r5.useEmissive);
    ...
    const { loadGLTF: e5 } = await import("./loader-2FVCVTI4.js");
...
function X(r5, t6, o4, s3, i5, n8, l5, a5, c) {
  ...
  if (!n8.has(x2)) {
    if (T2) {
      const e4 = (e5, t8 = false, o6 = false) => {
        if (null != e5 && !l5.has(e5)) {
          ...
          if (s4) {
            const r6 = s4.data, i6 = t8 && !t2(r6) ? a5.compressionOptions : void 0;
            l5.set(e5, new M(t2(r6) ? r6.data : r6, __spreadProps(__spreadValues({}, s4.parameters), { preMultiplyAlpha: !t2(r6) && o6, encoding: t2(r6) ? r6.encoding : void 0, compressionOptions: i6 })));
          }
        }
      }, t7 = 1 !== h3 && !c;
    ...
    const o5 = y(m2.color[0]), f4 = y(m2.color[1]), d4 = y(m2.color[2]), p3 = null != m2.colorTexture && T2 ? l5.get(m2.colorTexture) : null, g2 = t4(m2), y3 = null != m2.normalTextureTransform?.scale ? m2.normalTextureTransform?.scale : a3;
...
function re(e4, t6) {
  for (let o4 = 0; o4 < e4.model.lods.length; ++o4) {
    ...
    for (const i5 of s3.parts) {
      ...
      if (null == s4) return;
      const n8 = i5.attributes.position, u4 = n8.count, T2 = n4(), b3 = n4(), h3 = n4(), w3 = new Float32Array(4 * u4), R2 = new Float32Array(3 * u4), S = h(e2(), i5.transform);
      let B = 0, j3 = 0;
      for (let l5 = 0; l5 < u4; l5++) {
        n8.getVec(l5, b3), s4.getVec(l5, T2), E(b3, b3, i5.transform), e3(h3, b3, t6.center), i2(h3, h3, t6.radius);
        const a5 = h3[2], u5 = a2(h3), x2 = Math.min(0.45 + 0.55 * u5 * u5, 1) ** p;
...
//# sourceMappingURL=chunk-6IDKN4HL.js.map
