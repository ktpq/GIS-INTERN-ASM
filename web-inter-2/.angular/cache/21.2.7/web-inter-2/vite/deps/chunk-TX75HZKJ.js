...
function r2(r5, o6) {
  return o6 ? r5.replaceAll(e3, "object" == typeof o6 ? (e6, r6) => n2(t2(r6, o6)) : (t4, e6) => n2(o6(e6))) : r5;
}
function o3(e6, n5) {
...
function i2(t4) {
  c2 ??= new DOMParser();
  return c2.parseFromString(t4 || "", "text/html").body.innerText || "";
}
function f3(t4, e6) {
...
var e4 = globalThis;
var a3 = __spreadValues({}, e4.esriConfig?.has);
function has(d) {
  return "function" == typeof a3[d] ? a3[d] = a3[d](e4) : a3[d];
}
has.add = (e6, d, r5, t4) => {
  ...
  has.add("host-webworker", void 0 !== e4.WorkerGlobalScope && self instanceof e4.WorkerGlobalScope);
  ...
  if (has.add("host-browser", a4), has.add("host-node", !("object" != typeof e4.process || !e4.process.versions?.node || !e4.process.versions.v8)), has.add("dom", a4), has("host-browser")) {
  ...
  has.add("esri-wasm", "WebAssembly" in e4), has.add("esri-performance-mode-frames-between-render", 20), has.add("esri-force-performance-mode", false), has.add("esri-shared-array-buffer", () => {
    const a4 = "SharedArrayBuffer" in e4, d = false === e4.crossOriginIsolated;
    return a4 && !d;
  }), has.add("wasm-simd", () => {
...
function n3(n5, t4, r5 = false) {
  const o6 = `🛑 DEPRECATED - ${t4}`;
  if (!r5) return void n5.warn(o6);
  let i5 = e5.get(n5);
  i5 || (i5 = /* @__PURE__ */ new Set(), e5.set(n5, i5)), i5.has(t4) || (i5.add(t4), n5.warn(o6));
}
var t3 = "https://www.esriurl.com/";
function r3(e6, n5, r5, o6 = {}) {
...
var r4 = class _r {
  constructor(t4, e6, r5) {
    this.type = "error", this.name = t4, this.message = e6 ? o3(e6, r5) : "", this.details = r5;
  }
  toString() {
...
//# sourceMappingURL=chunk-TX75HZKJ.js.map
