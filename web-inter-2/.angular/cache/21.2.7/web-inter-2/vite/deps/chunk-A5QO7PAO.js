...
function l4(r6) {
  const { spatialReference: f8, vertexSpace: l5, untransformedBounds: d4 } = r6, g6 = f(d4, u7);
...
async function u8(r6, o3, n7) {
  const { source: i4 } = o3, { loadGLTFMesh: a8 } = await p(import("./loadGLTFMesh-JPS7PIBY.js"), n7), c10 = await f6(i4, n7);
  s(n7);
...
var Y2 = Q2 = class extends l2(p2(m(s2))) {
  ...
  async toBinaryGLTF(e7) {
    const [{ toBinaryGLTF: t3 }] = await Promise.all([import("./gltfexport-5JAQQUZY.js"), this.load(e7)]);
  ...
  static async createFromGLTF(e7, t3, r6) {
    ...
    const { loadGLTFMesh: o3 } = await p(import("./loadGLTFMesh-JPS7PIBY.js"), r6);
...
//# sourceMappingURL=chunk-A5QO7PAO.js.map
