...
__decorate([m()], y2.prototype, "accentColor", void 0), __decorate([m()], y2.prototype, "initialOverrides", void 0), y2 = __decorate([l("esri.views.2d.interactive.editingTools.draw.SymbolDictionary")], y2);
...
var y3 = class extends b {
  ...
  initialize() {
    this._symbolDictionary = new y2({ accentColor: this.view.effectiveTheme.accentColor, initialOverrides: this.symbolOverrides }), this.addHandles(l2(() => this.view.effectiveTheme.accentColor, (e) => {
...
__decorate([m()], y3.prototype, "symbolOverrides", void 0), __decorate([m()], y3.prototype, "view", void 0), y3 = __decorate([l("esri.views.2d.interactive.editingTools.draw.DrawToolRenderer2D")], y3);

export {
  y3 as y,
  g
};
//# sourceMappingURL=chunk-DMKBQFQD.js.map
