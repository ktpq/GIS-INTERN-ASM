...
async function o2(o3) {
  const a2 = "portalItem" in o3 ? o3 : { portalItem: o3 }, { fromItem: e } = await import("./portalLayers-6GUXSMPD.js");
  try {
    return await e(a2);
  } catch (p) {
...
var b = class extends n2(o(u)) {
  ...
  static async fromArcGISServerUrl(t) {
    ...
    return (await import("./arcgisLayers-MANDTN4Y.js")).fromUrl(e);
  }
...
//# sourceMappingURL=chunk-DVV7T3XR.js.map
