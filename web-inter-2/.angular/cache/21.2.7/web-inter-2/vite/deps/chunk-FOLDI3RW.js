...
var j = class extends s3(l2(g(_2(e(b))))) {
  ...
  async queryElevation(e2, r3) {
    const { query: t3 } = await import("./ElevationQuery-EJJQPHR6.js");
    return s(r3), t3(this, e2, r3);
  }
  async createElevationSampler(e2, r3) {
    const { createSampler: t3 } = await import("./ElevationQuery-EJJQPHR6.js");
    return s(r3), t3(this, e2, r3);
  }
...
//# sourceMappingURL=chunk-FOLDI3RW.js.map
