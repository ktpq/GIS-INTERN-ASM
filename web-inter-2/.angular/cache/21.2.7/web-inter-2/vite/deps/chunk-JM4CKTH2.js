...
function g(e11, n12) {
  return !!i2(n12) && (t3().error("Accessor#set", "Assigning an instance of '" + (n12.declaredClass || "unknown") + "' which is not a subclass of '" + h(e11) + "'"), true);
}
function m(e11, n12) {
...
function x(e11, n12) {
  ...
  return (n13) => {
    ...
    if ("string" == typeof e11.key && !i2(n13)) {
      const t7 = {};
...
function t4(o15, e11, s9) {
  if (o15 && e11) if ("object" == typeof e11) for (const r9 of Object.getOwnPropertyNames(e11)) t4(o15, r9, e11[r9]);
    ...
    if (e11.includes(".")) {
      ...
      return void t4(o5(o15, n12), i9, s9);
    }
...
//# sourceMappingURL=chunk-JM4CKTH2.js.map
