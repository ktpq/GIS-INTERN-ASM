...
async function u() {
  if (!p2()) {
    const [e, o, r2, p3] = await Promise.all([import("./Envelope2D-MBIV4VTW.js"), import("./ProjectionTransformation-MB5L2AKO.js").then(({ queryTransformationList: n }) => n), import("./SpatialReference-QMDBPWPX.js").then((n) => n.aP).then(({ injectPe: n }) => n), import("./apiConverter-MOJHCOS4.js"), P()]);
...
//# sourceMappingURL=geographicTransformationUtils-O4DW4XOY.js.map
