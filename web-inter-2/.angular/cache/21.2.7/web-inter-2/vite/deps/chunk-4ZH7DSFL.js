...
__decorate([a({ type: Number, json: { write: true, origins: { "web-map": { default: 0, write: true }, "web-scene": { write: { overridePolicy: m2 } } } } })], l2.prototype, "rotation", void 0), __decorate([m("rotation")], l2.prototype, "castRotation", null), __decorate([a({ type: Number, json: { write: true, origins: { "web-map": { default: 0, write: true }, "web-scene": { write: { overridePolicy: m2 } } } } })], l2.prototype, "scale", void 0), __decorate([a({ types: s3, json: { read: u3, write: true, origins: { "web-scene": { read: u3, write: { overridePolicy: m2 } } } } })], l2.prototype, "targetGeometry", void 0), __decorate([a({ type: d, json: { write: true, origins: { "web-scene": { write: { isRequired: true } } } } })], l2.prototype, "camera", void 0), l2 = p = __decorate([c("esri.Viewpoint")], l2);
var c3 = l2;
function m2() {
...
async function J(t, r3, n3, o2) {
  ...
  if (q2.isCollection(t) && (t = t.toArray()), Array.isArray(t) && t.length && "object" == typeof t[0]) {
...
var nt = (function() {
  ...
  return function(r3, n3, o2, a2) {
    ...
    return o(e3, c4, c4), h(t, e3), s4(t, t, l3), i(t, t, rt(e3, o2, a2)), i(t, t, [0, a2.top - a2.bottom]), o(r3, t[4], t[5]);
  };
})();
function ot(t) {
...
var ut = (function() {
  ...
  return function(n3, o2, u5, l3, f2, m3) {
    return x(t, o2), l(e3, u5, 0.5 * m3), o(r3, 1 / l3 * m3, -1 / l3 * m3), f(n3, e3), f2 && s4(n3, n3, f2), c2(n3, n3, r3), i(n3, n3, t), n3;
  };
})();
var lt = (function() {
  const t = n2();
...
//# sourceMappingURL=chunk-4ZH7DSFL.js.map
