...
var e5 = class _e {
  ...
  acquire(...t7) {
    ...
    return this._acquireFunction ? this._acquireFunction(s9, ...t7) : i2(s9) && s9.acquire(...t7), s9;
  }
  release(i8) {
...
var t5 = class {
  constructor(t7, e11, i8) {
    this.name = t7, this.details = i8, this.type = "warning", this.message = e11 ? o2(e11, i8) : "";
  }
  toString() {
...
function r6(r9, a11 = {}) {
  const t7 = r9 instanceof o ? r9 : new o(r9, a11), { alwaysWriteDefaults: l6, default: o15, ignoreUnknown: s9 = true, name: i8, nonNullable: u7, readOnly: p7 = false } = a11;
...
//# sourceMappingURL=chunk-XCGM4D6U.js.map
