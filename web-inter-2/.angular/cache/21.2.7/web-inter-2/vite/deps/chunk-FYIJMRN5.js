...
var N3 = class extends O {
  ...
  loadDependencies() {
    return c3({ button: () => import("./calcite-button-2TVLMR4O.js"), icon: () => import("./calcite-icon-VXSOFU5M.js"), input: () => import("./calcite-input-KLEZJZBF.js") });
  }
...
var m5 = class extends O {
  ...
  loadDependencies() {
    return c3({ button: () => import("./calcite-button-2TVLMR4O.js"), icon: () => import("./calcite-icon-VXSOFU5M.js"), input: () => import("./calcite-input-KLEZJZBF.js"), "input-message": () => import("./calcite-input-message-LPSODQGC.js") });
  }
  render() {
...
var l4 = class extends O {
  ...
  loadDependencies() {
    return c3({ button: () => import("./calcite-button-2TVLMR4O.js"), dropdown: () => import("./calcite-dropdown-TOACMQ4T.js"), "dropdown-item": () => import("./calcite-dropdown-item-WQLIKSVF.js"), "dropdown-group": () => import("./calcite-dropdown-group-NYCYQH3T.js") });
  }
...
//# sourceMappingURL=chunk-FYIJMRN5.js.map
