...
function U(r3, t, n2) {
  ...
  return { type: String, read: (r4, t2, e) => {
    ...
    const l = S(t2), m2 = m(l, __spreadProps(__spreadValues({}, u), { verifyItemRelativeUrls: u?.verifyItemRelativeUrls ? { writtenUrls: u.verifyItemRelativeUrls.writtenUrls, rootPath: void 0 } : void 0 }), 1), y2 = i2.type !== String && (!i(this) || u?.origin && this.originIdOf(n2) > r(u.origin)), g2 = { object: this, propertyName: n2, value: t2, targetUrl: m2, dest: p2, targetPropertyName: c, context: u, params: r3 };
...
function w(e) {
  ...
  if (p2?.contentAddressed && "json" !== y2.type) return void a.messages?.push(new r2("persistable:contentAddressingUnsupported", `Property "${d}" is trying to serializing a resource with content of type ${y2.type} with content addressing. Content addressing is only supported for json resources.`, { content: y2 }));
...
//# sourceMappingURL=chunk-QG6BYYHC.js.map
