...
var T3 = class extends O {
  constructor(e4, t3) {
    super(e4, t3), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new v2(), this.messages = null, this._disposeChart = (e5) => {
      ...
      if (t4 || !i5 || !e5) return;
      const { createRoot: a3 } = await import("./chartUtilsAm5-GBFRGSWE.js"), r6 = await a3(e5);
  ...
  async _getSeriesColors(e4) {
    const { colorAm5: t3 } = await import("./chartCommon-QYVGEQBN.js"), i5 = /* @__PURE__ */ new Map();
    return e4.forEach((e5) => {
      e5.color && i5.set(e5, t3(e5.color.toCss(true)));
    }), i5;
  }
  async _getRendererColors() {
    const { colorAm5: e4 } = await import("./chartCommon-QYVGEQBN.js"), t3 = /* @__PURE__ */ new Map(), i5 = this._getRenderer(), a3 = "default";
    if (!i5) return t3;
  ...
  async _renderChart(e4) {
    const { root: t3, mediaInfo: i5 } = e4, { value: a3, type: r6 } = i5, { ResponsiveThemeAm5: o2, DarkThemeAm5: s3, AnimatedThemeAm5: n6, ColorSetAm5: d2, ThemeAm5: m4, esriChartColorSet: c6 } = await import("./chartCommon-QYVGEQBN.js"), h6 = m4.new(t3);
  ...
  async _customizeChartTooltip(e4, t3 = "horizontal") {
    const { colorAm5: i5 } = await import("./chartCommon-QYVGEQBN.js");
  ...
  async _createPieChart(e4, t3) {
    const { TooltipAm5: i5 } = await import("./chartCommon-QYVGEQBN.js"), { PieChartAm5: a3, PieSeriesAm5: r6 } = await import("./pieChart-UV6JQL72.js"), { mediaInfo: o2, root: s3 } = e4, { title: n6 } = o2, l4 = 5, d2 = o2?.altText || o2?.title || "", m4 = s3.container.children.push(a3.new(s3, { ariaLabel: d2, focusable: true, paddingBottom: l4, paddingTop: l4, paddingLeft: l4, paddingRight: l4 })), c6 = "{category}: {valuePercentTotal.formatNumber('0.00')}%\n ({value})", h6 = i5.new(s3, { labelText: c6 }), p6 = m4.series.push(r6.new(s3, { name: n6, valueField: A, categoryField: w2, tooltip: h6 }));
  ...
  async _createColumnChart(e4, t3, i5) {
    const { TooltipAm5: a3, ScrollbarAm5: r6 } = await import("./chartCommon-QYVGEQBN.js"), { CategoryAxisAm5: o2, AxisRendererXAm5: s3, ValueAxisAm5: n6, AxisRendererYAm5: l4, ColumnSeriesAm5: d2 } = await import("./xyChart-LIAYYLK3.js"), { mediaInfo: m4, root: c6 } = t3, { value: h6, title: p6 } = m4;
  ...
  async _createLineChart(e4, t3, i5) {
    const { TooltipAm5: a3, ScrollbarAm5: r6 } = await import("./chartCommon-QYVGEQBN.js"), { CategoryAxisAm5: o2, AxisRendererXAm5: s3, ValueAxisAm5: n6, AxisRendererYAm5: l4, LineSeriesAm5: d2 } = await import("./xyChart-LIAYYLK3.js"), { root: m4, mediaInfo: c6 } = t3, { value: h6, title: p6 } = c6;
    e4.setAll({ wheelX: "panX", wheelY: "zoomX" });
...
var M2 = b2 = class extends O {
  ...
  loadDependencies() {
    return c3({ chip: () => import("./calcite-chip-UJ4Z2GVB.js"), icon: () => import("./calcite-icon-VXSOFU5M.js"), list: () => import("./calcite-list-CVCNOH2T.js"), "list-item": () => import("./calcite-list-item-P27G5SD5.js"), loader: () => import("./calcite-loader-3HRSMTEQ.js"), notice: () => import("./calcite-notice-HLCX44BS.js") });
  }
  destroy() {
  ...
  async _selectRecord(e4) {
    ...
    const { default: i5 } = await import("./Feature-NGN6CJ5Z.js");
...
var g2 = class extends O {
  ...
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-VXSOFU5M.js"), list: () => import("./calcite-list-CVCNOH2T.js"), "list-item": () => import("./calcite-list-item-P27G5SD5.js"), loader: () => import("./calcite-loader-3HRSMTEQ.js"), notice: () => import("./calcite-notice-HLCX44BS.js") });
  }
  destroy() {
...
var k2 = class extends d(O) {
  ...
  loadDependencies() {
    return c3({ notice: () => import("./calcite-notice-HLCX44BS.js"), loader: () => import("./calcite-loader-3HRSMTEQ.js") });
  }
  destroy() {
    ...
    if (Array.isArray(n6)) n6.forEach((n7, o2) => {
      ...
      if ("utility-network-associations" === n7.type) {
        const e5 = async (e6) => {
          ...
          const { default: l4 } = await import("./FeatureUtilityNetworkAssociationList-RRBAM6DM.js"), d2 = new l4({ viewModel: n9, parentFeatureViewModel: s3, listType: r7, title: o3, featureVisibleElements: t3, description: s3.title, flowItems: i5 });
          i5.push(d2);
...
//# sourceMappingURL=chunk-TSPLSJ4Z.js.map
