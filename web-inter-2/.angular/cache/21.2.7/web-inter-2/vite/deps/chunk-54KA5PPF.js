...
var $ = E = class extends m3(a3) {
  ...
  writeStyleOrigin(e2, t, s, i3) {
    e2.styleName ? t.styleName = e2.styleName : e2.styleUrl && (t.styleUrl = m(e2.styleUrl, i3));
  }
  ...
  _watchUniqueValueInfos() {
    ...
    if (e2) {
      const t = [];
      for (const s of e2) t.push(l(() => ({ symbol: s.symbol, value: s.value, label: s.label, description: s.description }), (e3, t2) => {
  ...
  _watchUniqueValueGroups() {
    ...
    if (e2) {
      const t = [];
      for (const s of e2) {
        t.push(l(() => ({ classes: s.classes }), (e3, t2) => {
          e3 !== t2 && (this._updateInfosFromGroups(), this._isInfosSource = false);
        }, { sync: true }));
        for (const e3 of s.classes ?? []) t.push(l(() => ({ symbol: e3.symbol, values: e3.values, label: e3.label, description: e3.description }), (e4, t2) => {
...
__decorate([a2({ readOnly: true })], $.prototype, "_cache", null), __decorate([r({ uniqueValue: "unique-value" })], $.prototype, "type", void 0), __decorate([a2(n4)], $.prototype, "backgroundFillSymbol", void 0), __decorate([a2({ value: null, json: { type: String, read: { source: "field1" }, write: { target: "field1" } } })], $.prototype, "field", null), __decorate([m2("field")], $.prototype, "castField", null), __decorate([r2("field")], $.prototype, "writeField", null), __decorate([a2({ type: String, value: null, json: { write: true } })], $.prototype, "field2", null), __decorate([a2({ type: String, value: null, json: { write: true } })], $.prototype, "field3", null), __decorate([a2({ type: Boolean, json: { name: "drawInClassOrder", default: false, write: true, origins: { "web-scene": { write: false } } } })], $.prototype, "orderByClassesEnabled", void 0), __decorate([a2({ type: String, value: null, json: { write: true } })], $.prototype, "valueExpression", null), __decorate([a2({ type: String, json: { write: true } })], $.prototype, "valueExpressionTitle", void 0), __decorate([a2({ type: u2, json: { write: true } })], $.prototype, "legendOptions", void 0), __decorate([a2({ type: String, json: { write: true } })], $.prototype, "defaultLabel", void 0), __decorate([a2(n(__spreadValues({}, y2), { json: { write: { overridePolicy() {
...
//# sourceMappingURL=chunk-54KA5PPF.js.map
