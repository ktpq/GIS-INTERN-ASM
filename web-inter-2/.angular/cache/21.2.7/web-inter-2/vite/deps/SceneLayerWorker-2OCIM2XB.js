...
async function g(e) {
  ...
  let y2;
  const [{ projectBuffer: h3 }, { initializeProjection: d3 }] = await Promise.all([import("./projectBuffer-JJD2FPWH.js"), import("./projectionUtils-SGP4JNRA.js")]);
  await d3(l, u2);
  const g2 = [0, 0, 0];
  ...
  if ("georeferenced" === c2.type && null == c2.origin) {
    ...
    const e2 = "georeferenced" === c2.type ? c.fromJSON(c2) : i.fromJSON(c2), { projectMeshVertexPositions: r } = await import("./projectMeshVertexPositions-RAQWPABO.js"), t = r({ vertexAttributes: { position: f2 }, transform: m2 ? { localMatrix: m2 } : void 0, vertexSpace: e2, spatialReference: l }, u2);
...
//# sourceMappingURL=SceneLayerWorker-2OCIM2XB.js.map
