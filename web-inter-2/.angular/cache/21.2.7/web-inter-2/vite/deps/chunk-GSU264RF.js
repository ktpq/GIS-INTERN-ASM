...
${s4}`);
  ...
  addUpdateTracking(t4, s4) {
    const e5 = l2(() => s4.updating, (s5) => this._idToUpdatingState.set(t4, s5), { sync: true });
    this.addHandles(e5);
  }
  addPromise(t4) {
...
__decorate([a({ constructOnly: true })], n3.prototype, "debugName", void 0), __decorate([a({ readOnly: true })], n3.prototype, "updating", null), n3 = __decorate([l("esri.views.2d.layers.support.UpdateTracking2D")], n3);
...
//# sourceMappingURL=chunk-GSU264RF.js.map
