...
function c(e, t) {
  const a = Ye(e), c2 = a.getSpatialReference();
  return Qe(o(a.getGeometry(), Ke(t), c2), c2);
}
function i(r, o2) {
  const [c2, i2] = Xe(r);
  return u(c2, Ke(o2), i2, 7).map((e) => Qe(e, i2)).filter(N);
}
export {
  c as execute,
  i as executeMany
};
//# sourceMappingURL=intersectionOperator-7WVUEAOE.js.map
