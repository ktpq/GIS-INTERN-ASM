import {
  g as g2
} from "./chunk-3WMSWMLX.js";
import "./chunk-CVBRGZYR.js";
...
async function H(e2, t2, i3, o) {
  const r = (await import("./visualVariableUtils-WTT4A47D.js")).getSizeRangeAtScale(e2, i3, o), s2 = r && O(r);
  if (!r || !s2) return;
...
async function F(e2, t2, l4, i3, o) {
  const { getSize: r } = await import("./visualVariableUtils-WTT4A47D.js");
...
//# sourceMappingURL=sizeRampUtils-WZ65CPVT.js.map
