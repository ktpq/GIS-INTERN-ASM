...
var D = class extends i3(c3(l)) {
  ...
  async _locationUpdate(e3, t) {
    ...
    if (s && "mesh" !== s && i4 && r4 && this.selectedFeature) if ("point" !== s) try {
      ...
      s2 = H(s2, i4), Z || (Z = await Promise.all([import("./intersectsOperator-F5IAOOAA.js"), import("./proximityOperator-KQZQ54WJ.js")]));
      const [n5, l6] = Z;
      if (!n5.execute(s2, r4)) {
...
//# sourceMappingURL=chunk-C4UPAWPM.js.map
