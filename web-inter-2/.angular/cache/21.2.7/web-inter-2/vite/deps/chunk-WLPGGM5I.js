...
function H(e6, r3 = l(e6), n4 = s(e6)) {
  return null == e6 ? null : t(e6) ? j(e6, r3, n4) : o2(e6) ? A(e6, r3, n4) : e2(e6) ? S(e6, r3, n4) : i(e6) ? Y(e6, r3, n4) : void y().error("convertFromGeometry:unknown-geometry", new r("internal:geometry", `Unable to parse unknown geometry type '${e6}'`));
}
...
//# sourceMappingURL=chunk-WLPGGM5I.js.map
