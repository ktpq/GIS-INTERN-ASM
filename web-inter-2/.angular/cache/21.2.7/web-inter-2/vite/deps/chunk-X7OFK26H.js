...
var o4;
var r4 = o4 = class extends p {
  constructor(t2) {
    super(t2), this.image = null, this.type = "button";
  }
  clone() {
    return new o4({ active: this.active, className: this.className, disabled: this.disabled, icon: this.icon, id: this.id, indicator: this.indicator, title: this.title, visible: this.visible, image: this.image });
  }
};
__decorate([a2()], r4.prototype, "image", void 0), r4 = o4 = __decorate([c("esri.support.actions.ActionButton")], r4);
var a3 = r4;
...
var o5;
var a12 = o5 = class extends p {
  constructor(i14) {
    super(i14), this.image = null, this.type = "toggle", this.value = false;
  }
  clone() {
    return new o5({ active: this.active, className: this.className, disabled: this.disabled, icon: this.icon, id: this.id, indicator: this.indicator, title: this.title, visible: this.visible, image: this.image, value: this.value });
  }
};
__decorate([a2()], a12.prototype, "image", void 0), __decorate([a2()], a12.prototype, "value", void 0), a12 = o5 = __decorate([c("esri.support.actions.ActionToggle")], a12);
var r5 = a12;

// node_modules/@arcgis/core/PopupTemplate.js
var B = "relationships/";
var L = "expression/";
var M = q.ofType({ key: "type", defaultKeyValue: "button", base: p, typeMap: { button: a3, toggle: r5 } });
...
//# sourceMappingURL=chunk-X7OFK26H.js.map
