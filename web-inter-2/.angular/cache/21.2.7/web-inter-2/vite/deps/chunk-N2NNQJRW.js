...
var n3 = class extends b {
  ...
  async update(t, r2) {
    const { addOrUpdateResources: e } = await import("./resourceUtils-X36L7DVR.js");
...
var k = v = class extends a2(u) {
  ...
  async fetchResources(e = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-X36L7DVR.js");
    return i(this, e, t);
  }
  async addResource(e, t, i) {
    const { addOrUpdateResources: r2 } = await import("./resourceUtils-X36L7DVR.js");
  ...
  async removeResource(e, t) {
    const { removeResource: r2 } = await import("./resourceUtils-X36L7DVR.js");
  ...
  async removeAllResources(e) {
    const { removeAllResources: t } = await import("./resourceUtils-X36L7DVR.js");
    return t(this, e);
  }
  resourceFromPath(e) {
...
//# sourceMappingURL=chunk-N2NNQJRW.js.map
