...
var u7 = n3 = class extends n {
  ...
  async fetchItems(t2) {
    ...
    const { default: r2 } = await import("./PortalItem-67FWW7F6.js"), o3 = { folders: false, inRecycleBin: !!t2.inRecycleBin || null, foldersContent: !(t2.folder || !t2.includeSubfolderItems) || null, num: t2.num || 10, start: t2.start || 1, sortField: t2.sortField || "created", sortOrder: t2.sortOrder || "asc" }, l3 = await this.portal.request(e2, { query: o3 });
    let s5;
...
var _;
var b2;
var U = { PortalGroup: () => Promise.resolve({ default: u6 }), PortalItem: () => import("./PortalItem-67FWW7F6.js"), PortalUser: () => Promise.resolve({ default: u7 }) };
var M = class extends a4(u4) {
  ...
  load(e2) {
    const t2 = import("./Basemap-CFMJGHG3.js").then(({ default: t3 }) => {
      s2(e2), b2 = t3;
  ...
  async createElevationLayers() {
    await this.load();
    const e2 = this._getHelperService("defaultElevationLayers"), t2 = (await import("./ElevationLayer-IBLP3EKC.js")).default;
...
//# sourceMappingURL=chunk-KYLXXMSB.js.map
