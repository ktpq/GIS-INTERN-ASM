...
var v2 = class _v extends S {
  ...
  async queryAggregate(e2) {
    ...
    const n3 = e2.statistics.map((e3) => new p3({ onStatisticField: null !== e3.workingexpr ? l(e3.workingexpr, t3) : "", outStatisticFieldName: e3.field, statisticType: e3.toStatisticsName() }));
    let u = this._maxQueryRate();
    const c2 = this._layer.capabilities?.query.maxRecordCount;
    null != c2 && c2 < u && (u = c2);
  ...
  async queryAttachments(e2, t3, r3, s5, l2) {
    ...
    if (!n3(o2)) return [];
    const u = new p({ objectIds: [e2], returnMetadata: l2 });
    ...
    return c2?.[e2] ? c2[e2].map((t4) => {
      ...
      let s6 = null;
      return l2 && t4.exifInfo && (s6 = p2.convertJsonToArcade(t4.exifInfo, "system", true)), new t2(t4.id, t4.name, t4.contentType, t4.size, r4, s6, t4.keywords ?? null);
    }) : [];
  }
...
//# sourceMappingURL=chunk-MWJDJ5WJ.js.map
