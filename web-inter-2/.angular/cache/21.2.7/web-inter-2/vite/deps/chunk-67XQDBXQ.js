...
var j = class extends s3(l2(g(_2(e(b))))) {
  ...
  async queryElevation(e2, r3) {
    const { query: t3 } = await import("./ElevationQuery-EUHFR6P7.js");
    return s(r3), t3(this, e2, r3);
  }
  async createElevationSampler(e2, r3) {
    const { createSampler: t3 } = await import("./ElevationQuery-EUHFR6P7.js");
    return s(r3), t3(this, e2, r3);
  }
...
//# sourceMappingURL=chunk-67XQDBXQ.js.map
