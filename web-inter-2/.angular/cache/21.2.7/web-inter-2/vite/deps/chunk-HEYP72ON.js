...
function s(s3) {
  ...
  const a5 = null != s3.offset ? s3.offset : a3, n8 = null != s3.rotation ? s3.rotation : 0, e4 = null != s3.scale ? s3.scale : i3, f3 = n3(1, 0, 0, 0, 1, 0, a5[0], a5[1], 1), c = n3(Math.cos(n8), -Math.sin(n8), 0, Math.sin(n8), Math.cos(n8), 0, 0, 0, 1), m2 = n3(e4[0], 0, 0, 0, e4[1], 0, 0, 0, 1), u4 = e();
...
async function z2(e4, r5) {
  ...
  if (r5.cache) s3 = await r5.cache.loadGLTF(o4.url, r5, !!r5.usePBR, !!r5.useEmissive);
    ...
    const { loadGLTF: e5 } = await import("./loader-YLTMY3QG.js");
...
//# sourceMappingURL=chunk-HEYP72ON.js.map
