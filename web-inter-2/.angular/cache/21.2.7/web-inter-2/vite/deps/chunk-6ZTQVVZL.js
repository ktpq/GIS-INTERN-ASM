...
async function u8(r6, o3, n7) {
  const { source: i4 } = o3, { loadGLTFMesh: a8 } = await p(import("./loadGLTFMesh-RKHKC5QC.js"), n7), c10 = await f6(i4, n7);
  s(n7);
...
var Y2 = Q2 = class extends l(p2(m(s2))) {
  ...
  async toBinaryGLTF(e7) {
    const [{ toBinaryGLTF: t3 }] = await Promise.all([import("./gltfexport-T5CT63P7.js"), this.load(e7)]);
  ...
  static async createFromGLTF(e7, t3, r6) {
    ...
    const { loadGLTFMesh: o3 } = await p(import("./loadGLTFMesh-RKHKC5QC.js"), r6);
...
//# sourceMappingURL=chunk-6ZTQVVZL.js.map
