...
var x = class extends a2(u2) {
  ...
  async _loadLayersFromJSON(e, r2, t) {
    const s4 = this.resourceInfo?.context, a6 = this.portalItem?.portal || s4?.portal || null, o = O[s4?.origin || ""] ?? "web-map", { populateOperationalLayers: i3 } = await import("./layersCreator-TCO2LSYD.js"), n4 = [];
...
//# sourceMappingURL=chunk-P2MMSCEF.js.map
