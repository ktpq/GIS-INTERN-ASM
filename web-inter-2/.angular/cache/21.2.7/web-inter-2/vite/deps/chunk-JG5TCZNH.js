...
var E3 = class extends n3 {
  ...
  _createOrUpdateGraphic(t6) {
    ...
    return this._graphic = o5, this.updateGraphicGeometry(t6), this.internalGraphicsLayer.add(o5), this.addHandles(this.initializeGraphic(o5)), this.notifyChange("graphic"), this.addHandles(e2(() => {
...
function f5({ predicate: o5 = () => true, snappingManager: i7, snappingContext: a7, updatingHandles: u6, useZ: p8 = true }) {
  ...
  const T4 = () => {
    Z3 = e(Z3), i7.doneSnapping(), j7?.frameTask.remove(), j7 = null, f6 = l(f6), z6 = null;
  }, k10 = d4(i7, p8, c8);
...
//# sourceMappingURL=chunk-JG5TCZNH.js.map
