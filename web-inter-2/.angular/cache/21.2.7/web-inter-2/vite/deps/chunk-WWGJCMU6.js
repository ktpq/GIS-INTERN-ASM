...
var w3 = w.fromSimpleMarkerSymbol(p2);
var S2 = b.fromSimpleLineSymbol(u3);
var b2 = f2.fromSimpleFillSymbol(c2);
var j2 = new n({ symbolLayers: new q([new d({ material: { color: e3 }, edges: new p({ size: e2(1), color: new g(i) }) })]) });
var L = new b({ symbolLayers: new q([new j({ material: { color: new g([0, 0, 0]) }, size: e2(1) })]) });
var D = new f2({ symbolLayers: new q([new d({ outline: { color: new g([0, 0, 0]), size: e2(1) } })]) });
function d3(o) {
...
function u4(u6, d4 = g2) {
  ...
  if (S(u6)) k = u6.clone();
  ...
  } else if (u6 instanceof d2) k = b.fromSimpleLineSymbol(u6);
  else if (u6 instanceof u) k = w.fromSimpleMarkerSymbol(u6);
  else if (u6 instanceof c) k = w.fromPictureMarkerSymbol(u6);
  else if (u6 instanceof m) k = d4.geometryType && "mesh" === d4.geometryType ? n.fromSimpleFillSymbol(u6) : f2.fromSimpleFillSymbol(u6);
  else {
    ...
    k = j3 ? f.fromTextSymbol(u6) : w.fromTextSymbol(u6);
  }
...
//# sourceMappingURL=chunk-WWGJCMU6.js.map
